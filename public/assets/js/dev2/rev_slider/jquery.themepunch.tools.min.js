    ...
    ;(W._startTime = i.time),
      ...
      (D._updateRoot = G.render =
        function () {
          var a, b, c
          if (
            (J.length && Y(), W.render((i.time - W._startTime) * W._timeScale, !1, !1), V.render((i.frame - V._startTime) * V._timeScale, !1, !1), J.length && Y(), i.frame >= X)
          ) {
    ...
    function (t, e, i) {
      ...
      return (
        ...
        (d.staggerTo = function (t, e, r, n, a, h, l, _) {
          ...
          for (
            'string' == typeof t && (t = i.selector(t) || t), t = t || [], o(t) && (t = m(t)), n = n || 0, 0 > n && ((t = m(t)), t.reverse(), (n *= -1)), u = 0;
            t.length > u;
            u++
          )
...
!(function (a) {
  ...
  ;(H.split = function (a) {
    ...
    for (
      var b, c, d, e = this.elements.length, f = a.span ? 'span' : 'div', g = ('absolute' === a.position || a.absolute === !0, x(a.wordsClass, f)), h = x(a.charsClass, f);
      --e > -1;
