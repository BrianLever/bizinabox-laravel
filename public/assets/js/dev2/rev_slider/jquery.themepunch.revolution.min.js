...
!(function (jQuery, undefined) {
  ...
  jQuery.extend(!0, _R, {
    ...
    setSize: function (e) {
      ...
      if (
        ((e.paddings =
          e.paddings === undefined ? { top: parseInt(e.c.parent().css('paddingTop'), 0) || 0, bottom: parseInt(e.c.parent().css('paddingBottom'), 0) || 0 } : e.paddings),
  ...
  var _ISM = _R.is_mobile(),
    ...
    runSlider = function (t, x) {
      ...
      if (
        ...
        ;(s = s === undefined ? 0 : s),
          (l = l === undefined ? 0 : l),
          o.wrap(
            '<div class="forcefullwidth_wrapper_tp_banner" id="' + d + '" style="position:relative;width:100%;height:auto;margin-top:' + l + ';margin-bottom:' + s + '"></div>'
          ),
    ...
    prepareSlides = function (e, u) {
      if (
        ...
        'on' == u.autoHeight &&
          (u.ul.css({ overflow: 'hidden', width: '100%', height: '100%', maxHeight: 'none' }), e.css({ maxHeight: 'none' }), e.parent().css({ maxHeight: 'none' })),
