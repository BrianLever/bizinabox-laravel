      ...
      switch (((g = !0 === a.nextslideatend ? '' : g), (a.videotype = y), h)) {
        ...
        case 'youtube':
          ;(m = 'https'),
            ...
            (!0 === a.videoinline || 'true' === a.videoinline || 1 === a.videoinline || i.hasClass('rs-background-video-layer') || 'on' === i.data('autoplay')) &&
              (d += '&playsinline=1')
      ...
      null != p &&
        ...
        A(r, 'play', function () {
          ...
          ;(e = null != e && 'mute' != e ? parseFloat(e) / 100 : e),
            I.is_mobile() ||
              I.isSafari11() ||
              (!0 === d.globalmute ? (r.muted = !0) : (r.muted = !1), 1 < e && (e /= 100), 'mute' == e ? (r.muted = !0) : null != e && (r.volume = e)),
