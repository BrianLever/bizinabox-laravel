...
!(function (e) {
  ...
  jQuery.extend(!0, A, {
          ...
          jQuery.each(p.layers.static, function (e, t) {
            ...
            !0 !== a.hoveredstatus && !0 !== a.inhoveroutanimation
              ? (A.updateMarkup(this, p),
                ...
                (r && 0 !== o) ||
                  !0 === a.veryfirstststic ||
                  (A.buildFullTimeLine({ caption: i, opt: p, offsetx: s, offsety: 0, index: e, recall: n, preset: r, regenerate: 0 === o }), (a.veryfirstststic = !0)),
                n && 'carousel' === p.sliderType && 'on' === p.carousel.showLayersAllTime && A.animcompleted(i, p))
              : A.prepareSingleCaption({ caption: i, opt: p, offsetx: s, offsety: 0, index: e, recall: n, preset: r })
          })
      ...
      if (!(t = r.timelines[n._slideid].layers[n._id]).generated || !0 === e.regenerate) {
        ...
        for (var l = 0; l < n.frames.length; l++)
          if (l !== n.hoverframeindex) {
            ...
            void 0 !== t.firstslide &&
              'frame_0' === m &&
              (i.addLabel('slide_' + t.firstslide + '_pause', 0), i.addPause('slide_' + t.firstslide + '_pause'), i.addLabel('slide_' + t.firstslide, '+=0.005')),
              void 0 !== t.lastslide &&
                'frame_999' === m &&
                (i.addLabel('slide_' + t.lastslide + '_pause', '+=0.01'), i.addPause('slide_' + t.lastslide + '_pause'), i.addLabel('slide_' + t.lastslide, '+=0.005')),
    ...
    createFrameOnTimeline: function (e) {
      ...
      if (
        ...
        'column' === i._nctype &&
          (n.add(punchgs.TweenLite.set(i._cbgc_man, { visibility: 'visible' }), a), n.add(punchgs.TweenLite.set(i._cbgc_auto, { visibility: 'hidden' }), a)),
        i.splittext && 0 === r)
      ) {
      ...
      if (0 !== r || e.fromcurrentstate)
        if ('block' === i._sfx_out && r === i.outframeindex)
          n.add(d.content.staggerTo(s, 0.001, { autoAlpha: 0, delay: x }), a), n.add(d.content.staggerTo(s, _.speed / 1e3 / 2 - 0.001, { x: 0, delay: x }), a + '+=0.001')
        else if (u && void 0 !== L) {
          R = { to: P(_.anim) }
          for (var I in s) {
  ...
  var O = function (e, t, i, a, n, r, o, s, d) {
      ...
      if (
        ...
        else if (e === a.outframeindex) for (m = 0; m < t.dchildren.length; m++) A.endMoveCaption({ caption: jQuery(t.dchildren[m]), opt: d, checkchildrens: !0 })
    ...
    P = function (e) {
      ...
      for (var i in e)
        'string' == typeof e[i] &&
          0 <= e[i].indexOf('|') &&
          (void 0 === t[i] && (t[i] = { index: 0 }), (t[i].values = e[i].replace('[', '').replace(']', '').split('|')), (t[i].len = t[i].values.length - 1))
      return t
    },
    B = function (e) {
      return (
  ...
  var v = function (a, e) {
      ...
      var t = (e = (e = (e = (e = (e = (e = (e = (e = e.replace('c:', 'color:')).replace('bg:', 'background-color:')).replace('bw:', 'border-width:')).replace(
        'bc:',
        'border-color:'
      )).replace('br:', 'borderRadius:')).replace('bs:', 'border-style:')).replace('td:', 'text-decoration:')).replace('zi:', 'zIndex:')).split(';')
      return (
        t &&
          jQuery.each(t, function (e, t) {
            var i = t.split(':')
    ...
    V = function (e, t) {
      ...
      if (
        ...
        ;(a.maxWidth = void 0 === e.data('width') ? parseInt(e.css('maxWidth'), 0) || 'none' : e.data('width')),
          (a.maxHeight =
            -1 !== jQuery.inArray(e.data('type'), ['column', 'row']) ? 'none' : void 0 === e.data('height') ? parseInt(e.css('maxHeight'), 0) || 'none' : e.data('height')),
