      ...
      m(a.navigation.bullets) &&
        ('fullscreen' != a.sliderLayout &&
          ...
          (a.navigation.bullets.h_offset =
            'center' === a.navigation.bullets.h_align ? a.navigation.bullets.h_offset_old + c / 2 - d / 2 : a.navigation.bullets.h_offset_old + c - d)),
        ...
        m(a.navigation.arrows) &&
          ('fullscreen' != a.sliderLayout &&
            ...
            (a.navigation.arrows.right.h_offset =
              'right' === a.navigation.arrows.right.h_align ? a.navigation.arrows.right.h_offset_old + d : a.navigation.arrows.right.h_offset_old + c)),
  ...
  var e = function (a, b) {
                ...
                case 'move':
                  if (
                    ...
                    ;('none' !== f.overpull && 0 !== f.overpull) || !(t < 0 || t > d.slideamount - 1)
                      ? t >= 0 && t <= d.slideamount - 1 && ((t >= 0 && i > f.overpull) || (t <= d.slideamount - 1 && i < f.overpull)) && (f.overpull = 0)
                      : (f.overpull = i),
                      (f.slide_offset =
                        t < 0
    ...
    o = function (a, b) {
      ...
      n(b.navigation.arrows) &&
        punchgs.TweenLite.delayedCall(c ? b.navigation.arrows.hide_delay_mobile : b.navigation.arrows.hide_delay, p, [d.find('.tparrows'), b.navigation.arrows, 'hide']),
        n(b.navigation.bullets) &&
          punchgs.TweenLite.delayedCall(c ? b.navigation.bullets.hide_delay_mobile : b.navigation.bullets.hide_delay, p, [d.find('.tp-bullets'), b.navigation.bullets, 'hide']),
        ...
        n(b.navigation.tabs) &&
          punchgs.TweenLite.delayedCall(c ? b.navigation.tabs.hide_delay_mobile : b.navigation.tabs.hide_delay, p, [d.find('.tp-tabs'), b.navigation.tabs, 'hide'])
    },
    p = function (a, b, c, d) {
    ...
    w = function (a, b, c, d, e) {
      ...
      jQuery.each(e.thumbs[c.index()].params, function (a, b) {
        ...
        p.append(
          '<div data-liindex="' + c.index() + '" data-liref="' + m + '" class="justaddedthumb ' + d + '" style="width:' + b.width + 'px;height:' + b.height + 'px;">' + s + '</div>'
        )
