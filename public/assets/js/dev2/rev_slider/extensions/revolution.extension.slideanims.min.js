    ...
    switch (
      ((v =
        void 0 !== h && 0 <= h.indexOf('gradient')
          ? 'background:' + h
          : 'background-color:' + h + ';background-image:url(' + d + ');background-repeat:' + w + ';background-size:' + g + ';background-position:' + m),
      a)
    ) {
      case 'box':
    ...
    d = function (a, t, e, o, i, n, r, s) {
      ...
      if (
        ...
        n.find('.slotslide').each(function (t) {
          var e = jQuery(this)
          ;(y += 1) == v && (y = 0),
            s.add(punchgs.TweenLite.from(e, g / 600, { opacity: 0, top: 0 - l.sloth, left: 0 - l.slotw, rotation: l.rotate, force3D: 'auto', ease: w }), (15 * t + 30 * y) / 1500)
        })
      }
      if (1 == a) {
        var x
        ...
        r.find('.slotslide').each(function (t) {
          ...
          n.find('.slotslide').each(function (t) {
            var e = jQuery(this),
              o = (t * z) / l.slots
            5 == a && (o = ((l.slots - t - 1) * z) / l.slots / 1.5),
              T.add(punchgs.TweenLite.from(e, 3 * z, { top: 0 - l.height, opacity: 0.5, rotation: l.rotate, force3D: 'auto', ease: punchgs.eo, delay: o }), 0),
              s.add(T, 0)
          })
      }
      if (6 == a) {
          ...
          n.find('.slotslide').each(function (t) {
            ...
            T.add(
              punchgs.TweenLite.fromTo(
                ...
                { left: 0 - t * l.slotw + 'px', ease: m, force3D: 'auto', top: '0px', width: l.width, height: l.height, opacity: 1, rotation: 0, delay: 0.1 }
              ),
              0
            ),
              s.add(T, 0)
      ...
      if (9 == a || 10 == a) {
        n.find('.slotslide').each(function (t) {
          ...
          0,
            s.add(
              punchgs.TweenLite.fromTo(e, g / 2e3, { autoAlpha: 0, force3D: 'auto', transformPerspective: 600 }, { autoAlpha: 1, ease: w, delay: (t * l.slots) / 100 / 2e3 }),
              0
            )
        })
      }
      ...
      if (11 == a) {
        ...
        switch (u) {
          ...
          case 12:
            ...
            s.add(
              punchgs.TweenLite.fromTo(n, g / 1e3, { autoAlpha: 0, filter: Z, '-webkit-filter': Z }, { autoAlpha: 1, filter: H, '-webkit-filter': H, force3D: 'auto', ease: w }),
              0
            ),
        ...
        s.add(punchgs.TweenLite.set(i.find('.tp-half-one'), { overflow: 'hidden' }), 0),
          ...
          s.add(
            punchgs.TweenLite.fromTo(
              i.find('.tp-half-two'),
              g / 800,
              { width: J, height: N, overflow: 'hidden', position: 'absolute', top: N / 2, left: '0px', force3D: 'auto', transformOrigin: 'center bottom' },
              {
                scale: rt,
                rotation: et,
                y: N + N / 4,
          ...
          n.find('.slotslide').each(function (t) {
            ...
            s.add(
              punchgs.TweenLite.fromTo(
                e,
                g / 1e3,
                { left: 0, rotationX: l.rotate, force3D: 'auto', opacity: E, top: 0, scale: 1, transformPerspective: 1200, transformOrigin: dt, rotationY: lt },
          ...
          r.find('.slotslide').each(function (t) {
            ...
            s.add(
              punchgs.TweenLite.fromTo(
                e,
                g / 1e3,
                { left: 0, rotationX: 0, top: 0, z: 0, scale: 1, force3D: 'auto', transformStyle: 'flat', transformPerspective: 1200, transformOrigin: dt, rotationY: 0 },
