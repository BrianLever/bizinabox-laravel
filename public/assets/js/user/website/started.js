...
function getTemplates(pageUrl = '/account/website/getting-started/getTemplates') {
...
function getDomains() {
  $.ajax({
    url: '/account/website/getting-started/getDomains',
    success: function (result) {
      if (result.status === 1) {
...
function getModules() {
  ...
  $.ajax({
    url: '/account/website/getting-started/getModules',
    data: { orderBy: orderBy, keyword: keyword },
    success: function (result) {
      console.log(result)
      if (result.status === 1) {
        $('.modules_append').html(result.data.view)
...
function saveProgress() {
  $.ajax({
    url: '/account/website/getting-started/saveStep',
    data: {
      step: step,
      name: $('#name').val(),
      package: package,
...
$(document).on('click', '.learn_more_btn', function (e) {
  e.preventDefault()
  $.ajax({
    url: '/account/website/getting-started/getModuleFeatures',
...
$(document).on('click', '.template_item_choose', function (e) {
  ...
  $.ajax({
    url: '/account/website/getting-started/previewTemplate',
    data: { id: $(this).data('id') },
    success: function (result) {
      if (result.status === 1) {
...
$(document).on('click', '#sub_domain_btn', function (e) {
  ...
  $.ajax({
    url: '/account/website/getting-started/checkSubDomain',
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      if (result.status === 0) {
        ...
        $('.tab_step_btn').attr('href', '/account/website/getting-started').removeClass('tab_step_btn')
      }
    },
    error: function (e) {
      console.log(e)
