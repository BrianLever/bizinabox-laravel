...
var alone = 0
var selected
var css, script, page_css, page_script
...
$(function () {
  ...
  page_css = ace.edit('page_css', {
    theme: 'ace/theme/twilight',
    mode: 'ace/mode/html',
    autoScrollEditorIntoView: true
  })

  page_script = ace.edit('page_script', {
    theme: 'ace/theme/twilight',
    mode: 'ace/mode/html',
    autoScrollEditorIntoView: true
  })
...
function getPageTable() {
  $.ajax({
    ...
    success: function (result) {
      console.log(result)
      if (result.status === 1) {
        $('.template_page_area').html(result.data)
      }
    },
    error: function (e) {
      console.log(e)
...
$('#submit_form').submit(function (event) {
  ...
  $.ajax({
    url: '/admin/template/item/edit/' + template_id,
    method: 'POST',
    data: formData,
    dataType: 'JSON',
    contentType: false,
