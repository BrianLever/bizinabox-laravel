...
(function (e) {
  ...
  e(document).mouseup(function () {
      ...
      _setOption: function (e, t) {
        return 'active' === e
          ...
          : ('event' === e && (this.options.event && this._off(this.headers, this.options.event), this._setupEvents(t)),
            ...
            'disabled' === e &&
              (this.element.toggleClass('ui-state-disabled', !!t).attr('aria-disabled', t), this.headers.add(this.headers.next()).toggleClass('ui-state-disabled', !!t)),
            void 0);
      },
      _keydown: function (t) {
    ...
    e.widget('ui.menu', {
      ...
      _move: function (e, t, i) {
        var s;
        this.active &&
          (s = 'first' === e || 'last' === e ? this.active['first' === e ? 'prevAll' : 'nextAll']('.ui-menu-item').eq(-1) : this.active[e + 'All']('.ui-menu-item').eq(0)),
    ...
    e.widget('ui.autocomplete', {
      ...
      _appendTo: function () {
        ...
        return (
          t && (t = t.jquery || t.nodeType ? e(t) : this.document.find(t).eq(0)), (t && t[0]) || (t = this.element.closest('.ui-front')), t.length || (t = this.document[0].body), t
        );
      },
        ...
        'checkbox' === this.type || 'radio' === this.type
          ? ((e = this.element.parents().last()),
            ...
            this.buttonElement.length ||
              ((e = e.length ? e.siblings() : this.element.siblings()), (this.buttonElement = e.filter(t)), this.buttonElement.length || (this.buttonElement = e.find(t))),
  ...
  e.extend(n.prototype, {
    ...
    _showDatepicker: function (t) {
      if (
        ((t = t.target || t), 'input' !== t.nodeName.toLowerCase() && (t = e('input', t.parentNode)[0]), !e.datepicker._isDisabledDatepicker(t) && e.datepicker._lastInput !== t)
      ) {
        var i, n, a, o, h, l, u;
    ...
    _generateMonthYearHeader: function (e, t, i, s, n, a, o, r) {
      ...
      if (a || !g) _ += "<span class='ui-datepicker-month'>" + o[t] + '</span>';
        ...
        for (
          h = s && s.getFullYear() === i, l = n && n.getFullYear() === i, _ += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", u = 0;
          12 > u;
          u++
        )
    ...
    e.widget('ui.draggable', e.ui.mouse, {
      ...
      _convertPositionTo: function (e, t) {
        ...
        return {
          ...
          left:
            t.left + this.offset.relative.left * i + this.offset.parent.left * i - ('fixed' === this.cssPosition ? -this.offset.scroll.left : s ? 0 : this.offset.scroll.left) * i
        };
      },
    ...
    (e.ui.intersect = (function () {
      ...
      return function (t, i, s, n) {
        ...
        switch (s) {
          ...
          case 'intersect':
            return (
              a + t.helperProportions.width / 2 > l && d > r - t.helperProportions.width / 2 && o + t.helperProportions.height / 2 > u && c > h - t.helperProportions.height / 2
            );
          case 'pointer':
  ...
  (e.effects = { effect: {} }),
    ...
    e.widget('ui.sortable', e.ui.mouse, {
            ...
            for (n = e(c[i]), s = n.length - 1; s >= 0; s--)
              (a = e.data(n[s], this.widgetFullName)),
                a &&
                  a !== this &&
                  !a.options.disabled &&
                  (d.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, { item: this.currentItem }) : e(a.options.items, a.element), a]),
      ...
      _clear: function (e, t) {
        ...
        var s,
          n = [];
        if (
          (!this._noFinalSort && this.currentItem.parent().length && this.placeholder.before(this.currentItem), (this._noFinalSort = null), this.helper[0] === this.currentItem[0])
        ) {
    ...
    e.widget('ui.spinner', {
      ...
      _parse: function (e) {
        return (
          'string' == typeof e && '' !== e && (e = window.Globalize && this.options.numberFormat ? Globalize.parseFloat(e, 10, this.options.culture) : +e),
          '' === e || isNaN(e) ? null : e
        );
      },
      _format: function (e) {
