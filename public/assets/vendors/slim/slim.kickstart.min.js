          ...
          (n.scale = function (t, i) {
            ...
            if (
              (v &&
                ...
                (c = i.left || 0),
                (d = i.top || 0),
                i.sourceWidth ? ((l = i.sourceWidth), i.right !== e && i.left === e && (c = y - l - i.right)) : (l = y - c - (i.right || 0)),
                i.sourceHeight ? ((p = i.sourceHeight), i.bottom !== e && i.top === e && (d = w - p - i.bottom)) : (p = w - d - (i.bottom || 0)),
                (b = l),
                (k = p)),
              (r = i.maxWidth),
              (s = i.maxHeight),
              ...
              v && r && s && i.crop
                ? ((b = r),
                  ...
                  m < 0
                    ...
                    : m > 0 && ((l = (r * p) / s), i.left === e && i.right === e && (c = (y - l) / 2)))
                : ((i.contain || i.cover) && ((h = r = r || h), (u = s = s || u)), i.cover ? (a(), o()) : (o(), a())),
              v)
            ) {
              if (
                ((f = i.pixelRatio),
                f > 1 && ((g.style.width = b + 'px'), (g.style.height = k + 'px'), (b *= f), (k *= f), g.getContext('2d').scale(f, f)),
        ...
        (n.hasCanvasOption = function (t) {
          ...
          (n.transformCoordinates = function (t, e) {
            ...
            var i = t.getContext('2d'),
              ...
              u = e.orientation;
            if (u && !(u > 8))
              switch ((u > 4 && ((t.width = a), (t.height = o), (t.style.width = h), (t.style.height = s)), u)) {
                case 2:
              ...
              if (1165519206 === t.getUint32(e + 4) && !(u + 8 > t.byteLength) && 0 === t.getUint16(e + 8)) {
                ...
                42 === t.getUint16(u + 2, r) &&
                  ...
                  s &&
                    ...
                    ((h = { exif: {} }), (s = n.parseExifTags(t, u, u + s, r, h)), h.exif[513] && (o.exif.Thumbnail = n.getExifThumbnail(t, u + h.exif[513], h.exif[514]))),
                  o.exif[34665] && !a.disableExifSub && n.parseExifTags(t, u, u + o.exif[34665], r, o),
                  o.exif[34853] && !a.disableExifGps && n.parseExifTags(t, u, u + o.exif[34853], r, o));
              }
            }
          }),
        ...
        var u = (function () {
            ...
            var s = function (t, i, n) {
                    ...
                    return f.completed()
                      ? void (a.loop > 1 && !f.isStopped()
                          ...
                          : (a.complete && a.complete.call(t),
                            _.length && ((a = _.pop()), (s = y(a, u, !0)), (u = y(a, $(u))), (a = w(s, u, a)), (f = S(a)), i.push([t, f]), f.tick(e), k(o))))
                      : k(o);
                }
              ...
              S = function (t) {
                ...
                var u,
                  ...
                  g = a / o;
                return (
                  (l = t.valueFeeder ? V(t.valueFeeder, i, n, h) : j(i, n, h)),
                  {
                    stop: function () {
                      d = !0;
                    },
              ...
              E = function (t) {
                ...
                return {
                  ...
                  updateMovement: function () {
                    var t = n.getValue();
                    a && ((l.position[0] = i.position[0] * t), (l.position[1] = i.position[1] * t), (l.position[2] = i.position[2] * t)),
                      r && ((l.rotation[0] = i.rotation[0] * t), (l.rotation[1] = i.rotation[1] * t), (l.rotation[2] = i.rotation[2] * t)),
                      s && ((l.rotationPost[0] = i.rotationPost[0] * t), (l.rotationPost[1] = i.rotationPost[1] * t), (l.rotationPost[2] = i.rotationPost[2] * t)),
              ...
              q = function (t) {
                ...
                return {
                  ...
                  asMatrix: function () {
                    ...
                    return (
                      t.clear(),
                      this.transformOrigin && t.translate(-this.transformOrigin[0], -this.transformOrigin[1], -this.transformOrigin[2]),
                      this.scale && t.scale(this.scale[0], this.scale[1]),
                      this.skew && t.skew(this.skew[0], this.skew[1]),
                      this.rotation && (t.rotateX(this.rotation[0]), t.rotateY(this.rotation[1]), t.rotateZ(this.rotation[2])),
                      this.position && t.translate(this.position[0], this.position[1], this.position[2]),
                      this.rotationPost && (t.rotateX(this.rotationPost[0]), t.rotateY(this.rotationPost[1]), t.rotateZ(this.rotationPost[2])),
          ...
          l = (function () {
            ...
            function i(t, e, i, r, s, h) {
              ...
              for (l = 0; l < s; l++) {
                ...
                for (W = N, q = F, u = 0; u < r; u++)
                  (O[f + 3] = I = (y * j) >> V),
                    0 != I ? ((I = 255 / I), (O[f] = ((m * j) >> V) * I), (O[f + 1] = ((g * j) >> V) * I), (O[f + 2] = ((v * j) >> V) * I)) : (O[f] = O[f + 1] = O[f + 2] = 0),
                    (m -= w),
                    (g -= b),
                    (v -= k),
                    (y -= x),
              ...
              for (u = 0; u < r; u++) {
                ...
                for (f = u, W = N, q = F, l = 0; l < s; l++)
                  (c = f << 2),
                    (O[c + 3] = I = (y * j) >> V),
                    I > 0 ? ((I = 255 / I), (O[c] = ((m * j) >> V) * I), (O[c + 1] = ((g * j) >> V) * I), (O[c + 2] = ((v * j) >> V) * I)) : (O[c] = O[c + 1] = O[c + 2] = 0),
                    (m -= w),
                    (g -= b),
                    (v -= k),
                    (y -= x),
            ...
            var o = [
              ...
              a = [
                9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19,
                19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21,
                21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22,
                22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23,
                23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24,
        ...
        var p = (function () {
          ...
          tt = function (t, e, i) {
            var n,
              ...
              r,
              s = e / t;
            return s < i ? ((r = e), (a = r / i), (n = 0.5 * (t - a)), (o = 0)) : ((a = t), (r = a * i), (n = 0), (o = 0.5 * (e - r))), { x: n, y: o, height: r, width: a };
          },
          et = function (t) {
            ...
            if (s) {
              ...
              90 === r
                ? (g.translate(0.5 * a.width, 0.5 * a.height),
                  ...
                  g.drawImage(t, (1 - f) * t.width - t.width * m, s.x, s.height, s.width, 0.5 * -a.height, 0.5 * -a.width, a.height, a.width))
                : 180 === r
                ? (g.translate(0.5 * a.width, 0.5 * a.height),
                  g.rotate((-180 * Math.PI) / 180),
                  g.drawImage(t, (1 - (d + _)) * c.width, (1 - (f + m)) * c.height, _ * c.width, m * c.height, 0.5 * -a.width, 0.5 * -a.height, a.width, a.height))
                : 270 === r
                ? (g.translate(0.5 * a.width, 0.5 * a.height),
                  g.rotate((-270 * Math.PI) / 180),
                  g.drawImage(t, s.y, (1 - d) * t.height - t.height * _, s.height, s.width, 0.5 * -a.height, 0.5 * -a.width, a.height, a.width))
          ...
          at = function (t) {
            return function (e, i, n) {
              for (var o = [0, -1, 0, -1, 5, -1, 0, -1, 0], a = Math.round(Math.sqrt(o.length)), r = (0.5 * a) | 0, s = ot(i, n), h = s.data, u = e.data, l = n, p = void 0; l--; )
                for (p = i; p--; ) {
          ...
          ht = function (t, e) {
            ...
            return (
              ...
              (n.height = t.height),
              o.drawImage(t, 0, 0),
              e > 0 && 1 !== e && i(n, e, { width: Math.round(t.width * e), height: Math.round(t.height * e) }, { width: 0, height: 0 }),
              n
            );
          },
          ut = function (t) {
          ...
          bt = function (t) {
            ...
            return (
              L('input', i) && !a && (r.input.image = yt(t.input.image, t.input.type)),
              L('output', i) &&
                ((r.output = { name: o ? V(t.input.name) + '.' + o : t.input.name, type: w[o] || t.input.type, width: t.output.width, height: t.output.height }),
                (r.output.image = yt(t.output.image, r.output.type, n)),
                (r.output.type = wt(r.output.image)),
                'image/png' === r.output.type && (r.output.name = V(r.input.name) + '.png')),
              L('actions', i) && (r.actions = mt(t.actions)),
              r
            );
          },
          kt = function (t, i, n) {
            var o = t.output.image,
              ...
              r = w[n] || t.input.type;
            'image/png' === r && (a = V(t.input.name) + '.png'),
              o.toBlob(
                function (t) {
            ...
            var i = {
              n: function (t, e, i, n) {
                ...
                return (
                  ...
                  (s < 0 || Math.round(a) > Math.round(i.width)) &&
                    ((p = Math.min(t.x, i.width - (t.x + t.width))), (s = t.x - p), (a = t.x + t.width + p), (h = a - s), (u = h * n), (o = r - u)),
              ...
              s: function (t, e, i, n) {
                ...
                return (
                  ...
                  (a = t.x + t.width + l),
                  (s < 0 || Math.round(a) > Math.round(i.width)) &&
                    ((p = Math.min(t.x, i.width - (t.x + t.width))), (s = t.x - p), (a = t.x + t.width + p), (h = a - s), (u = h * n), (r = o + u)),
                  { x: s, y: o, width: a - s, height: r - o }
                );
              },
              e: function (t, e, i, n) {
                ...
                return (
                  ...
                  (o < 0 || Math.round(r) > Math.round(i.height)) &&
                    ((p = Math.min(t.y, i.height - (t.y + t.height))), (o = t.y - p), (r = t.y + t.height + p), (u = r - o), (h = u / n), (a = s + h)),
                  { x: s, y: o, width: a - s, height: r - o }
                );
              },
              w: function n(t, e, i, o) {
                ...
                return (
                  ...
                  (a < 0 || Math.round(s) > Math.round(i.height)) &&
                    ((p = Math.min(t.y, i.height - (t.y + t.height))), (a = t.y - p), (s = t.y + t.height + p), (u = s - a), (n = u / o), (h = r - n)),
              ...
              ne: function (t, e, i, n) {
                ...
                return (
                  ...
                  (a = I(e.x, s, i.width)),
                  a - s < i.min.width && (a = s + i.min.width),
                  (u = n ? (a - s) * n : I(r - e.y, i.min.height, r)),
                  u < i.min.height && ((u = i.min.height), (a = s + u / n)),
                  (o = t.y - (u - t.height)),
                  (o < 0 || Math.round(r) > Math.round(i.height)) && ((l = Math.min(t.y, i.height - (t.y + t.height))), (o = t.y - l), (u = r - o), (h = u / n), (a = s + h)),
                  { x: s, y: o, width: a - s, height: r - o }
                );
              },
              se: function (t, e, i, n) {
                ...
                return (
                  ...
                  (a = I(e.x, s, i.width)),
                  a - s < i.min.width && (a = s + i.min.width),
                  (u = n ? (a - s) * n : I(e.y - t.y, i.min.height, i.height - o)),
                  u < i.min.height && ((u = i.min.height), (a = s + u / n)),
                  (r = t.y + t.height + (u - t.height)),
                  (o < 0 || Math.round(r) > Math.round(i.height)) &&
                    ((l = Math.min(t.y, i.height - (t.y + t.height))), (r = t.y + t.height + l), (u = r - o), (h = u / n), (a = s + h)),
                  { x: s, y: o, width: a - s, height: r - o }
                );
              },
              sw: function (t, e, i, n) {
                ...
                return (
                  ...
                  (r = t.y + t.height + (u - t.height)),
                  (o < 0 || Math.round(r) > Math.round(i.height)) &&
                    ((l = Math.min(t.y, i.height - (t.y + t.height))), (r = t.y + t.height + l), (u = r - o), (h = u / n), (s = a - h)),
                  { x: s, y: o, width: a - s, height: r - o }
                );
              },
              nw: function (t, e, i, n) {
                ...
                return (
                  ...
                  u < i.min.height && ((u = i.min.height), (s = a - u / n)),
                  (o = t.y - (u - t.height)),
                  (o < 0 || Math.round(r) > Math.round(i.height)) && ((l = Math.min(t.y, i.height - (t.y + t.height))), (o = t.y - l), (u = r - o), (h = u / n), (s = a - h)),
                  { x: s, y: o, width: a - s, height: r - o }
                );
              }
            };
                ...
                p(n, [
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      this._element.contains(t.target) &&
                        (t.preventDefault(),
                        x(document, y.MOVE, this),
                        x(document, y.UP, this),
                        (this._interaction = { type: t.target.className, offset: P(t) }),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      'c' === n
                        ? ((this._rect.x = I(e.x - this._interaction.offset.x, 0, this._space.width - this._rect.width)),
                          (this._rect.y = I(e.y - this._interaction.offset.y, 0, this._space.height - this._rect.height)))
                        : i[n] &&
                          (this._rect = i[n](
                            this._rect,
                            { x: e.x - this._space.x, y: e.y - this._space.y },
                            { x: 0, y: 0, width: this._space.width, height: this._space.height, min: { width: this._minWidth, height: this._minHeight } },
                            this._ratio
                          )),
                        (this._rectChanged = !0),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      t.preventDefault(),
                        S(document, y.MOVE, this),
                        S(document, y.UP, this),
                        (this._interaction = null),
                    ...
                    [
                      {
                        ...
                        value: function () {
                          ...
                          (this._element.className = 'slim-image-editor'),
                            (this._container = k('div', 'slim-container')),
                            (this._wrapper = k('div', 'slim-wrapper')),
                            (this._stage = k('div', 'slim-stage')),
                            this._container.appendChild(this._stage),
                            (this._cropper = new Tt()),
                            i.forEach(function (e) {
                              t._cropper.element.addEventListener(e, t);
                            }),
                            this._stage.appendChild(this._cropper.element),
                            (this._previewWrapper = k('div', 'slim-image-editor-preview slim-crop-preview')),
                            (this._previewBlurred = k('canvas', 'slim-crop-blur')),
                            this._previewWrapper.appendChild(this._previewBlurred),
                            this._wrapper.appendChild(this._previewWrapper),
                            (this._previewMask = k('div', 'slim-crop-mask')),
                            (this._preview = k('img')),
                            this._previewMask.appendChild(this._preview),
                            this._cropper.element.appendChild(this._previewMask),
                            (this._btnGroup = k('div', 'slim-editor-btn-group')),
                      ...
                      },
                      {
                        ...
                        value: function (t, e, i, n, o) {
                          ...
                          (this._preview.onload = function () {
                            ...
                            (this._preview.src = ''),
                            (this._preview.src = ht(
                              this._input,
                              Math.min(this._container.offsetWidth / this._input.width, this._container.offsetHeight / this._input.height) * this._options.devicePixelRatio
                            ).toDataURL());
                        }
                      },
                      {
                        ...
                        value: function (t) {
                          ...
                          var p = null;
                          (p = t ? { x: t.x * s, y: t.y * h, width: t.width * s, height: t.height * h } : tt(s, h, this._ratio || h / s)),
                        ...
                        value: function () {
                          ...
                          (this._wrapper.style.cssText = '\n\t\t\t\tleft:' + a + 'px;\n\t\t\t\ttop:' + r + 'px;\n\t\t\t\twidth:' + n + 'px;\n\t\t\t\theight:' + o + 'px;\n\t\t\t'),
                            ...
                            this._blurredPreview ||
                              ...
                              lt(this._input, this._previewBlurred),
                              pt(this._previewBlurred, 3),
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          (this._currentWindowSize.width === window.innerWidth && this._currentWindowSize.height === window.innerHeight) ||
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          document.removeEventListener('keydown', this),
                            ...
                            u(this._utilsGroup.childNodes, { fromOpacity: 1, opacity: 0, duration: 250 }),
                            u(this._btnGroup.childNodes, { fromOpacity: 1, opacity: 0, delay: 200, duration: 350 }),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      return (
                        !this._accept.length ||
                        !t ||
                        (this._allowURLs && 'string' === t[0].kind ? null : t[0].type && 0 === t[0].type.indexOf('application') ? null : this._accept.indexOf(t[0].type) !== -1)
                      );
                    }
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      return null === e || e
                        ? (this._dragPath || (this._dragPath = []),
                          this._dragPath.push(m(t)),
                          void this._element.dispatchEvent(new CustomEvent('file-over', { detail: { x: T(this._dragPath).x, y: T(this._dragPath).y } })))
                ...
                p(i, [
                  {
                    key: '_init',
                    value: function () {
                      (this._element = k('div', 'slim-popover')),
          ...
          Gt = (function () {
            function i(n) {
              ...
              t(this, i),
                Ft || (Ft = new Ot()),
                (this._uid = Wt++),
                (this._options = g(i.options(), o)),
                this._options.forceSize &&
                  ('string' == typeof this._options.forceSize && (this._options.forceSize = Vt(this._options.forceSize)),
                  (this._options.ratio = this._options.forceSize.width + ':' + this._options.forceSize.height),
                  (this._options.size = mt(this._options.forceSize))),
                'string' == typeof this._options.size && (this._options.size = Vt(this._options.size)),
                'string' == typeof this._options.minSize && (this._options.minSize = Vt(this._options.minSize)),
                ...
                (this._originalElementAttributes = _(n)),
                Dt(n)
                  ? (this._element = n)
                  : ((this._element = Ct(n)), (this._element.className = n.className), (n.className = ''), this._element.setAttribute('data-ratio', this._options.ratio)),
              ...
              p(
                ...
                [
                  ...
                  },
                  {
                    key: 'setSize',
                    value: function (t, e) {
                      'string' == typeof t && (t = Vt(t)),
                        t && t.width && t.height && ((this._options.size = mt(t)), (this._data.actions.size = mt(t)), this._data.input.image && e && this._manualTransform(e));
                    }
                  },
                  {
                    key: 'setForceSize',
                    value: function (t, e) {
                      'string' == typeof t && (t = Vt(t)),
                        t &&
                          t.width &&
                          t.height &&
                          ((this._options.size = mt(t)),
                          (this._options.forceSize = mt(t)),
                          (this._data.actions.size = mt(t)),
                        ...
                        (this._ratio = n[1] / n[0]),
                          this._data.input.image && e
                            ...
                            : (this._data.input.image &&
                                ((this._data.actions.crop = tt(this._data.input.image.width, this._data.input.image.height, this._ratio)),
                                (this._data.actions.crop.type = At.AUTO)),
                    ...
                    value: function (t) {
                      ...
                      'function' == typeof i
                        ...
                        : ((this._options.crop = i.crop),
                          ...
                          (this._initialRotation = i.rotation && i.rotation % 90 === 0 ? i.rotation : null),
                          (this._initialCrop = this._options.crop)),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (
                        ...
                        L('input', this._options.post) && (this._inputReference = 'slim_input_' + this._uid),
                        (this._input = this._getInputElement()),
                        this._input || ((this._input = k('input')), (this._input.type = 'file'), this._element.appendChild(this._input)),
                      ...
                      if (this._isImageOnly())
                        ...
                        this._input.hasAttribute('accept') && 'image/*' !== this._input.getAttribute('accept')
                          ...
                          : ((u = A()), this._input.setAttribute('accept', u.join(','))),
                          (this._imageHopper = new Lt()),
                      ...
                      if (
                        ...
                        (this._btnGroup = k('div', 'slim-btn-group')),
                    ...
                    value: function (t) {
                      if (((t = Math.min(0.99999, t)), this._element && this._progressEnabled)) {
                        ...
                        if (e) {
                          ...
                          n[0].setAttribute('d', Rt(0.5 * i, 0.5 * i, 0.5 * i - o, 0.9999)), n[1].setAttribute('d', Rt(0.5 * i, 0.5 * i, 0.5 * i - o, t));
                        }
                      }
                    }
                  },
                        ...
                        if (e) {
                          ...
                          this._updateProgress(1),
                            u(i, {
                              ...
                              duration: 250,
                              complete: function () {
                                e.removeAttribute('style'), i.removeAttribute('style'), t._updateProgress(0.5), (t._progressEnabled = !1);
                              }
                            });
                        }
                      }
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      e || ((e = k('div', 'slim-error')), this._element.querySelector('.slim-status').appendChild(e)),
                        (e.innerHTML = t),
                    ...
                    value: function (t) {
                      ...
                      i.translate(t.detail.x, t.detail.y, 0),
                        ...
                        1 == this._imageHopper.dragPath.length &&
                          ((e.style.opacity = 1), u(e.firstChild, { fromOpacity: 0, opacity: 0.5, fromScale: [0, 0], scale: [0.5, 0.5], duration: 150 }));
                    }
                  },
                  {
                    key: '_onFileOut',
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      var o = this._imageHopper.dragPath.length,
                        ...
                        r = t.detail.x - a.x,
                        s = t.detail.y - a.y;
                      u(i, { fromPosition: [t.detail.x, t.detail.y, 0], position: [t.detail.x + r, t.detail.y + s, 0], duration: 200 }),
                        u(i.firstChild, {
                          fromScale: [0.5, 0.5],
                          scale: [2, 2],
                          fromOpacity: 1,
                    ...
                    value: function (t, i) {
                      ...
                      if (!this._isBeingDestroyed) {
                        ...
                        if ('undefined' != typeof t.remote)
                          return X(t.remote)
                            ? void this._load(Z(t.remote), i, o)
                            : void (
                        ...
                        if (s.size && this._options.maxFileSize && D(s.size) > this._options.maxFileSize)
                          return r(), this._onOverWeightFile(), void (i && i.apply(this, ['file-too-big']));
                        this._imageEditor && this._imageEditor.dirty(),
                          (this._data.input.name = o && o.name ? o.name : q(s)),
                          (this._data.input.type = j(s)),
                          (this._data.input.size = s.size),
                          (this._data.input.file = s),
                          Q(s, this._options.internalCanvasSize, function (t, e) {
                            var a = function () {
                            ...
                            var h = function (t) {
                              ...
                              n.isDetached() ? (i.duration = 1) : ((i.easing = 'spring'), (i.springConstant = 0.3), (i.springDeceleration = 0.7)),
                                n._canInstantEdit() && ((i.delay = 500), (i.duration = 1), n._doEdit()),
                                u(e, i);
                            };
                            n._loadCanvas(
                              t,
                    ...
                    value: function (t, e, i, n) {
                      ...
                      if ((n || (n = {}), !this._isBeingDestroyed)) {
                        (this._data.input.image = t),
                          ...
                          this._initialRotation && ((this._data.actions.rotation = this._initialRotation), (this._initialRotation = null));
                        var a = this._data.actions.rotation % 180 !== 0;
                        this._isFixedRatio() ||
                          (this._initialCrop ? (this._ratio = this._initialCrop.height / this._initialCrop.width) : (this._ratio = a ? t.width / t.height : t.height / t.width),
                          this._scaleDropArea(this._ratio));
                        var r = function () {
                          o._options.size && (o._data.actions.size = { width: o._options.size.width, height: o._options.size.height }),
                        ...
                        this._initialCrop
                          ? ((this._data.actions.crop = mt(this._initialCrop)), (this._data.actions.crop.type = At.INITIAL), (this._initialCrop = null), r())
                          : this._options.willCropInitial.apply(this, [
                              this.data,
                              function (e) {
                                e
                                  ? ((o._data.actions.crop = e), (o._data.actions.crop.type = At.INITIAL))
                                  : ((o._data.actions.crop = tt(a ? t.height : t.width, a ? t.width : t.height, o._ratio)), (o._data.actions.crop.type = At.AUTO)),
                                  r();
                              },
                              this
                            ]);
                  ...
                  },
                  {
                    ...
                    value: function (t, e) {
                      ...
                      (n.filters = { sharpen: this._options.filterSharpen / 100 }),
                        this._options.forceMinSize ? (n.minSize = this._options.minSize) : (n.minSize = { width: 0, height: 0 }),
                        et(t, n, function (t) {
                          var n = t;
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var t = this;
                      this._imageEditor ||
                        ((this._imageEditor = new It(k('div'), {
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      i
                        ...
                        (this._data.actions.crop.type = At.MANUAL),
                        this._applyTransforms(this._data.input.image, function (t) {
                          ...
                          (o.src = ''),
                            (o.src = ht(t, (o.offsetWidth / t.width) * r).toDataURL()),
                            (o.onload = function () {
                    ...
                    value: function (t) {
                      ...
                      this._startProgressLoop(),
                        ...
                        this._applyTransforms(this._data.input.image, function (i) {
                          ...
                          var r = 'auto' === e._options.devicePixelRatio ? window.devicePixelRatio : e._options.devicePixelRatio;
                          (o.src = ''),
                            (o.src = ht(i, (o.offsetWidth / i.width) * r).toDataURL()),
                            (o.onload = function () {
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      this._isRequired && (this._input.required = !1),
                        (this._data.server = t),
                        (this._output.value = 'object' === ('undefined' == typeof t ? 'undefined' : c(t)) ? JSON.stringify(this._data.server) : t);
                    }
                  },
                  {
                    key: '_store',
                    ...
                    value: function (t, e) {
                      ...
                      this.requestOutput(function (t, n) {
                        ...
                        'string' == typeof i._options.service
                          ? O(i._options.service, i._options.uploadMethod, n, a, r, s, h)
                          : 'function' == typeof i._options.service && i._options.service.apply(i, ['file' === i._options.serviceFormat ? t : n, r, s, h, i]);
                      }, t);
                    }
                  },
                  {
                          ...
                          void n.parseMetaData(
                            ...
                            function (o) {
                              var a = [],
                                r = new FormData();
                              if (
                                (L('input', i._options.post) && (a.push(i._data.input.file), r.append(i._inputReference, i._data.input.file, i._data.input.file.name)),
                                L('output', i._options.post) && null !== i._data.output.image && i._options.uploadBase64 === !1)
                              ) {
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      if (this._btnGroup) {
                        ...
                        this.isDetached() ? (i.duration = 1) : ((i.easing = 'spring'), (i.springConstant = 0.3), (i.springDeceleration = 0.75)), u(this._btnGroup.childNodes, i);
                      }
                    }
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      this._data.input.image &&
                        ...
                        (Ft.inner = this._imageEditor.element),
                        this._imageEditor.open(
                          st(this._data.input.image),
                    ...
                    value: function () {
                      ...
                      (this._isBeingDestroyed = !0),
                        ...
                        this._imageEditor &&
                          ...
                          (this._imageEditor = null)),
                        St(this._btnGroup.children).forEach(function (t) {
