    ...
    elFinder.prototype.commands.quicklook.plugins.push(function (ql) {
      ...
      preview.on('update', function (e) {
        ...
        if (file.mime.indexOf('application/vnd.google-apps.') === 0) {
          if (file.url == '1') {
            preview.hide();
            $('<div class="elfinder-quicklook-info-data"><button class="elfinder-info-button">' + fm.i18n('getLink') + '</button></div>')
          ...
          if (file.url !== '' && file.url != '1') {
            ...
            loading = $(
              '<div class="elfinder-quicklook-info-data"><span class="elfinder-spinner-text">' + fm.i18n('nowLoading') + '</span><span class="elfinder-spinner"/></div>'
            ).appendTo(ql.info.find('.elfinder-quicklook-info'));
