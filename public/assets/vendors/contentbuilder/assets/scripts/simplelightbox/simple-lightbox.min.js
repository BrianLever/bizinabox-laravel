  ...
  t.fn.simpleLightbox = function (n) {
    var a,
      ...
      k = t('<div>')
        ...
        .html('<button class="sl-prev">' + n.navText[0] + '</button><button class="sl-next">' + n.navText[1] + '</button>'),
      ...
      P = function (e) {
        e.trigger(t.Event('show.simplelightbox')),
          n.disableScroll && (h = K('hide')),
          R.appendTo('body'),
          A.appendTo(R),
          n.overlay && T.appendTo(t('body')),
          (q = !0),
          (D = d.index(e)),
          (l = t('<img/>').hide().attr('src', e.attr(n.sourceAttr))),
          -1 == p.indexOf(e.attr(n.sourceAttr)) && p.push(e.attr(n.sourceAttr)),
          A.html('').attr('style', ''),
          l.appendTo(A),
          X(),
          T.fadeIn('fast'),
            ...
            (a.onload = function () {
              void 0 !== i &&
                d
                  ...
                  .trigger(t.Event((1 === i ? 'nextDone' : 'prevDone') + '.simplelightbox')),
                n.history && w(),
              ...
              t('.sl-image').css({ top: (t(e).height() - u) / 2 + 'px', left: (t(e).width() - r - h) / 2 + 'px' }),
                S.hide(),
                l.css({ width: r + 'px', height: u + 'px' }).fadeIn('fast'),
                (c = !0);
              var m,
                v = 'self' == n.captionSelector ? d.eq(D) : d.eq(D).find(n.captionSelector);
              if (
                ((m = 'data' == n.captionType ? v.data(n.captionsData) : 'text' == n.captionType ? v.html() : v.prop(n.captionsData)),
                n.loop || (0 === D && t('.sl-prev').hide(), D >= d.length - 1 && t('.sl-next').hide(), D > 0 && t('.sl-prev').show(), D < d.length - 1 && t('.sl-next').show()),
                ...
                n.animationSlide &&
                  (g
                    ...
                    : (b.left = parseInt(t('.sl-image').css('left')) + 100 * i + 'px')),
                  t('.sl-image').animate(b, n.animationSpeed, function () {
                    (q = !1), L(m);
                  });
              } else (q = !1), L(m);
      ...
      X = function () {
        t(e).on('resize.' + E, z),
          t(i).on('click.simplelb touchstart.' + E, '.sl-close', function (t) {
          ...
          k.on('click.' + E, 'button', function (e) {
        ...
        A.on('touchstart.simplelb mousedown.' + E, function (t) {
          ...
          .on('touchmove.simplelb mousemove.simplelb pointermove MSPointerMove', function (t) {
            if (!h) return !0;
            t.preventDefault(),
              (l = t.originalEvent.pageX || t.originalEvent.touches[0].pageX),
              (p = t.originalEvent.pageY || t.originalEvent.touches[0].pageY),
              (o = a - l),
              (s = r - p),
              n.animationSlide && (g ? W(0, -o + 'px') : A.css('left', u - o + 'px'));
          })
          .on('touchend.simplelb mouseup.simplelb touchcancel.simplelb mouseleave.simplelb pointerup pointercancel MSPointerUp MSPointerCancel', function (t) {
            if (h) {
              h = !1;
              var e = !0;
              n.loop || (0 === D && o < 0 && (e = !1), D >= d.length - 1 && o > 0 && (e = !1)),
                Math.abs(o) > n.swipeTolerance && e
                  ? j(o > 0 ? 1 : -1)
                  : n.animationSlide && (g ? W(n.animationSpeed / 1e3, '0px') : A.animate({ left: u + 'px' }, n.animationSpeed / 2)),
                n.swipeClose && Math.abs(s) > 50 && Math.abs(o) < n.swipeTolerance && H();
            }
          });
      },
      N = function () {
      ...
      j = function (e) {
        d.eq(D)
          ...
          .trigger(t.Event((1 === e ? 'next' : 'prev') + '.simplelightbox'));
        var i = D + e;
        if (!(q || ((i < 0 || i >= d.length) && !1 === n.loop))) {
          (D = i < 0 ? d.length - 1 : i > d.length - 1 ? 0 : i), t('.sl-wrapper .sl-counter .sl-current').text(D + 1);
          var a = { opacity: 0 };
          n.animationSlide && (g ? W(n.animationSpeed / 1e3, -100 * e - o + 'px') : (a.left = parseInt(t('.sl-image').css('left')) + -100 * e + 'px')),
      ...
      H = function () {
        if (!q) {
          var e = d.eq(D),
            i = !1;
          e.trigger(t.Event('close.simplelightbox')),
            n.history && y(),
