$(document).ready(function (e) {
  $('.is-arrow-down a').on('click', function (e) {
    if ($(this).parents('.is-section').nextAll('div:not(.is-hidden)').html()) {
      /* .hidden class can be used as an exception */
      $('html,body').animate(
        {
          scrollTop:
            $(this).parents('.is-section').nextAll('div:not(.is-hidden)').offset().top - parseInt($('.is-wrapper').css('padding-top')) /* + 1 Adjustment due to topbar height*/
        },
        800
      );
    }
  ...
  if ($(window).scrollTop() == 0) {
    //on editing, appear not triggered on first load (on top only). This is the fix.
        ...
        null !== f
          ? null !== d.activeBreakpoint
            ...
            : ((d.activeBreakpoint = f),
              ...
              (h = f))
          : null !== d.activeBreakpoint &&
            ((d.activeBreakpoint = null), (d.options = d.originalSettings), b === !0 && (d.currentSlide = d.options.initialSlide), d.refresh(b), (h = f)),
    ...
    (b.prototype.setProps = function () {
      ...
      (a.positionProp = a.options.vertical === !0 ? 'top' : 'left'),
        ...
        void 0 !== b.msTransform &&
          ((a.animType = 'msTransform'), (a.transformType = '-ms-transform'), (a.transitionType = 'msTransition'), void 0 === b.msTransform && (a.animType = !1)),
  ...
  var X = function () {
    ...
    $ = function () {
      ...
      var a,
        ...
        e = Ha();
      if (oa)
        e >= oa.endTime ? ((d = oa.targetTop), (a = oa.done), (oa = c)) : ((b = oa.easing((e - oa.startTime) / oa.duration)), (d = (oa.startTop + b * oa.topDiff) | 0)),
          ha.setScrollTop(d, !0);
      else if (!sa) {
  ...
  var ha,
    ...
    Ca = function () {
      var a,
        b = 0;
      return (
        ja && (b = i.max(ja.offsetHeight, ja.scrollHeight)), (a = i.max(b, f.scrollHeight, f.offsetHeight, e.scrollHeight, e.offsetHeight, e.clientHeight)), a - e.clientHeight
      );
    },
    Da = function (b) {
      var c = 'className';
