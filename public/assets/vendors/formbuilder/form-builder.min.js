  ...
  !(function (e) {
    ...
    function (t, r, n) {
      ...
      var l = function (e) {
        ...
        c = function (e, t) {
          ...
          return (
            (e = p(e)),
            t && (Array.isArray(t) ? (r = k(t.join(' '))) : ('boolean' == typeof t && (t = t.toString()), (r = k(t.trim())))),
            { name: e, value: (t = t ? '="' + r + '"' : '') }
          );
        },
        d = function e(t) {
          ...
          Array.isArray(t) || (t = [t]),
            t.forEach(function (t) {
              var n = 'href',
                ...
                i = '';
              if (
                ('object' == typeof t && ((n = t.type || (t.style ? 'inline' : 'href')), (i = t.id), (t = 'inline' == n ? t.style : t.href), (o = i || t.href || t.style)),
                !L(o, 'css'))
              ) {
                if ('href' == n) {
        ...
        I = function (e) {
          var t = (e = Array.isArray(e) ? e : [e]).map(function (e) {
            ...
            return new Promise(function (e, n) {
              ...
              var o = v('link', null, { href: t, rel: 'stylesheet', id: r });
        ...
        P = {
          ...
          merge: function e(t, r) {
            ...
            for (var o in r)
              n.hasOwnProperty(o) &&
                (Array.isArray(r[o]) ? (n[o] = Array.isArray(t[o]) ? q(t[o].concat(r[o])) : r[o]) : 'object' == typeof r[o] ? (n[o] = e(t[o], r[o])) : (n[o] = r[o]));
            return n;
          },
          mobileClass: B,
          nameAttr: h,
      ...
      e.exports = (function (e) {
        ...
        function (e, t, r) {
          ...
          (n.prototype = new Error()),
            ...
            (e.exports = function (e) {
              for (
                var t, r, o = String(e), i = '', a = 0, l = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
                o.charAt(0 | a) || ((l = '='), a % 1);
    ...
    function (e, t, r) {
      ...
      var o = {
        ...
        i = { btn: ['default', 'danger', 'info', 'primary', 'success', 'warning'] },
      ...
      var l = (function (e) {
        ...
        return (
          ...
          (u.register = function (e, t) {
            ...
            for (o = a ? o : o[Symbol.iterator](); ; ) {
              ...
              if (!e[c]) {
                ...
                if (!p) {
                  this.error(
                    'Error while registering custom field: ' + c + (f.subtype ? ':' + f.subtype : '') + '. Unable to find any existing defined control or template for rendering.'
                  );
                  continue;
                }
          ...
          (u.prototype.build = function () {
            ...
            for (
              var t = Object.assign(this.config), r = 0, n = ['label', 'description', 'subtype', 'id', 'isPreview', 'required', 'title', 'aria-required', 'type'];
              r < n.length;
              r++
            ) {
              var o = n[r];
            ...
            (t.help = function () {
              return this.data.description
                ? this.isTemplate('help')
                  ...
                  : this.markup('span', '?', { className: 'tooltip-element', tooltip: this.data.description })
                : null;
            }),
    ...
    function (t, r, n) {
      ...
      var l = (function (t) {
        ...
        return (
          (f.build = function () {
            ...
            return f.push(this.markup('ul', c, { id: o.id + '-list', className: 'fb-' + n + '-list' })), f;
          }),
      ...
      o.a.register(['paragraph', 'header'], d),
        ...
        o.a.register(['h1', 'h2', 'h3', 'h4'], d, 'header');
      var b = (function (t) {
        var r, n;
        function i() {
          return t.apply(this, arguments) || this;
        ...
        return (
          (u.build = function () {
            var e = [],
              ...
              c = 'select' === i;
            if (
              ((u.multiple || 'checkbox-group' === i) && (u.name = u.name + '[]'), 'checkbox-group' === i && u.required && (this.onRender = this.groupRequired), delete u.title, r)
            ) {
    ...
    function (t, r, n) {
          ...
          return (
            ...
            (r.updatePreview = function (t) {
              ...
              if (!n.includes('input-control')) {
                ...
                i.match(r.optionFieldsRegEx) &&
                  ...
                  ((s = Object(p.y)(s)).className = this.classNames(o, s)),
                  t.data('fieldData', s);
            ...
            (r.dialog = function (e, t, r) {
              ...
              return (
                t
                  ...
                  : ((t = { pageX: Math.max(n, window.innerWidth || 0) / 2, pageY: Math.max(o, window.innerHeight || 0) / 2 }), (i.style.position = 'fixed')),
            ...
            (r.removeField = function (t, r) {
              ...
              if (!t) {
                ...
                m.a.opts.notify.warning('fieldID required to remove specific fields.'),
                  ...
                  m.a.opts.notify.warning('Available IDs: ' + l.join(', ')),
                  (t = i.lastChild.id);
              }
            ...
            (r.processActionButtons = function (e) {
              var t = e.label,
                ...
                o = t,
                i = this.data;
              (o = o ? f.a.current[o] || o : n.id ? f.a.current[n.id] || Object(p.d)(n.id) : ''),
      ...
      var A = function (e, t, r) {
          ...
          var S = function (t, n) {
              ...
              u && (o.style = u[1]),
                n &&
                  ((o = Object.assign({}, o, e.onAddField(b.lastID, o))),
                  setTimeout(function () {
            ...
            B = function (t) {
              var r,
                ...
                i = (function (e) {
                  ...
                  var o = n[e];
                  return (
                    'radio-group' === e && Object(p.u)('toggle', o),
                    ['header', 'paragraph', 'button'].includes(e) && Object(p.u)('description', o),
                  ...
                  for (var o in e)
                    if (e.hasOwnProperty(o)) {
                      var i = R(o, e[o]),
                        ...
                        u = s.value || '';
                      (s.value = t[o] || s.value || ''),
                        s.label && (l[o] = Array.isArray(s.label) ? f.a.get.apply(f.a, s.label) || s.label[0] : s.label),
                        n[i] && r.push(n[i](o, s)),
                        (l[o] = a),
                        (s.value = u);
                    }
          ...
          var I = function (e, t, r) {
            ...
            P = function (e, t) {
              ...
              return O('div', ['<label for="' + d.id + '">' + c + '</label>', '<div class="input-wrap">' + m + '</div>'], { className: 'form-group ' + e + '-wrap' }).outerHTML;
            },
            U = function (e, t, r) {
            ...
            H = function (t, r, n) {
              ...
              if (
                ...
                'label' !== t || e.disableHTMLLabels
                  ? ((s.value = o), (s.type = 'text'), (l += '<input ' + Object(p.b)(s) + '>'))
                  : ((s.contenteditable = !0), (l += O('div', o, s).outerHTML));
            ...
            V = function (t, n) {
              ...
              c.push(O('label', Object(p.t)(a), { className: 'field-label' })),
                c.push(O('span', ' *', { className: 'required-asterisk', style: t.required ? 'display:inline' : '' }));
          ...
          if (
            ...
            q.on('blur', 'input.fld-name', function (e) {
              (e.target.value = Object(p.w)(e.target.value)),
                '' === e.target.value ? r(e.target).addClass('field-error').attr('placeholder', f.a.get('cannotBeEmpty')) : r(e.target).removeClass('field-error');
            }),
              ...
              toggleFieldEdit: function (e) {
                (Array.isArray(e) ? e : [e]).forEach(function (e) {
                  ['number', 'string'].includes(typeof e) &&
                    ('number' == typeof e ? (e = h.stage.children[e].id) : /^frmb-/.test(e) || (e = h.stage.querySelector(e).id), A.toggleEdit(e));
                });
              },
