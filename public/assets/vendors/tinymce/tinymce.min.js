...
!(function (j) {
  ...
  var et,
        ...
        return {
          ...
          deviceType: (function (e, t, n, r) {
            var o = e.isiOS() && !0 === /ipad/i.test(n),
              ...
              f = !s && !c && !l;
            return { isiPad: $(o), isiPhone: $(i), isTablet: $(c), isPhone: $(s), isTouch: $(u), isAndroid: e.isAndroid, isiOS: e.isiOS, isWebView: $(l), isDesktop: $(f) };
          })(i, o, e, t)
        };
    ...
    Mt = (j.Node.DOCUMENT_TYPE_NODE, j.Node.DOCUMENT_FRAGMENT_NODE, j.Node.ELEMENT_NODE),
    Rt = j.Node.TEXT_NODE,
    ...
    Pt = ('undefined' != typeof j.window ? j.window : Function('return this;')(), He(Mt)),
    Lt = He(Rt),
    Vt = function (n, r) {
      return {
        left: $(n),
    ...
    rn = {
      getPos: function (e, t, n) {
        var r,
          ...
          u = e.ownerDocument;
        if (((n = n || e), t)) {
          if (n === e && t.getBoundingClientRect && 'static' === Ge(it.fromDom(e), 'position'))
            return {
  ...
  var Pn = {
    ...
    Wn = {
      ...
      deviceType: { isDesktop: Un.isDesktop, isiPad: Un.isiPad, isiPhone: Un.isiPhone, isPhone: Un.isPhone, isTablet: Un.isTablet, isTouch: Un.isTouch, isWebView: Un.isWebView }
    },
    Kn = Array.isArray,
    Xn = {
      isArray: Kn,
  ...
  var Sr = {
    ...
    Hr = function (e) {
      function t(e, t, n) {
        ...
        var o, i, a;
        for (t = t || '', 'string' == typeof (n = n || []) && (n = Or(n)), o = (e = Or(e)).length; o--; )
          (a = { attributes: r((i = Or([u, t].join(' ')))), attributesOrder: i, children: r(n, Tr) }), (s[e[o]] = a);
      }
      function n(e, t) {
        var n, r, o, i;
  ...
  function Pr(i) {
    ...
    (r = Hr((i = i || {}).schema)),
      ...
      Mr((i.special || 'script noscript noframes noembed title style textarea xmp').split(' '), function (e) {
        v[e] = new RegExp('</' + e + '[^>]*>', 'gi');
      });
    function N(e) {
    ...
    function y(e) {
      var t,
        ...
        x = /[*?+]/;
      if (e)
        for (e = Or(e, ','), z['@'] && ((p = z['@'].attributes), (v = z['@'].attributesOrder)), t = 0, n = e.length; t < n; t++)
          if ((i = C.exec(e[t]))) {
            if (
              ((m = i[1]),
              (s = i[2]),
            ...
            if (c)
              for (r = 0, o = (c = Or(c, '|')).length; r < o; r++)
                if ((i = w.exec(c[r]))) {
                  ...
                  m &&
                    ('=' === m && ((a.attributesDefault = a.attributesDefault || []), a.attributesDefault.push({ name: l, value: b }), (u.defaultValue = b)),
                    ':' === m && ((a.attributesForced = a.attributesForced || []), a.attributesForced.push({ name: l, value: b }), (u.forcedValue = b)),
                    '<' === m && (u.validValues = Ar(b, '?'))),
                    x.test(l) ? ((a.attributePatterns = a.attributePatterns || []), (u.pattern = N(l)), a.attributePatterns.push(u)) : (d[l] || h.push(l), (d[l] = u));
                }
  ...
  function Fr(e, t) {
    ...
    return (
      ...
      !(r.stopImmediatePropagation = function () {
        ...
        })(r) && ((r.isDefaultPrevented = Xr), (r.isPropagationStopped = Xr), (r.isImmediatePropagationStopped = Xr)),
  ...
  var jr = '\ufeff',
    ...
    $r = function (b, e) {
      var C,
        ...
        N = {},
        S = jr;
      for (b = b || {}, e && ((s = e.getValidStyles()), (l = e.getInvalidStyles())), t = ('\\" \\\' \\; \\: ; : ' + S).split(' '), C = 0; C < t.length; C++)
        (N[t[C]] = S + C), (N[S + C] = t[C]);
      return {
        toHex: function (e) {
        ...
        parse: function (e) {
          function t(e, t, n) {
            ...
            if ((r = p[e + '-top' + t]) && (o = p[e + '-right' + t]) && (i = p[e + '-bottom' + t]) && (a = p[e + '-left' + t])) {
              ...
              (-1 < C && n) ||
                ((p[e + t] = -1 === C ? u[0] : u.join(' ')), delete p[e + '-top' + t], delete p[e + '-right' + t], delete p[e + '-bottom' + t], delete p[e + '-left' + t]);
            }
          }
          function n(e) {
            var t,
        ...
        serialize: function (i, e) {
          ...
          if (e && s) t('*'), t(e);
            ...
            for (n in i)
              !(r = i[n]) || (l && ((o = n), (a = e), (u = void 0), ((u = l['*']) && u[o]) || ((u = l[a]) && u[o]))) || (c += (0 < c.length ? ' ' : '') + n + ': ' + r + ';');
          return c;
        }
      };
    },
    Wr = /^(?:mouse|contextmenu)|click/,
    Kr = { keyLocation: 1, layerX: 1, layerY: 1, returnValue: 1, webkitMovementX: 1, webkitMovementY: 1, keyIdentifier: 1, mozPressure: 1 },
    Xr = function () {
      return !1;
    },
    Yr = function () {
    ...
    Gr =
      ...
      (Zr.prototype.executeHandlers = function (e, t) {
        var n,
          ...
          a = this.events[t];
        if ((n = a && a[e.type]))
          for (r = 0, o = n.length; r < o; r++) if (((i = n[r]) && !1 === i.func.call(i.scope, e) && e.preventDefault(), e.isImmediatePropagationStopped())) return;
      }),
      (Zr.Event = new Zr()),
      Zr);
  function Zr() {
  ...
  var Qr,
    ...
    qo = {
      ...
      CHILD: new RegExp(
        '^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(' + Oo + '*(even|odd|(([+-]|)(\\d*)n|)' + Oo + '*(?:([+-]|)' + Oo + '*(\\d+)|))' + Oo + '*\\)|)',
        'i'
      ),
        ...
        ? ((ho = (fo = c).documentElement),
          ...
          (No = t
            ? function (e, t) {
                ...
                return (
                  n ||
                  (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!eo.sortDetached && t.compareDocumentPosition(e) === n)
  ...
  (Jo.matchesSelector = function (e, t) {
    if (((e.ownerDocument || e) !== fo && lo(e), (t = t.replace(Fo, "='$1']")), eo.matchesSelector && mo && (!po || !po.test(t)) && (!go || !go.test(t))))
      try {
      ...
      preFilter: {
        ...
        CHILD: function (e) {
          return (
            (e[1] = e[1].toLowerCase()),
            'nth' === e[1].slice(0, 3)
              ? (e[3] || Jo.error(e[0]), (e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ('even' === e[3] || 'odd' === e[3]))), (e[5] = +(e[7] + e[8] || 'odd' === e[3])))
              : e[3] && Jo.error(e[0]),
            e
          );
        },
        PSEUDO: function (e) {
          ...
          return qo.CHILD.test(e[0])
            ...
            : (e[3]
                ? (e[2] = e[4] || e[5] || '')
                : n && Uo.test(n) && (t = oo(n, !0)) && (t = n.indexOf(')', n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))),
              e.slice(0, 3));
        }
      },
      filter: {
            ...
            : function (e, t, n) {
                ...
                if (l) {
                  ...
                  if (((c = [v ? l.firstChild : l.lastChild]), v && d)) {
                    for (
                      u = (r = (o = l[yo] || (l[yo] = {}))[h] || [])[0] === Co && r[1], a = r[0] === Co && r[2], i = u && l.childNodes[u];
                  ...
                  } else if (d && (r = (e[yo] || (e[yo] = {}))[h]) && r[0] === Co) a = r[1];
                  else
                    for (
                      ;
                      (i = (++u && i && i[s]) || (a = u = 0) || c.pop()) &&
                      ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[yo] || (i[yo] = {}))[h] = [Co, a]), i !== e));
        ...
        PSEUDO: function (e, i) {
          var t,
            a = to.pseudos[e] || to.setFilters[e.toLowerCase()] || Jo.error('unsupported pseudo: ' + e);
          return a[yo]
            ? a(i)
            : 1 < a.length
            ? ((t = [e, e, '', i]),
    ...
    for (
      ...
      if ((t = to.relative[e[u].type])) l = [ci(si(l), t)];
        ...
        if ((t = to.filter[e[u].type].apply(null, e[u].matches))[yo]) {
          ...
          return fi(
            1 < u && si(l),
            1 < u && ui(e.slice(0, u - 1).concat({ value: ' ' === e[u - 2].type ? '*' : '' })).replace(Lo, '$1'),
            t,
            u < n && di(e.slice(u, n)),
            n < o && di((e = e.slice(n))),
            n < o && ui(e)
    ...
    (oo = Jo.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], c = to.preFilter; a; ) {
          for (i in ((n && !(r = Vo.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
          (n = !1),
          (r = Io.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(Lo, ' ') }), (a = a.slice(n.length))),
          to.filter))
            to.filter.hasOwnProperty(i) &&
              (!(r = qo[i].exec(a)) || (c[i] && !(r = c[i](r))) || ((n = r.shift()), o.push({ value: n, type: i, matches: r }), (a = a.slice(n.length))));
          if (!n) break;
        }
    ...
    (ao = Jo.select =
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          ...
          for (o = qo.needsContext.test(e) ? 0 : i.length; o-- && ((a = i[o]), !to.relative[(u = a.type)]); )
            if ((c = to.find[u]) && (r = c(a.matches[0].replace(Zo, Jr), (Yo.test(i[0].type) && ii(t.parentNode)) || t))) {
  ...
  var xi = j.document,
    ...
    Ti = function (e, t, n, r) {
      ...
      if (mi(t)) t = gi(t, Bi(e[0]));
        ...
        if (((t = Ii.makeArray(t)), r)) for (o = t.length - 1; 0 <= o; o--) Ti(e, t[o], n, r);
  ...
  (yi.fn = yi.prototype =
    {
      ...
      init: function (e, t) {
        ...
        if (mi(e)) {
          ...
          if (n[1]) for (r = gi(e, Bi(t)).firstChild; r; ) zi.call(o, r), (r = r.nextSibling);
          else {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t) for (n = Ii.unique(this.toArray().concat(Ii.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r];
        ...
        return e
          ...
          : ((t = this[0]) &&
              ...
              t.getBoundingClientRect &&
                ((i = (o = t.getBoundingClientRect()).left + (r.scrollLeft || n.body.scrollLeft) - r.clientLeft), (a = o.top + (r.scrollTop || n.body.scrollTop) - r.clientTop))),
            { left: i, top: a });
      },
      push: zi,
          ...
          style: {
            set: function (e, t) {
              null === t || 'object' != typeof t
                ? (i && e.attr('data-mce-style', t), null !== t && 'string' == typeof t ? (e.removeAttr('style'), e.css(n.parse(t))) : e.attr('style', t))
                : e.css(t);
            },
            get: function (e) {
    ...
    var T = {},
      ...
      e = (function U(m, g) {
        ...
        function n(e, t, n) {
          ...
          if (((e = Zn._addCacheSuffix(e)), y[e] ? (l = y[e]) : ((l = { passed: [], failed: [] }), (y[e] = l)), t && l.passed.push(t), n && l.failed.push(n), 1 !== l.status))
            if (2 !== l.status)
              if (3 !== l.status) {
                if (
                  ((l.status = 1),
                  ...
                  g.referrerPolicy && en(it.fromDom(u), 'referrerpolicy', g.referrerPolicy),
                ...
                (e = Zn._addCacheSuffix(e)),
                  M[e] ||
                    ...
                    (t = x(
                      'link',
                      te(
                        te({ rel: 'stylesheet', type: 'text/css', href: e }, u.contentCssCors ? { crossOrigin: 'anonymous' } : {}),
  ...
  function la() {
    ...
    var r = this,
      ...
      e = function (e, t, n) {
        void 0 === n && (n = 'added'), ee(f, e) && 'added' === n ? t() : ee(l, e) && 'loaded' === n ? t() : i.push({ name: e, state: n, callback: t });
      };
    return {
      items: o,
      urls: l,
  ...
  function Ma(n, e) {
    ...
    var o = at({}),
      r = function (e, t) {
        var n = o.get(),
          r = t(n.hasOwnProperty(e) ? n[e] : { listeners: [], previous: at(R.none()) });
        (n[e] = r), o.set(n);
      },
      t = da(function () {
        var e = o.get(),
  ...
  function Wa(e) {
    return e
      ? { left: Tu(e.left), top: Tu(e.top), bottom: Tu(e.bottom), right: Tu(e.right), width: Tu(e.width), height: Tu(e.height) }
  ...
  var uu,
    ...
    $u = function (e) {
      ...
      if (Du(e.container()))
        if (e.isAtEnd()) (o = Uu(e.container(), e.offset())), Vu(o) && t(o, o.data.length), Pu(o) && !Iu(o) && r(au(qu(o), !1));
        else {
        ...
        !(function (e) {
          ...
          for (t = Ii('*[contentEditable=false]', e), o = 0; o < t.length; o++)
            (r = (n = t[o]).previousSibling),
              yu(r) && (1 === (i = r.data).length ? r.parentNode.removeChild(r) : r.deleteData(i.length - 1, 1)),
              (r = n.nextSibling),
              vu(r) && (1 === (i = r.data).length ? r.parentNode.removeChild(r) : r.deleteData(0, 1));
        })(i),
      ...
      show: function (t, e) {
        ...
        if (!a(e))
          return (
            ...
            Ps(u.nextSibling) ? (r.setStart(u, 0), r.setEnd(u, 0)) : (r.setStart(u, 1), r.setEnd(u, 1)),
            r
          );
  ...
  var Pc,
    ...
    Vs = Qt.matchStyleValues('display', 'block table table-cell table-caption list-item'),
    Is = La,
    Fs = Ba,
    Us = Qt.isElement,
    js = qa,
  ...
  function ll(e, t, n) {
    ...
    if (
      ...
      for (
        a < (i = u.childNodes).length ? ((u = i[a]), (r = new Fi(u, e.getParent(u, e.isBlock)))) : ((u = i[i.length - 1]), (r = new Fi(u, e.getParent(u, e.isBlock))).next(!0)),
          o = r.current();
        o;
        o = r.next()
      )
  ...
  function Tl(e, t, n, r) {
    ...
    var o = t.startContainer,
      ...
      c = e.dom;
    return (
      Qt.isElement(o) && o.hasChildNodes() && ((o = Qa(o, i)), Qt.isText(o) && (i = 0)),
      Qt.isElement(a) && a.hasChildNodes() && ((a = Qa(a, t.collapsed ? u : u - 1)), Qt.isText(a) && (u = a.nodeValue.length)),
      (o = Cl(c, o)),
      (a = Cl(c, a)),
      (Yl(o.parentNode) || Yl(o)) &&
        ((o = Yl(o) ? o : o.parentNode), (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o), Qt.isText(o) && (i = t.collapsed ? o.length : 0)),
      (Yl(a.parentNode) || Yl(a)) &&
        ((a = Yl(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), Qt.isText(a) && (u = t.collapsed ? 0 : a.length)),
      t.collapsed &&
      ...
      (n[0].inline || n[0].block_expand) &&
        ((n[0].inline && Qt.isText(o) && 0 !== i) || (o = kl(c, n, o, i, a, u, !0)), (n[0].inline && Qt.isText(a) && u !== a.nodeValue.length) || (a = kl(c, n, o, i, a, u, !1))),
      n[0].selector && !1 !== n[0].expand && !n[0].inline && ((o = Nl(c, n, t, o, 'previousSibling')), (a = Nl(c, n, t, a, 'nextSibling'))),
      (n[0].block || n[0].selector) &&
        ((o = Sl(e, n, o, 'previousSibling')),
        (a = Sl(e, n, a, 'nextSibling')),
        n[0].block && (c.isBlock(o) || (o = kl(c, n, o, i, a, u, !0)), c.isBlock(a) || (a = kl(c, n, o, i, a, u, !1)))),
  ...
  var Al,
    ...
    Pl = function (e, t, n) {
      ...
      if (Rl(c)) {
        ...
        if (zc(e) && 0 < s && ((o = Ws(c, s - 1)), Ol(o)))
          return !Hl(o) && (i = Nc(o, e, Bl, o)) ? (Rl(i) ? Vc(i, i.data.length) : Vc.after(i)) : Rl(o) ? Vc(o, o.data.length) : Vc.before(o);
      ...
      return ((xc(e) && u.isAtEnd()) || (zc(e) && u.isAtStart())) && ((r = Nc(r, e, $(!0), n, !0)), Bl(r, n))
        ? Ks(e, r)
        : ((o = Nc(r, e, Bl, n)),
          !(a = Xn.last(
            U(
    ...
    Il = d(Ll, !0),
    Fl = d(Ll, !1),
    Ul = { fromPosition: Ll, nextPosition: Il, prevPosition: Fl, navigate: Qs, navigateIgnore: Vl, positionIn: el, firstPositionIn: d(el, !0), lastPositionIn: d(el, !1) },
    jl = function (e, t) {
      var n = e.dom;
      if (t) {
        if (
        ...
        if (
          ...
          return R.some(
            (function (e, t) {
              var n, r;
              return (
                (n = e.createRng()), (r = Gu(e.getRoot(), t.start)), n.setStart(r.container(), r.offset()), (r = Gu(e.getRoot(), t.end)), n.setEnd(r.container(), r.offset()), n
              );
            })(n, t)
          );
        if (
  ...
  function gf(e, t, n) {
    var r,
      ...
      u = 1;
    for (
      a = e.getShortEndedElements(), (i = /<([!?\/])?([A-Za-z0-9\-_\:\.]+)((?:\s+[^"\'>]+(?:(?:"[^"]*")|(?:\'[^\']*\')|[^>]*))*|\/|\s+)>/g).lastIndex = r = n;
      (o = i.exec(t));
          ...
          if ((H < o.index && X(L(i.substr(H, o.index - H))), (u = o[7]))) ':' === (u = u.toLowerCase()).charAt(0) && (u = u.substr(1)), t(u);
            ...
            if (!y || (b = $.getElementRule(u))) {
              if (
                ...
                (x = o[9]) ? ((h = -1 !== x.indexOf('data-mce-type')) && m && (C = !1), ((s = []).map = {}), x.replace(R, r)) : ((s = []).map = {}),
                y && !h)
              ) {
                if (((N = b.attributesRequired), (S = b.attributesDefault), (k = b.attributesForced), b.removeEmptyAttrs && !s.length && (C = !1), k))
                  for (l = k.length; l--; ) (d = (w = k[l]).name), '{$uid}' === (D = w.value) && (D = 'mce_' + P++), (s.map[d] = D), s.push({ name: d, value: D });
                if (S)
                  for (l = S.length; l--; ) (d = (w = S[l]).name) in s.map || ('{$uid}' === (D = w.value) && (D = 'mce_' + P++), (s.map[d] = D), s.push({ name: d, value: D }));
                if (N) {
  ...
  function yf(e, t) {
    ...
    for (
      ...
      (r = c.lastIndex), (o = i[0].length), (n = a[i[1]] ? r : fd.findEndTag(s, u, r)), (u = u.substring(0, r - o) + u.substring(n)), (c.lastIndex = r - o);
    return mu.trim(u);
  }
  function bf(e, t, n) {
    var r;
          ...
          var h = function (e) {
            ...
            if (l) l(e);
              ...
              if (((t = e.name), (n = e.shortEnded), (r = e.attributes), d && r && 1 < r.length && (((a = []).map = {}), (s = m.getElementRule(e.name))))) {
                for (u = 0, c = s.attributesOrder.length; u < c; u++) (o = s.attributesOrder[u]) in r.map && ((i = r.map[o]), (a.map[o] = i), a.push({ name: o, value: i }));
                for (u = 0, c = r.length; u < c; u++) (o = r[u].name) in a.map || ((i = r.map[o]), (a.map[o] = i), a.push({ name: o, value: i }));
                r = a;
              }
        ...
        ((cd = function (e) {
          ...
          (t = e.target),
            n &&
              ...
              (t === j.document.body || Lf(n, t) || r.focusedEditor !== n || (n.fire('blur', { focusedEditor: null }), (r.focusedEditor = null)));
        }),
              ...
              return (
                0 === n.length || /^\s+$/.test(n)
                  ? ((i = '<br data-mce-bogus="1">'),
                    ...
                    (n =
                      (o = as(e)) && e.schema.isValidChild(t.nodeName.toLowerCase(), o.toLowerCase())
                        ? ((n = i), e.dom.createHTML(o, e.settings.forced_root_block_attrs, n))
                        : n || '<br data-mce-bogus="1">'),
                    Kf(e, n),
                    e.fire('SetContent', r))
                  : ('raw' !== r.format && (n = wf({ validate: e.validate }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 }))),
  ...
  function Zf(e, t) {
    ...
    e.destroyed ||
      (t || e.removed
        ? (t || (e.editorManager.off('beforeunload', e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Yf(n), Yf(r)),
          (function (e) {
            var t = e.formElement;
  ...
  function id(e, t, n, r) {
    ...
    return 'hash' === r
      ? (function (e) {
          ...
          return (
            'string' == typeof e
              ? F(0 < e.indexOf('=') ? e.split(/[;,](?![^=;,]*(?:[;,]|$))/) : e.split(','), function (e) {
                  var t = e.split('=');
    ...
    Gd = function (e, t, n) {
      var r = it.fromDom(e.getBody()),
        ...
        i = (function (e, t, n, r) {
          ...
          return { x: n - (e ? o.left + t.dom().clientLeft + Yd(t) : 0), y: r - (e ? o.top + t.dom().clientTop + Xd(t) : 0) };
        })(e.inline, o, t, n);
      return (function (e, t, n) {
        var r = Wd(e),
          o = Kd(e);
  ...
  function lh(r, a) {
    ...
    function _(e) {
      ...
      return (
        !1 !== t &&
        !Wn.iOS &&
        ('string' != typeof t && (t = 'table,img,figure.image,div'), 'false' !== e.getAttribute('data-mce-resize') && e !== a.getBody() && me(it.fromDom(e), t))
      );
    }
    function D(e) {
      var t, n, r, o;
      (t = e.screenX - d),
        ...
        (b = b < 5 ? 5 : b),
        (C = C < 5 ? 5 : C),
        (M(u) && !1 !== Os(a) ? !hh.modifierPressed(e) : hh.modifierPressed(e)) && (k(t) > k(n) ? ((C = T(b * y)), (b = T(C / y))) : ((b = T(C / y)), (C = T(b * y)))),
                    ...
                    e.stopImmediatePropagation(),
                      ...
                      (function (e) {
                        (d = e.screenX),
                          ...
                          z.bind(N, 'mouseup', H),
                          S !== N && (z.bind(S, 'mousemove', D), z.bind(S, 'mouseup', H)),
  ...
  function nm(e, t, n, r) {
    ...
    if ((Qt.isElement(o) && i > o.childNodes.length - 1 && (c = !1), Qt.isDocument(o) && ((o = f), (i = 0)), o === f)) {
      ...
      if (o.hasChildNodes()) {
        if (
          ((i = Math.min(!c && 0 < i ? i - 1 : i, o.childNodes.length - 1)), (o = o.childNodes[i]), (i = Qt.isText(o) && s ? o.data.length : 0), !t && o === f.lastChild && Qh(o))
        )
          return R.none();
        if (
          (function (e, t) {
  ...
  var sm = (function PN(r, o) {
    ...
    Om = function (e, t) {
      if ((void 0 === t && (t = {}), (t.get = !0), (t.format = t.format || 'html'), (t.selection = !0), (t = e.fire('BeforeGetContent', t)).isDefaultPrevented()))
  ...
  function Im(u, c, e, s) {
    ...
    var n,
      ...
      h = function () {
        ...
        return (
          (n = (n = vm(s, [n])[0]) || (o.createRange ? o.createRange() : o.body.createTextRange())).setStart &&
          ...
          return (function (e, t) {
            ...
            return t
              ? ((r = t.startContainer),
                ...
                3 === r.nodeType &&
                  3 === o.nodeType &&
                  ((r = r.length === i ? um(r.nextSibling, !0) : r.parentNode), (o = 0 === a ? um(o.previousSibling, !1) : o.parentNode), r && r === o))
                  ? r
                  : n && 3 === n.nodeType
                  ? n.parentNode
                  : n)
        ...
        getSelectedBlocks: function (e, t) {
          return (function (e, t, n, r) {
            ...
            if (
              ...
              for (var u = new Fi((o = n), i); (o = u.next()) && o !== r; ) e.isBlock(o) && a.push(o);
              ...
              start: function (e, t, n) {
                ...
                if ((i = v ? A.getElementRule(e) : {})) {
                  for ((r = S(i.outputName || e, 1)).attributes = t, r.shortEnded = n, d.append(r), (u = p[d.name]) && p[r.name] && !u[r.name] && h.push(r), o = R.length; o--; )
                    (a = R[o].name) in t.map && ((c = D[a]) ? c.push(r) : (D[a] = [r]));
                ...
                if ((n = v ? A.getElementRule(e) : {})) {
                  if (l[e] && !f) {
                    if ((t = d.firstChild) && 3 === t.type)
                      ...
                      else for (o = t.next, t.remove(), t = o; t && 3 === t.type; ) (r = t.value), (o = t.next), (0 !== r.length && !E.test(r)) || (t.remove(), (t = o)), (t = o);
                    if ((t = d.lastChild) && 3 === t.type)
                      if (0 < (r = t.value.replace(x, '')).length) (t.value = r), (t = t.prev);
                      else for (o = t.prev, t.remove(), t = o; t && 3 === t.type; ) (r = t.value), (o = t.prev), (0 !== r.length && !E.test(r)) || (t.remove(), (t = o)), (t = o);
                  }
                  if ((f && C[e] && (f = !1), n.removeEmpty && qm(A, g, C, d) && !d.attr('name') && !d.attr('id')))
                        ...
                        if (h[n.name] && 'li' === n.parent.name) {
                          ...
                          if (r && 1 < o.length) {
                            for (o.reverse(), i = a = O(o[0].clone()), s = 0; s < o.length - 1; s++) {
                              for (A.isValidChild(a.name, o[s].name) ? ((u = O(o[s].clone())), a.append(u)) : (u = a), c = o[s].firstChild; c && c !== o[s + 1]; )
            ...
            e.addAttributeFilter('class', function (e) {
              for (var t, n, r, o, i, a, u, c = e.length, s = p.getValidClasses(); c--; ) {
                for (n = (t = e[c]).attr('class').split(' '), i = '', r = 0; r < n.length; r++)
                  (o = n[r]), (u = !1), (a = s['*']) && a[o] && (u = !0), (a = s[t.name]), !u && a && a[o] && (u = !0), u && (i && (i += ' '), (i += o));
        ...
        t.addAttributeFilter('src,href,style', function (e, t) {
          for (var n, r, o = e.length, i = 'data-mce-' + t, a = c.url_converter, u = c.url_converter_scope; o--; )
            (r = (n = e[o]).attr(i)) !== undefined
              ...
              : ((r = n.attr(t)), 'style' === t ? (r = s.serializeStyle(s.parseStyle(r), n.name)) : a && (r = a.call(u, r, t, n.name)), n.attr(t, 0 < r.length ? r : null));
        }),
        ...
        ? (function (e, t, n) {
            ...
            return (
              ...
              (r = j.document.implementation).createHTMLDocument &&
                ...
                Zn.each('BODY' === t.nodeName ? t.childNodes : [t], function (e) {
  ...
  function hg(o) {
    ...
    function c(n) {
      return (
        (f = f || dg(m, { url: Cs(o), basePath: ws(o), credentials: xs(o), handler: zs(o) })),
        p().then(
          t(function (r) {
            ...
            return f.upload(e, a).then(
              t(function (e) {
                var t = X(e, function (e, t) {
                  var n = r[t].image;
                  return e.status && bs(o) ? u(n, e.url) : e.error && ch.uploadError(o, e.error), { element: n, status: e.status };
                });
                return n && n(t), t;
              })
            );
  ...
  function Cg(e, t) {
    var n,
      ...
      c = e.dom;
    if (u)
      for (n = e.selection.getStart(), r = bl(c, n), i = u.length - 1; 0 <= i; i--) {
    ...
    return (
      t === r && Qt.isText(t)
        ? 0 < n &&
          ...
          ((t = (r = wg(t, n)).previousSibling), n < o ? ((t = r = wg(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
        : (Qt.isText(t) && 0 < n && n < t.nodeValue.length && ((t = wg(t, n)), (n = 0)),
          Qt.isText(r) && 0 < o && o < r.nodeValue.length && (o = (r = wg(r, o).previousSibling).nodeValue.length)),
  ...
  function Fg(e, t, n) {
    ...
    var r = e.dom,
      o = e.selection;
    if (t) Ig(e, t, n);
    else if (!(t = lc(e.getBody(), o.getStart()))) for (; (t = r.get(cp)); ) Ig(e, t, !1);
  }
  function Ug(e, t, n) {
    var r = e.dom,
    ...
    t.on('mouseup keydown', function (e) {
      !(function (e, t) {
        var n = e.selection,
          r = e.getBody();
        Fg(e, null, !1),
          (8 !== t && 46 !== t) || !n.isCollapsed() || n.getStart().innerHTML !== up || Fg(e, lc(r, n.getStart())),
    ...
    tp = function (e, t, n, r, o) {
      ...
      if (s && t)
        for (a = 0; a < s.length; a++)
          if (((i = s[a]), pg(e.dom, t, i) && vg(l, t, i, 'attributes', o, r) && vg(l, t, i, 'styles', o, r))) {
      ...
      ? ((function (t, e, n) {
          ...
          n.block &&
            (a
              ...
              : i.isBlock(e) &&
                !i.isBlock(o) &&
                (vp(i, e, !1) || vp(i, e.firstChild, !0, !0) || e.insertBefore(i.create('br'), e.firstChild),
                vp(i, e, !0) || vp(i, e.lastChild, !1, !0) || e.appendChild(i.create('br')))),
  ...
  function bp(u, n, a, e, r) {
    ...
    function s(e) {
      ...
      return (
        ...
        Qt.isText(n) && 0 === n.data.length && (n = e ? t.previousSibling || t.nextSibling : t.nextSibling || t.previousSibling),
        h.remove(t, !0),
        n
      );
    }
    function t(e) {
      ...
      if (f.split) {
        if (((o = xg(o)), (t = mp(u, o, !0)) !== (n = mp(u, o)))) {
          ...
          (t = gp(h, t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), (n = gp(h, n, 'span', { id: '_end', 'data-mce-type': 'bookmark' }));
          var a = h.createRng();
          a.setStartAfter(t),
            a.setEndBefore(n),
            ef(h, a, function (e) {
        ...
        Rp(e, function (e) {
          g(e),
            Qt.isElement(e) &&
              ...
              yp(u, { deep: !1, exact: !0, inline: 'span', styles: { textDecoration: 'underline' } }, null, e);
        });
      });
    }
    var o,
      ...
      g = function (e) {
        var t, n, r, o, i;
        if ((Qt.isElement(e) && h.getContentEditable(e) && ((o = d), (d = 'true' === h.getContentEditable(e)), (i = !0)), (t = Zn.grep(e.childNodes)), d && !i))
    ...
    if (e) sl(e) ? ((i = h.createRng()).setStartBefore(e), i.setEndAfter(e), t(i)) : t(e);
      ...
      m.isCollapsed() && f.inline && !h.select('td[data-mce-selected],th[data-mce-selected]').length
        ...
        : ((o = Wc.getPersistentBookmark(u.selection, !0)), t(m.getRng()), m.moveToBookmark(o), f.inline && yg(u, n, a, m.getStart()) && ll(h, m, m.getRng()), u.nodeChanged());
    else {
      e = m.getNode();
  ...
  var Ap = Zn.each,
    ...
    Lp = function (m, g, p, r) {
        ...
        (l = C.inline || C.block),
          ...
          ef(c, e, function (e) {
            var a,
              u = function (e) {
                ...
                if ((Qt.isElement(e) && c.getContentEditable(e) && ((n = h), (h = 'true' === c.getContentEditable(e)), (t = !0)), gl(r, 'br')))
                ...
                if (C.wrapper && tp(m, e, g, p)) a = 0;
                  ...
                  (C.inline && c.isBlock(e))
                    ? ((a = 0), Pp(Zn.grep(e.childNodes), u), t && (h = n), (a = 0))
          ...
          Pp(d, function (e) {
            ...
            (!(1 < d.length) && c.isBlock(e)) || 0 !== n)
              ? (C.inline || C.wrapper) &&
                (C.exact || 1 !== n || ((i = t((o = e))) && !Wl(i) && pg(c, i, C) && ((a = c.clone(i, !1)), v(a), c.replace(a, o, !0), c.remove(i, !0)), (e = a || o)),
                Sp(m, b, p, e),
                (function (t, n, r, o, i) {
      ...
      if ('false' !== i.getContentEditable(a.getNode())) {
        if (C) {
          if (r) sl(r) ? y(b, r) || ((n = i.createRng()).setStartBefore(r), n.setEndAfter(r), e(i, Tl(m, n, b), 0, !0)) : e(i, r, 0, !0);
            ...
            !(function (e, t, n) {
              ...
              c && 0 < a && a < c.length && l.test(c.charAt(a)) && l.test(c.charAt(a - 1))
                ? ((u = s.getBookmark()), r.collapse(!0), (r = Tl(e, r, e.formatter.get(t))), (r = xg(r)), e.formatter.apply(t, n, r), s.moveToBookmark(u))
                : ((o && i.nodeValue === up) ||
                    ((i = (o = (function (e, t) {
            ...
            m.settings.forced_root_block || !b[0].defaultBlock || i.getParent(u, i.isBlock) || Lp(m, b[0].defaultBlock),
    ...
    Fp = function (r) {
      var t = {
        ...
        alignjustify: [
          { selector: 'figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li', styles: { textAlign: 'justify' }, inherit: !1, defaultBlock: 'div', preview: 'font-family font-size' }
        ],
        bold: [
      ...
      return (
        Zn.each('p h1 h2 h3 h4 h5 h6 div address pre div dt dd samp'.split(/\s/), function (e) {
    ...
    return 'preview' in e && !1 === (u = e.preview)
      ...
      : ((t = e.block || e.inline || 'span'),
        ...
        Uv(u.split(' '), function (e) {
          ...
          if (
            !(
              ('background-color' === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = jv.getStyle(n.getBody(), e, !0)), '#ffffff' === jv.toHex(t).toLowerCase())) ||
        ...
        undo: function () {
          return (function (e, t, n, r) {
            ...
            return (
              ...
              0 < r.get() && (r.set(r.get() - 1), (o = t.data[r.get()]), Qv(e, o, !0), e.setDirty(!0), e.fire('Undo', { level: o })),
              o
            );
          })(n, a, o, i);
        },
          ...
          n.on('keyup', function (e) {
            ...
            e.isDefaultPrevented() ||
              ...
              a.get() &&
                r.typing &&
                !1 === ey(Jv(n), r.data[0]) &&
                (!1 === n.isDirty() && (n.setDirty(!0), n.fire('change', { level: r.data[0], lastLevel: null })), n.fire('TypingUndo'), a.set(!1), n.nodeChanged()));
          }),
            ...
            r =
              ...
              (function (e, t, n) {
                if (ip(it.fromDom(t), !1)) {
                  ...
                  return (
                    !o ||
                    (!e.getStyle(t.firstElementChild, 'padding-left') && !e.getStyle(t.firstElementChild, 'padding-right') && (r ? !e.isBlock(o) : n === o.nodeName.toLowerCase()))
                  );
                }
                return !1;
              })(i, n, a);
  ...
  function sv(e) {
    ...
    if (
      ...
      for (n = (t = d.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, s = Dd(e), g = p.firstChild; g; )
        if (((y = m), (b = g), Qt.isText(b) || (Qt.isElement(b) && !uv(y, b) && !Wl(b)))) {
          if (cv(m, g)) {
      ...
      var e = m.length + g.length + 2,
        ...
        l = function (e, t, n, r) {
          ...
          for (v[1 + h] = e, y[1 + h] = t + 1, a = 0; a <= h; ++a) {
            for (u = -a; u <= a; u += 2) {
              for (
                c = u + h, u === -a || (u !== a && v[c - 1] < v[c + 1]) ? (v[c] = v[c + 1]) : (v[c] = v[c - 1] + 1), l = (s = v[c]) - e + n - u;
                s < t && l < r && m[s] === g[l];
            ...
            for (u = f - a; u <= f + a; u += 2) {
              for (
                c = u + h - f, u === f - a || (u !== f + a && y[c + 1] <= y[c - 1]) ? (y[c] = y[c + 1] - 1) : (y[c] = y[c - 1]), l = (s = y[c] - 1) - e + n - u;
                e <= s && n <= l && m[s] === g[l];
      ...
      setupSelectedState: function (t) {
        ...
        return (
          t.on('NodeChange', function (e) {
            Hv(t) &&
              ((function (e, t, n) {
                var r = U(t.select('*[data-mce-selected="inline-boundary"]'), e),
                  o = U(n, e);
  ...
  function tb(e, t, n, r) {
    for (var o, i, a, u, c, s, l = Xs(n), f = r, d = []; f && ((c = l), (s = f), (o = t === Pc.Forwards ? c.next(s) : c.prev(s))); ) {
      if (Qt.isBr(o.getNode(!1)))
        return t === Pc.Forwards ? { positions: eb(t, d).concat([o]), breakType: Ly.Br, breakAt: R.some(o) } : { positions: eb(t, d), breakType: Ly.Br, breakAt: R.some(o) };
      if (o.isVisible()) {
        if (e(f, o)) {
    ...
    return (function (e, o, i) {
      ...
      U(
        (function (n, e) {
          return v(e, function (e) {
            var t = (function (e, t) {
              return { left: e.left - t, top: e.top - t, right: e.right + 2 * t, bottom: e.bottom + 2 * t, width: e.width + t, height: e.height + t };
  ...
  var Mw = d(tb, Wu.isAbove, -1),
          ...
          (function (e, t, n) {
            ...
            Fw(
              [
                ...
                { keyCode: hh.RIGHT, ctrlKey: !r.isOSX(), altKey: r.isOSX(), action: by.moveNextWord(e, t) },
    ...
    tx = function (e) {
      ...
      return (
        Qt.isContentEditableTrue(n) &&
          e.dom.isBlock(n) &&
          e.dom.isEmpty(n) &&
          ((t = e.dom.create('br', { 'data-mce-bogus': '1' })), e.dom.setHTML(n, ''), n.appendChild(t), e.selection.setRng(Vc.before(t).toRange())),
        !0
      );
    },
    nx = function (e, t) {
    ...
    zx = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        if (VC(n, r, !0) && VC(n, r, !1)) BC(n, 'LI') ? i.insertAfter(u, LC(n)) : i.replace(u, n);
        else if (VC(n, r, !0)) BC(n, 'LI') ? (i.insertAfter(u, LC(n)), u.appendChild(i.doc.createTextNode(' ')), u.appendChild(n)) : n.parentNode.insertBefore(u, n);
    ...
    Ex = function (a, e) {
      function t(e) {
        ...
        if ((e || 'TABLE' === m || 'HR' === m ? ((t = y.create(e || p)), $C(a, t)) : (t = s.cloneNode(!1)), (r = t), !1 === ls(a)))
      ...
      Qt.isElement(c) &&
        c.hasChildNodes() &&
        ((v = i > c.childNodes.length - 1), (c = c.childNodes[Math.min(i, c.childNodes.length - 1)] || c), (i = v && Qt.isText(c) ? c.nodeValue.length : 0)),
        (u = qC(y, c)) &&
          (((p && !l) || (!p && l)) &&
            (c = (function (e, t, n, r, o) {
              ...
              if (!(a = d.getParent(r, d.isBlock)) || !UC(d, a)) {
                if (
                  ...
                  return (i = d.create(f)), $C(e, i), a.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i;
          ...
          /^(LI|DT|DD)$/.test(m) && y.isEmpty(s)
            ...
            : (p && s === a.getBody()) ||
              ...
              Ba(s)
                ...
                ? r()
                : n(!0)
                ? ((f = s.parentNode.insertBefore(t(), s)), yx(a, FC(s, 'HR') ? f : s))
                : ((o = (function (e) {
                    var t = e.cloneRange();
  ...
  function Fx(r) {
    ...
    'onselectionchange' in r.getDoc() ||
      r.on('NodeChange click mouseup keyup focus', function (e) {
        var t, n;
        (n = { startContainer: (t = r.selection.getRng()).startContainer, startOffset: t.startOffset, endContainer: t.endContainer, endOffset: t.endOffset }),
  ...
  function Zx(g) {
    ...
    function p(e, t, n, r) {
      return (
        void 0 === r && (r = !0),
        g.fire('ShowCaret', { target: t, direction: e, before: n }).isDefaultPrevented() ? null : (r && g.selection.scrollIntoView(t, -1 === e), o.show(n, t))
      );
    }
    function t(e) {
    ...
    var v,
      ...
      u = function (e) {
        var t = g.schema.getShortEndedElements(),
          ...
          a = e.endOffset;
        return (
          ee(t, r.nodeName.toLowerCase()) ? (0 === o ? n.setStartBefore(r) : n.setStartAfter(r)) : n.setStart(r, o),
          ee(t, i.nodeName.toLowerCase()) ? (0 === a ? n.setEndBefore(i) : n.setEndAfter(i)) : n.setEnd(i, a),
          n
        );
      },
      c = function (e, t) {
        ...
        if (
          ...
          (a = e.startOffset),
          (u = e.endOffset),
          3 === i.nodeType && 0 === a && Rz(i.parentNode) && ((i = i.parentNode), (a = h.nodeIndex(i)), (i = i.parentNode)),
          1 !== i.nodeType)
        )
          return null;
        ...
        (r = ka(it.fromDom(g.getBody()), '#' + b).fold(
          ...
          l === f && Wn.ie
            ...
            : (r.empty().append(qr).append(l).append(qr), e.setStart(r[0].firstChild, 1), e.setEnd(r[0].lastChild, 0)),
        ...
        (function () {
          ...
          (n = g).on(
            ...
            g.on('mousedown', function (e) {
              var t,
                n = e.target;
              if ((n === y || 'HTML' === n.nodeName || g.dom.isChildOf(n, y)) && !1 !== Gd(g, e.clientX, e.clientY))
                if ((t = Gx(g, n)))
                  Rz(t)
                    ? (e.preventDefault(), c(My(g, t)))
                    : (s(), (Mz(t) && e.shiftKey) || dh(e.clientX, e.clientY, g.selection.getRng()) || (w(), g.selection.placeCaretAt(e.clientX, e.clientY)));
                else if (!1 === wc(n)) {
                  s(), w();
  ...
  function Jx(a) {
    ...
    return (
      ...
      g &&
        ...
        a.on('click', function (e) {
          var t = e.target;
          /^(IMG|HR)$/.test(t.nodeName) && 'false' !== s.getContentEditableParent(t) && (e.preventDefault(), a.selection.select(t), a.nodeChanged()),
  ...
  function ez(e, t) {
    var n = e.editorManager.translate('Rich Text Area. Press ALT-0 for help.'),
      r = (function (e, t, n, r) {
        ...
        return Ke(o, r), Ke(o, { id: e + '_ifr', frameBorder: '0', allowTransparency: 'true', title: t }), va(o, 'tox-edit-area__iframe'), o;
    ...
    return (
      ...
      (e.iframeHTML = (function (e) {
        ...
        return (
          (r = es(e) + '<html><head>'),
          ts(e) !== e.documentBaseUrl && (r += '<base href="' + e.documentBaseURI.getURI() + '" />'),
          (r += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />'),
          (t = ns(e)),
          (n = rs(e)),
          os(e) && (r += '<meta http-equiv="Content-Security-Policy" content="' + os(e) + '" />'),
            ...
            return (
              ...
              3 === n.nodeType &&
                ...
                (n.data[r] === qr
                  ...
                  : n.data[r - 1] === qr && (n.deleteData(r - 1, 1), /[\u00a0| ]$/.test(t) || (t = ' ' + t))),
              t
            );
        ...
        (function (n, e) {
          ...
          if (e) {
            ...
            (i = e.previousSibling) && 3 === i.nodeType
              ? (s.setStart(i, i.nodeValue.length), Wn.ie || ((a = e.nextSibling) && 3 === a.nodeType && (i.appendData(a.data), a.parentNode.removeChild(a))))
  ...
  var Ez = function (e, t) {
    ...
    Dz = function (t, e) {
      ...
      o.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.readonly || (t.inline && 'static' === _z.getStyle(n, 'position', !0) && (n.style.position = 'relative'), (n.contentEditable = t.getParam('content_editable_state', !0))),
        (n.disabled = !1),
        (t.editorUpload = hg(t)),
        (t.schema = Pr(o)),
        (t.dom = Qi(a, {
          ...
          return (
            ...
            e.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function (e) {
              for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--; )
                (t = e[n]).isEmpty(r) && 0 === t.getAll('br').length && (t.append(new hf('br', 1)).shortEnded = !0);
            }),
            e
          );
        })(t)),
        ...
        o.browser_spellcheck || o.gecko_spellcheck || ((a.body.spellcheck = !1), _z.setAttrib(n, 'spellcheck', 'false')),
        (t.quirks = Jx(t)),
        (function (e) {
          e.fire('PostRender');
        })(t);
    ...
    Hz = function (e, t) {
      var n = ez(e, t);
      t.editorContainer && ((Oz.get(t.editorContainer).style.display = e.orgDisplay), (e.hidden = Oz.isHidden(t.editorContainer))),
    ...
    Iz = function (t) {
      ...
      if (Gr.Event.domLoaded) {
        if (t.getElement() && Wn.contentEditable) {
          ...
          o &&
            ((t.formElement = o),
            e.hidden_input && !Qt.isTextareaOrInput(t.getElement()) && (Vz.insertAfter(Vz.create('input', { type: 'hidden', name: n }), n), (t.hasHiddenInput = !0)),
    ...
    $z = function (e, t) {
      var n = (function (e) {
        var t;
        return 'string' != typeof e ? ((t = Zn.extend({ paste: e.paste, data: { paste: e.paste } }, e)), { content: e.content, details: t }) : { content: e, details: {} };
      })(t);
    ...
    Qz =
      ((eE.prototype.execCommand = function (t, n, r, e) {
        ...
        if (!u.editor.removed) {
          if (
            (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(t) || (e && e.skip_focus) ? zd(u.editor) : u.editor.focus(),
          ...
          'InsertUnorderedList,InsertOrderedList': function (e) {
            ...
            a.execNativeCommand(e),
              (t = i.dom.getParent(i.selection.getNode(), 'ol,ul')) &&
                ((n = t.parentNode), /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (a.storeSelection(), i.dom.split(n, t), a.restoreSelection()));
          },
  ...
  var tE = Zn.makeMap(
    ...
    nE =
      ...
      (rE.prototype.on = function (e, t, n, r) {
        ...
        if ((!1 === t && (t = s), t)) {
          var u = { func: t };
          for (r && Zn.extend(u, r), a = (i = e.toLowerCase().split(' ')).length; a--; )
  ...
  function fE(e, t) {
    return 'selectionchange' === t
      ...
      ? (e.eventRoot || (e.eventRoot = bE.select(e.settings.event_root)[0]), e.eventRoot)
      : e.getBody();
  }
  function dE(e, t, n) {
    !(function (e) {
  ...
  function gE(t) {
    var n = at('design'),
      r = at({ design: { activate: i, deactivate: i, editorReadOnly: !1 }, readonly: { activate: i, deactivate: i, editorReadOnly: !0 } });
    return (
      (function (e) {
        e.serializer
          ? lE(e)
  ...
  var pE,
    ...
    xE = Zn.each,
    zE = Zn.explode,
    EE = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
    ...
    SE =
      ...
      (kE.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return (
          ((o = Zn.map(zE(e, '>'), this.parseShortcut))[o.length - 1] = Zn.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
  ...
  var AE = Zn.each,
    ...
    DE =
      ...
      (OE.prototype.toAbsPath = function (e, t) {
        ...
        return (
          0 !== (o = (n = u.length - i) <= 0 ? w(a).join('/') : u.slice(0, n).join('/') + '/' + w(a).join('/')).indexOf('/') && (o = '/' + o),
  ...
  var HE = Qi.DOM,
    ...
    IE =
      ...
      (FE.prototype.execCallback = function (e) {
        ...
        if (o)
          return (
            ...
            'string' == typeof o &&
              ((r = (r = o.replace(/\.\w+$/, '')) ? LE(r) : 0), (o = LE(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = { func: o, scope: r })),
      ...
      (FE.prototype.show = function () {
        this.hidden &&
          ((this.hidden = !1), this.inline ? (this.getBody().contentEditable = 'true') : (HE.show(this.getContainer()), HE.hide(this.id)), this.load(), this.fire('show'));
      }),
      (FE.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (HE.hide(e.getContainer()), HE.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'));
      }),
      ...
      (FE.prototype.getContent = function (e) {
        return (function (t, n) {
          return (
            void 0 === n && (n = {}),
            R.from(t.getBody()).fold($('tree' === n.format ? new hf('body', 11) : ''), function (e) {
              return bf(t, n, e);
            })
          );
        })(this, e);
        ...
        (e = e || r.getBody()),
          ...
          PE(i.select('table,a', e), function (e) {
            ...
            switch (e.nodeName) {
              case 'TABLE':
                return (
                  (n = o.visual_table_class || 'mce-item-table'), void (((t = i.getAttrib(e, 'border')) && '0' !== t) || !r.hasVisual ? i.removeClass(e, n) : i.addClass(e, n))
                );
              case 'A':
                return void (
                  i.getAttrib(e, 'href') ||
                  ((t = i.getAttrib(e, 'name') || e.id), (n = o.visual_anchor_class || 'mce-item-anchor'), t && r.hasVisual ? i.addClass(e, n) : i.removeClass(e, n))
                );
            }
          }),
  ...
  function FE(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        (ra.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy), Qi.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
      (wa.languageLoad = this.settings.language_load),
      (wa.baseURL = n.baseURL),
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new DE(this.settings.document_base_url, { base_uri: this.baseUri })),
      (this.baseURI = this.baseUri),
      (this.inline = !!this.settings.inline),
      (this.shortcuts = new SE(this)),
      (this.editorCommands = new Qz(this)),
      this.settings.cache_suffix && (Wn.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, '')),
      (this.ui = { registry: TE() });
    var o = gE(this);
    (this.mode = o),
      (this.setMode = o.set),
                  ...
                  (o = Zn.grep(o, function (e) {
                    ...
                    : YE(o, function (e) {
                        !(function (e, t) {
                          ...
                          ? n(s(e), r, e)
                          : ch.initError('Could not initialize inline editor on invalid inline target element', e);
                      }));
          };
        return (
          (c.settings = r),
        ...
        if (e) {
          if (!K(e))
            return (
              ...
              O(r.get(n.id))
                ? null
                : (qE(n) && r.fire('RemoveEditor', { editor: n }), 0 === eN.length && window.removeEventListener('beforeunload', $E), n.remove(), jE(0 < eN.length), n)
            );
    ...
    SN =
      ...
      (kN.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          ...
          (o.data = xN.serialize({ id: e.id || 'c' + this.count++, method: e.method, params: e.params })),
          ...
          function t(e) {
            ...
            return (
              'object' == typeof e
                ...
                : (t = /#([0-F])([0-F])([0-F])/gi.exec(e)) && ((u = parseInt(t[1] + t[1], 16)), (c = parseInt(t[2] + t[2], 16)), (s = parseInt(t[3] + t[3], 16))),
              (u = u < 0 ? 0 : 255 < u ? 255 : u),
              (c = c < 0 ? 0 : 255 < c ? 255 : c),
              (s = s < 0 ? 0 : 255 < s ? 255 : s),
              n
          ...
          return (
            ...
            (n.toHsv = function () {
              return (function (e, t, n) {
                ...
                return (
                  (o = 0),
                  (i = bN((e /= 255), bN((t /= 255), (n /= 255)))) === (a = CN(e, CN(t, n)))
                    ? { h: 0, s: 0, v: 100 * (o = i) }
                    : ((r = (a - i) / a),
                      { h: wN(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: wN(100 * r), v: wN(100 * o) })
                );
              })(u, c, s);
            }),
            (n.toHex = function () {
