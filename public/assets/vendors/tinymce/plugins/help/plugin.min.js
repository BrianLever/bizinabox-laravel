...
!(function () {
  ...
  function A(a, r) {
    return function () {
      ...
      a.windowManager.open({ title: 'Help', size: 'medium', body: o, buttons: [{ type: 'cancel', name: 'close', text: 'Close', primary: !0 }], initialData: {} });
    };
  }
  var C,
    T = function (n) {
    ...
    j = function (e) {
      var n = I.mac ? { alt: '&#x2325;', ctrl: '&#x2303;', shift: '&#x21E7;', meta: '&#x2318;', access: '&#x2303;&#x2325;' } : { meta: 'Ctrl ', access: 'Shift + Alt ' },
        t = e.split('+'),
        o = y(t, function (e) {
                ...
                : '<div data-mce-tabstop="1" tabindex="-1">' +
                  (function (t) {
                    var e = (function (e) {
                      ...
                      o = n.length,
                      a = n.join('');
                    return '<p><b>' + U.translate(['Plugins installed ({0}):', o]) + '</b></p><ul>' + a + '</ul>';
                  })(n) +
                  '</div>'),
              ((t = y(
                [
    ...
    L = function () {
      var e,
        ...
        n =
          ...
          ((e = N.majorVersion), (t = N.minorVersion), 0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) +
          '</a>';
      return { name: 'versions', title: 'Version', items: [{ type: 'htmlpanel', html: '<p>' + U.translate(['You are using {0}', n]) + '</p>', presets: 'document' }] };
    },
    B = function () {
      return {
        name: 'keyboardnav',
