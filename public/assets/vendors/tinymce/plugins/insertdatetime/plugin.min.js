  ...
  function i(e, t, n) {
    return (
      ...
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace('%D', '%m/%d/%Y')).replace('%r', '%I:%M:%S %p')).replace(
        '%Y',
        '' + n.getFullYear()
      )).replace('%y', '' + n.getYear())).replace('%m', a(n.getMonth() + 1, 2))).replace('%d', a(n.getDate(), 2))).replace('%H', '' + a(n.getHours(), 2))).replace(
        '%M',
        '' + a(n.getMinutes(), 2)
      )).replace('%S', '' + a(n.getSeconds(), 2))).replace('%I', '' + (((n.getHours() + 11) % 12) + 1))).replace('%p', n.getHours() < 12 ? 'AM' : 'PM')).replace(
        '%B',
        '' + e.translate(f[n.getMonth()])
      )).replace('%b', '' + e.translate(d[n.getMonth()]))).replace('%A', '' + e.translate(s[n.getDay()]))).replace('%a', '' + e.translate(l[n.getDay()]))).replace('%%', '%'))
    );
  }
      ...
      if (m(e)) {
        ...
        a
          ? (function (e, t, n, r) {
              ...
              t.parentNode.insertBefore(a, t), e.dom.remove(t), e.selection.select(a, !0), e.selection.collapse(!1);
            })(e, a, r, n)
