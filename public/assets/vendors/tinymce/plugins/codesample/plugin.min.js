    ...
    (window.Prism = { manual: !0 }),
      (function (e) {
        if ('object' == typeof t && void 0 !== r) r.exports = e();
          ...
          ('undefined' != typeof window ? window : void 0 !== w ? w : 'undefined' != typeof self ? self : this).EphoxContactWrapper = e();
        }
      })(function () {
              ...
              function (e, t, n) {
                (function (e) {
                  var n = (function (u) {
                    var c = /\blang(?:uage)?-([\w-]+)\b/i,
                      ...
                      E = {
                          ...
                          clone: function s(e, t) {
                            ...
                            switch (((t = t || {}), a)) {
                              case 'Object':
                                ...
                                for (var i in ((r = {}), (t[n] = r), e)) e.hasOwnProperty(i) && (r[i] = s(e[i], t));
                                return r;
                              case 'Array':
                                return (
                                  (n = E.util.objId(e)),
                          ...
                          DFS: function l(e, n, t, r) {
                            ...
                            for (var i in e)
                              if (e.hasOwnProperty(i)) {
                                ...
                                var s = e[i],
                                  o = E.util.type(s);
                                'Object' !== o || r[a(s)] ? 'Array' !== o || r[a(s)] || ((r[a(s)] = !0), l(s, n, i, r)) : ((r[a(s)] = !0), l(s, n, null, r));
                              }
                          }
                        },
                        plugins: {},
                        ...
                        highlightElement: function (e, n, t) {
                          ...
                          var s = { element: e, language: r, grammar: a, code: e.textContent };
                          function o(e) {
                            (s.highlightedCode = e),
                          ...
                          if ((E.hooks.run('before-sanity-check', s), !s.code)) return E.hooks.run('complete', s), void (t && t.call(s.element));
                          ...
                          for (var o in t)
                            if (t.hasOwnProperty(o) && t[o]) {
                              ...
                              for (var u = 0; u < l.length; ++u) {
                                ...
                                c = c.pattern || c;
                                for (var b = r, y = a; b < n.length; y += n[b].length, ++b) {
                                  var w = n[b];
                                  if (n.length > e.length) return;
                                  if (!(w instanceof O)) {
                                    if (g && b != n.length - 1) {
                                      if (((c.lastIndex = y), !(F = c.exec(e)))) break;
                                      for (
                                        var v = F.index + (d && F[1] ? F[1].length : 0), k = F.index + F[0].length, x = b, _ = y, A = n.length;
                                        x < A && (_ < k || (!n[x].type && !n[x - 1].greedy));
                                        ++x
                                      )
                                        (_ += n[x].length) <= v && (++b, (y = _));
                                      if (n[b] instanceof O) continue;
                                      (P = x - b), (w = e.slice(y, _)), (F.index -= y);
                                    } else {
                                      c.lastIndex = 0;
                                      var F = c.exec(w),
                                        P = 1;
                                    ...
                                    if (F) {
                                      ...
                                      k = (v = F.index + m) + (F = F[0].slice(m)).length;
                                      var S = w.slice(0, v),
                                        j = w.slice(k),
                                        $ = [b, P];
                                      S && (++b, (y += S.length), $.push(S));
                                      var C = new O(o, p ? E.tokenize(F, p) : F, f, F, g);
                                      if (($.push(C), j && $.push(j), Array.prototype.splice.apply(n, $), 1 != P && E.matchGrammar(e, n, t, b, y, !0, o + ',' + u), i)) break;
                                    } else if (i) break;
                                  }
                                }
                              }
                      ...
                      (O.stringify = function (e, n) {
                        ...
                        if (Array.isArray(e))
                          return e
                            ...
                            .join('');
                        var t = { type: e.type, content: O.stringify(e.content, n), tag: 'span', classes: ['token', e.type], attributes: {}, language: n };
                        if (e.alias) {
                        ...
                        var a = Object.keys(t.attributes)
                          ...
                          .join(' ');
                        return '<' + t.tag + ' class="' + t.classes.join(' ') + '"' + (a ? ' ' + a : '') + '>' + t.content + '</' + t.tag + '>';
                      }),
                      !u.document)
                    )
                      return (
                            ...
                            u.addEventListener(
                              ...
                              function (e) {
                                var n = JSON.parse(e.data),
                                  ...
                                  r = n.code,
                                  a = n.immediateClose;
                                u.postMessage(E.highlight(r, E.languages[t], t)), a && u.close();
                              },
                              !1
                            )),
                        E
                    ...
                    if ((e && ((E.filename = e.src), e.hasAttribute('data-manual') && (E.manual = !0)), !E.manual)) {
                      var t = function () {
                ...
                }.call(this, void 0 !== w ? w : 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : {}));
              },
              {}
            ],
            4: [
                ...
                (Prism.languages.csharp = Prism.languages.extend('clike', {
                  ...
                  Prism.languages.insertBefore('csharp', 'class-name', {
                    ...
                    preprocessor: {
                      ...
                      alias: 'property',
                      inside: {
                        directive: { pattern: /(\s*#)\b(?:define|elif|else|endif|endregion|error|if|line|pragma|region|undef|warning)\b/, lookbehind: !0, alias: 'keyword' }
                      }
                    }
                  }),
                ...
                (r = Prism),
                  ...
                  r.languages.insertBefore('java', 'class-name', {
                    ...
                    generics: {
                      ...
                      inside: { 'class-name': i, keyword: a, punctuation: /[<>(),.:]/, operator: /[?&|]/ }
                    }
                  });
              },
              {}
                      ...
                      value: function (r, a, e, i) {
                        if (r.language === a) {
                          ...
                          (r.code = r.code.replace(e, function (e) {
                            ...
                            for (var n, t = s.length; -1 !== r.code.indexOf((n = b(a, t))); ) ++t;
                            return (s[t] = e), n;
                          })),
                              ...
                              if ('string' == typeof t || (t.content && 'string' == typeof t.content)) {
                                ...
                                if (-1 < o) {
                                  ...
                                  var l = i.substring(0, o),
                                    u = new y.Token(g, y.tokenize(a, d.grammar), 'language-' + g, a),
                                    c = i.substring(o + s.length),
                                    p = [];
                                  l && p.push.apply(p, h([l])),
                                    p.push(u),
                                    c && p.push.apply(p, h([c])),
                                    'string' == typeof t ? e.splice.apply(e, [n, 1].concat(p)) : (t.content = p);
                                }
            ...
            11: [
              function (e, n, t) {
                !(function (n) {
                  ...
                  var e = { pattern: /{\$(?:{(?:{[^{}]+}|[^{}]+)}|[^{}])+}|(^|[^\\{])\$+(?:\w+(?:\[.+?]|->\w+)*)/, lookbehind: !0, inside: n.languages.php };
  ...
  var k,
      ...
      n.undoManager.transact(function () {
        ...
        return (
          ...
          e.fold(
            ...
            function (e) {
              n.dom.setAttrib(e, 'class', 'language-' + t), (e.innerHTML = r), F(n).highlightElement(e), n.selection.select(e);
            }
          )
        );
      });
    ...
    N = function (n) {
      n.addCommand('codesample', function () {
        ...
        n.selection.isCollapsed() || f.isCodeSample(e) ? z(n) : n.formatter.toggle('code');
      });
    },
    T = function (t) {
      var a = t.$;
