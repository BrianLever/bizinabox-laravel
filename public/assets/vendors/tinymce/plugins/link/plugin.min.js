...
!(function (c) {
  ...
  function U(n, t) {
    return (t = t || n.selection.getNode()), tn(t) ? n.dom.select('a[href]', t)[0] : n.dom.getParent(t, 'a[href]');
  }
  function M(n) {
  ...
  var W,
    ...
    nn = (s(Array.from) && Array.from, tinymce.util.Tools.resolve('tinymce.util.Tools')),
    tn = function (n) {
    ...
    gn = function (n, r) {
      function e(n, t) {
        var e = (function (n, t) {
          return 'link' === t ? n.catalogs.link : 'anchor' === t ? n.catalogs.anchor : X.none();
        })(r, t.name).getOr([]);
  ...
  (W = undefined),
    ...
    (function (n) {
      ...
      return (function l(i, u, c) {
        ...
        for (var f = 'function' == typeof G && G, n = 0; n < c.length; n++) a(c[n]);
        return a;
      })(
        {
          1: [
  ...
  var On = yn.exports.boltExport,
      ...
      return L(
        [
          ...
          (function (e, r) {
            return function (n) {
              var t = n.href;
              return (1 === e && !mn(t)) || (0 === e && /^\s*www[\.|\d\.]/i.test(t))
                ? X.some({
    ...
    jn = function (n) {
      ...
      return 0 < e.length ? X.some([{ text: 'None', value: '' }].concat(e)) : X.none();
    },
    Fn = function (n) {
      var t = y(n);
    ...
    zn = function (e, r) {
      return Rn(e).map(function (n) {
        var t = (function (n, t) {
          var e = n.dom,
            r = fn(n.selection.getContent()) ? X.some(sn(n.selection, t)) : X.none(),
            o = t ? X.some(e.getAttrib(t, 'href')) : X.none(),
            i = t ? X.from(e.getAttrib(t, 'target')) : X.none(),
            u = xn(e, t, 'rel'),
            c = xn(e, t, 'class');
          return { url: o, text: r, title: xn(e, t, 'title'), target: i, rel: u, linkClass: c };
        })(e, r);
        return { anchor: t, catalogs: { targets: Mn(e), rels: Dn(e, t.target), classes: Fn(e), anchor: jn(e), link: n }, optNode: X.from(r), flags: { titleEnabled: w(e) } };
      });
    },
    qn = function (t) {
      (function (n) {
    ...
    $n = function (n) {
      n.addCommand('mceLink', function () {
        x(n) ? n.fire('contexttoolbar-show', { toolbarKey: 'quicklink' }) : Kn(n)();
      });
    },
    Gn = function (n) {
    ...
    Jn = function (n) {
      n.ui.registry.addToggleButton('link', { icon: 'link', tooltip: 'Insert/edit link', onAction: Kn(n), onSetup: Wn(n) }),
        n.ui.registry.addButton('openlink', { icon: 'new-tab', tooltip: 'Open link', onAction: Bn(n), onSetup: Hn(n) }),
    ...
    Xn = function (n) {
      n.ui.registry.addMenuItem('openlink', { text: 'Open link', icon: 'new-tab', onAction: Bn(n), onSetup: Hn(n) }),
        n.ui.registry.addMenuItem('link', { icon: 'link', text: 'Link...', shortcut: 'Meta+K', onAction: Kn(n) }),
    ...
    Yn = function (i) {
      ...
      i.ui.registry.addContextForm('quicklink', {
        launch: { type: 'contextformtogglebutton', icon: 'link', tooltip: 'Link', onSetup: Wn(i) },
        label: 'Link',
                ...
                var r = { href: e, attach: function () {} },
                  o = fn(i.selection.getContent())
                    ? X.some(sn(i.selection, t))
                        ...
                        .or(X.from(e))
                    : X.none();
                on(i, r, { href: e, text: o, title: X.none(), rel: X.none(), target: X.none(), class: X.none() }), n.hide();
              }
            }
          },
          {
