...
!(function (s) {
  ...
  function L(t, e, n) {
    !(function (t, e, n) {
      if (!(_(n) || A(n) || N(n))) throw (s.console.error('Invalid call to Attr.set. Key ', e, ':: Value ', n, ':: Element ', t), new Error('Attribute value was not simple'));
      t.setAttribute(e, n + '');
    })(t.dom(), e, n);
  }
  function R(t, e) {
  ...
  function G(t) {
    z(t)
      ...
      : (function (t) {
          ...
          Ht.insertAfter(e, t), e.appendChild(t), e.appendChild(Ht.create('figcaption', { contentEditable: 'true' }, 'Caption')), (e.contentEditable = 'false');
        })(t);
  }
  function W(t, e) {
  ...
  function at(e, t, n) {
    var r = (function (t, e, n) {
      ...
      if ((Bt(t, I(I({}, e), { caption: !1 }), r, n), zt(r, e.alt, e.isDecorative, n), e.caption)) {
        var i = Ht.create('figure', { class: 'image' });
        return i.appendChild(r), i.appendChild(Ht.create('figcaption', { contentEditable: 'true' }, 'Caption')), (i.contentEditable = 'false'), i;
      }
      return r;
    })(
      function (t) {
  ...
  var st,
    ...
    Et = {
      fromHtml: function (t, e) {
        ...
        if (((n.innerHTML = t), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (s.console.error('HTML does not have a single root node', t), new Error('HTML must have a single root node'));
    ...
    St = function (t, e) {
      ...
      var r = s.document.createElement('img');
      (r.onload = function () {
        var t = { width: R(r.width, r.clientWidth), height: R(r.height, r.clientHeight) };
        n(yt.value(t));
      }),
        (r.onerror = function () {
  ...
  function Kt(t) {
    var e = t.imageList.map(function (t) {
      ...
      n = { name: 'alt', type: 'input', label: 'Alternative description', disabled: t.hasAccessibilityOptions && t.image.isDecorative },
      ...
      [
        {
          type: 'grid',
          columns: 2,
          items: T([r.toArray(), t.hasImageCaption ? [{ type: 'label', label: 'Caption', items: [{ type: 'checkbox', name: 'caption', label: 'Show caption' }] }] : []])
        }
      ]
    ]);
  }
    ...
    if (r !== undefined) {
      ...
      !(function (t, e, n) {
        t.hasDescription && _(n.alt) && (e.alt = n.alt),
          ...
          t.hasDimensions && (_(n.width) && (e.dimensions.width = n.width), _(n.height) && (e.dimensions.height = n.height)),
          _(n['class']) &&
    ...
    l.block('Uploading image'),
      (function (t) {
        ...
        function (n) {
          ...
          function i(t) {
            l.setData({ src: { value: t, meta: {} } }), l.showTab('general'), ne(u, c, e, l);
          }
          var o = s.URL.createObjectURL(n),
            a = Jt({ url: c.url, basePath: c.basePath, credentials: c.credentials, handler: c.handler });
  ...
  function oe(n, r, i) {
    return function (t, e) {
      'src' === e.name
        ...
        : 'fileinput' === e.name
        ? ie(n, r, i, t)
        : 'isDecorative' === e.name && (t.getData().isDecorative ? t.disable('alt') : t.enable('alt'));
    };
  }
  function ae(n) {
    return function (t) {
      ...
      return {
        ...
        body: (function (t) {
          return t.hasAdvTab || t.hasUploadUrl || t.hasUploadHandler
            ? { type: 'tabpanel', tabs: T([[se(t)], t.hasAdvTab ? [le(t)] : [], t.hasUploadTab && (t.hasUploadUrl || t.hasUploadHandler) ? [de(t)] : []]) }
  ...
  function ce(o) {
    return function (t) {
      for (
        ...
        var i = t[n];
        void 0, (e = i.attr('class')) && /\bimage\b/.test(e) && (i.attr('contenteditable', o ? 'false' : null), Gt.each(i.getAll('figcaption'), r));
      }
    };
  }
  var le = function (t) {
    ...
    ge = function (e) {
      e.ui.registry.addToggleButton('image', {
        ...
        e.ui.registry.addMenuItem('image', { icon: 'image', text: 'Image...', onAction: ue(e).open }),
