  ...
  var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    o = function (t) {
      ...
      for (
        ...
        if ((((o = c[e]).element.id = o.id), (r = c[e + 1] && c[e + 1].level), a === o.level)) i += '<li>';
        else for (n = a; n < o.level; n++) i += '<ul><li>';
        if (((i += '<a href="#' + o.id + '">' + o.title + '</a>'), r !== o.level && r)) for (n = o.level; r < n; n--) i += '</li></ul><li>';
        else (i += '</li>'), r || (i += '</ul>');
        a = o.level;
      }
      return i;
      ...
      insertToc: function (t) {
        ...
        !(function (t, e) {
          ...
          : t.insertContent(
              (function (t) {
                var e = o(t);
                return '<div class="' + t.dom.encode(c(t)) + '" contenteditable="false">' + e + '</div>';
              })(t)
            );
      },
      updateToc: r
