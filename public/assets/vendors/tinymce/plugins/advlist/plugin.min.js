...
!(function () {
  ...
  var e,
    ...
    c = function (n) {
      var t = n.getParam('advlist_number_styles', 'default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman');
      return t ? t.split(/[ ,]/) : [];
    },
    s = function (n) {
              ...
              n(
                u.map(o, function (n) {
                  return {
                    type: 'choiceitem',
                    value: 'default' === n ? '' : n,
                    icon: 'list-' + ('OL' === i ? 'num' : 'bull') + '-' + ('disc' === n || 'decimal' === n ? 'default' : n),
                    text: (function (n) {
  ...
  !(function b() {
    r.add('advlist', function (n) {
      var t, e, r;
      (e = 'lists'), (r = (t = n).settings.plugins ? t.settings.plugins : ''), -1 !== u.inArray(r.split(/[ ,]/), e) && (T(n), i(n));
    });
  })();
})();
