...
!(function (r) {
  ...
  function y(e, n) {
    return (function (e) {
      for (var n = [], t = 0, r = e.length; t < r; ++t) {
        if (!qe(e[t])) throw new Error('Arr.flatten item ' + t + ' was not an array, input: ' + e);
        ze.apply(n, e[t]);
      }
      return n;
    })(g(e, n));
  ...
  function A(e, n, t) {
    return e.isSome() && n.isSome() ? He.some(t(e.getOrDie(), n.getOrDie())) : He.none();
  }
  function x(e) {
  ...
  function H(e, n) {
    return (function (e, n) {
      for (var t = n !== undefined && null !== n ? n : In, r = 0; r < e.length && t !== undefined && null !== t; ++r) t = t[e[r]];
      return t;
    })(e.split('.'), n);
  }
  function $(e) {
  ...
  function K(e, n) {
    var t,
      ...
      a = i.createFragment(),
      s = nt(e);
    if ((s && ((r = i.create(s)).tagName === s.toUpperCase() && i.setAttribs(r, tt(e)), Xn(n.firstChild, u) || a.appendChild(r)), n))
      for (; (t = n.firstChild); ) {
        var c = t.nodeName;
        o || ('SPAN' === c && 'bookmark' === t.getAttribute('data-mce-type')) || (o = !0),
          Xn(t, u) ? (a.appendChild(t), (r = null)) : s ? (r || ((r = i.create(s)), a.appendChild(r)), r.appendChild(t)) : a.appendChild(t);
      }
    return s ? o || r.appendChild(i.create('br', { 'data-mce-bogus': '1' })) : a.appendChild(i.create('br')), a;
  }
  function X(e) {
  ...
  function z(e, n) {
    ...
    !(function (e, n) {
      ...
      !(function (e, n, t) {
        if (!($e(t) || We(t) || Ke(t))) throw (r.console.error('Invalid call to Attr.set. Key ', n, ':: Value ', t, ':: Element ', e), new Error('Attribute value was not simple'));
        e.setAttribute(n, t + '');
      })(t, n, e);
    });
  }
  ...
  function Y(e, n, t) {
    if (!$e(t)) throw (r.console.error('Invalid call to CSS.set. Property ', n, ':: Value ', t, ':: Element ', e), new Error('CSS value must be a string: ' + t));
    !(function (e) {
    ...
    return (
      O(r).each(function (e) {
        !(function (e, n) {
          ...
          (function (e, n) {
            X(e.list) !== n.listType && (e.list = J(e.list, n.listType)), z(e.list, n.listAttributes);
          })(e, t);
      }),
      r
    );
  ...
  function ne(e, n, t) {
    var r = (function (e, n, t) {
      for (var r, o, i, u = [], a = 0; a < t; a++) u.push(((r = e), (o = n.listType), void 0, (i = { list: Ln.fromTag(o, r), item: Ln.fromTag('li', r) }), M(i.list, i.item), i));
      return u;
    ...
    return (
      ...
      (function (e, n) {
        for (var t = 0; t < e.length - 1; t++) (r = e[t].item), (o = 'list-style-type'), (i = 'none'), void 0, (u = r.dom()), Y(u, o, i);
        var r, o, i, u;
        O(e).each(function (e) {
          z(e.list, n.listAttributes), z(e.item, n.itemAttributes), U(e.item, n.content);
        });
      })(r, t),
      (function (e, n) {
        A(O(e), S(n), Z);
  ...
  function ae(t) {
    p(t, function (n, e) {
      (function (e, n) {
        ...
        !(function (e, n) {
          (e.listType = n.listType), (e.listAttributes = Ye({}, n.listAttributes));
        })(n, e);
      });
    });
  }
        ...
        function () {
          ...
          var e = (function (n, t, r) {
            return x(n)
              .filter(rt)
              .map(function (e) {
                return { depth: t, isSelected: r, content: ue(n), itemAttributes: Q(n), listAttributes: Q(e), listType: X(e) };
              });
          })(i, t, o.get());
          r.each(function (e) {
            k(e.end, i) && o.set(!1);
  ...
  function ve(e, n) {
    ...
    if (t.length || r.length) {
      ...
      le(e, t, n), ge(e, n, r), e.selection.moveToBookmark(i), e.selection.setRng(st(e.selection.getRng())), e.nodeChanged(), (o = !0);
    }
    return o;
  }
  function he(e) {
  ...
  function Te(r, o, i) {
    ...
    'false' !== a.getContentEditable(r.selection.getNode()) &&
      ...
      Mn.each(
        (function (t, e, r) {
          for (var o, i = [], u = t.dom, n = Le(t, e, !0, r), a = Le(t, e, !1, r), s = [], c = n; c && (s.push(c), c !== a); c = c.nextSibling);
          return (
            Mn.each(s, function (e) {
              if (Kn(t, e)) return i.push(e), void (o = null);
              if (u.isBlock(e) || Wn(e)) return Wn(e) && u.remove(e), void (o = null);
              var n = e.nextSibling;
        ...
        function (e) {
          ...
          (function (e, n, t) {
            ...
            : ((n = a.create(o)), e.parentNode.insertBefore(n, e), n.appendChild(e), (e = a.rename(e, u))),
            (function (t, r, e) {
              Mn.each(e, function (e) {
                var n;
                return t.setStyle(r, (((n = {})[e] = ''), n));
              });
            })(a, e, ['margin', 'margin-right', 'margin-bottom', 'margin-left', 'margin-top', 'padding', 'padding-right', 'padding-bottom', 'padding-left', 'padding-top']),
            be(a, n, i),
            mt(r.dom, n);
        }
      ),
  ...
  function we(e, n) {
    ...
    'LI' === r.nodeName &&
      r.firstChild === n &&
      ((t = r.previousSibling) && 'LI' === t.nodeName ? (t.appendChild(n), Qn(e, r) && vt.remove(r)) : vt.setStyle(r, 'listStyleType', 'none')),
      Fn(r) && (t = r.previousSibling) && 'LI' === t.nodeName && t.appendChild(n);
  }
  function ke(e, n, t, r) {
  ...
  function Re(n, e, t) {
    ...
    if (Yn(n, e) && Yn(n, t)) {
      Fn(t.lastChild) && (o = t.lastChild),
        i === t.lastChild && Wn(i.previousSibling) && n.remove(i.previousSibling),
  ...
  function _e(e, n) {
    return e.selection.isCollapsed()
      ...
      : (function (e) {
          ...
          return (
            !!(e.dom.getParent(n, 'LI,DT,DD', t) || 0 < Zn.getSelectedListItems(e).length) &&
            (e.undoManager.transact(function () {
  ...
  var Fe,
    ...
    an = function (e) {
      var n = e.current;
      return { current: n, version: e.version, isEdge: L(nn, n), isChrome: L(tn, n), isIE: L('IE', n), isOpera: L(rn, n), isFirefox: L(on, n), isSafari: L(un, n) };
    },
    sn = {
      unknown: function () {
    ...
    yn = [
      ...
      { name: 'Opera', versionRegexes: [Nn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: w('opera') },
      { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: w('firefox') },
      {
        name: 'Safari',
    ...
    Sn = [
      { name: 'Windows', search: w('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
      {
        name: 'iOS',
        search: function (e) {
      ...
      { name: 'Android', search: w('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
      { name: 'OSX', search: w('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
      ...
      { name: 'ChromeOS', search: w('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] }
    ],
        ...
        return {
          ...
          deviceType: (function (e, n, t, r) {
            var o = e.isiOS() && !0 === /ipad/i.test(t),
              ...
              d = !c && !s && !f;
            return { isiPad: l(o), isiPhone: l(i), isTablet: l(s), isPhone: l(c), isTouch: l(a), isAndroid: e.isAndroid, isiOS: e.isiOS, isWebView: l(f), isDesktop: l(d) };
          })(i, o, e, n)
        };
    ...
    Ln = {
      fromHtml: function (e, n) {
        ...
        if (((t.innerHTML = e), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (r.console.error('HTML does not have a single root node', e), new Error('HTML must have a single root node'));
    ...
    Tn =
      (r.Node.ATTRIBUTE_NODE, r.Node.CDATA_SECTION_NODE, r.Node.COMMENT_NODE, r.Node.DOCUMENT_NODE, r.Node.DOCUMENT_TYPE_NODE, r.Node.DOCUMENT_FRAGMENT_NODE, r.Node.ELEMENT_NODE),
    Dn = (r.Node.TEXT_NODE, r.Node.PROCESSING_INSTRUCTION_NODE, r.Node.ENTITY_REFERENCE_NODE, r.Node.ENTITY_NODE, r.Node.NOTATION_NODE, Tn),
    ...
    at = function (e, n, t) {
      var r, o, i, u, a, s;
      for (
        i = ut.select('span[data-mce-type="bookmark"]', n), a = K(e, t), (r = ut.createRng()).setStartAfter(t), r.setEndAfter(n), u = (o = r.extractContents()).firstChild;
        u;
        u = u.firstChild
      )
      ...
      function e(e) {
        ...
        (t = o[e ? 'startContainer' : 'endContainer']),
          ...
          1 === t.nodeType &&
            ...
            t.hasChildNodes() ? ((r = Math.min(r, t.childNodes.length - 1)), e ? t.insertBefore(n, t.childNodes[r]) : ft.insertAfter(n, t.childNodes[r])) : t.appendChild(n),
            (t = n),
            (r = 0)),
        ...
        (n = r = o[e ? 'startContainer' : 'endContainer']),
          ...
          n &&
            (1 === n.nodeType &&
              ...
              (n = n.parentNode),
              ft.remove(r),
              !n.hasChildNodes() && ft.isBlock(n) && n.appendChild(ft.create('br'))),
            (o[e ? 'startContainer' : 'endContainer'] = n),
            (o[e ? 'startOffset' : 'endOffset'] = t));
      }
      e(!0), e();
      var n = ft.createRng();
      return n.setStart(o.startContainer, o.startOffset), o.endContainer && n.setEnd(o.endContainer, o.endOffset), st(n);
    },
    mt = function (e, n) {
      var t, r;
    ...
    Nt = function (n) {
      n.on('keydown', function (e) {
        e.keyCode === xn.BACKSPACE ? _e(n, !1) && e.preventDefault() : e.keyCode === xn.DELETE && _e(n, !0) && e.preventDefault();
      });
    },
    yt = _e,
    St = function (n) {
    ...
    bt = function (n) {
      ...
      (r = 'advlist'),
        ...
        -1 === Mn.inArray(o.split(/[ ,]/), r) &&
          (n.ui.registry.addToggleButton('numlist', { icon: 'ordered-list', active: !1, tooltip: 'Numbered list', onAction: e('InsertOrderedList'), onSetup: Ue(n, 'OL') }),
          n.ui.registry.addToggleButton('bullist', { icon: 'unordered-list', active: !1, tooltip: 'Bullet list', onAction: e('InsertUnorderedList'), onSetup: Ue(n, 'UL') }));
    };
  !(function Lt() {
