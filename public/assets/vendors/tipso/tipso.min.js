!(function (t) {
  ...
  function o(o, e) {
    (this.element = o),
      ...
      'object' == typeof this.$element.data('tipso') && t.extend(this.settings, this.$element.data('tipso'));
  ...
  function r(t) {
    t.removeClass('top_right_corner bottom_right_corner top_left_corner bottom_left_corner'),
      t.find('.tipso_title').removeClass('top_right_corner bottom_right_corner top_left_corner bottom_left_corner');
  }
  function s(o) {
    var i,
      n,
    ...
    switch ((void 0 !== h && '' !== h && (c = p.settings.titleBackground), l.parent().outerWidth() > f.outerWidth() && (f = l.parent()), p.settings.position)) {
      case 'top-right':
        (n = l.offset().left + l.outerWidth()),
          ...
          d.find('.tipso_arrow').css({ marginLeft: -p.settings.arrowWidth, marginTop: '' }),
          i < f.scrollTop()
            ? ((i = l.offset().top + l.outerHeight() + g),
              d.find('.tipso_arrow').css({ 'border-bottom-color': c, 'border-top-color': 'transparent', 'border-left-color': 'transparent', 'border-right-color': 'transparent' }),
              r(d),
            ...
            : (d
                .find('.tipso_arrow')
                .css({ 'border-top-color': p.settings.background, 'border-bottom-color': 'transparent ', 'border-left-color': 'transparent', 'border-right-color': 'transparent' }),
              r(d),
              d.addClass('top_right_corner'),
              d.find('.tipso_arrow').css({ 'border-left-color': p.settings.background }),
        ...
        (n = l.offset().left - e(d).width),
          ...
          i < f.scrollTop()
            ...
            : (d
              ...
              d.find('.tipso_arrow').css({ 'border-right-color': p.settings.background }),
              d.removeClass('top bottom left right'),
              d.addClass('top'));
        break;
      case 'bottom-right':
        (n = l.offset().left + l.outerWidth()),
          ...
          i + e(d).height > f.scrollTop() + f.outerHeight()
            ? ((i = l.offset().top - e(d).height - g),
              d
                .find('.tipso_arrow')
                .css({ 'border-bottom-color': 'transparent', 'border-top-color': p.settings.background, 'border-left-color': 'transparent', 'border-right-color': 'transparent' }),
              r(d),
              d.addClass('top_right_corner'),
              ...
              d.removeClass('top-right top bottom left right'),
              d.addClass('top'))
            : (d.find('.tipso_arrow').css({ 'border-top-color': 'transparent', 'border-bottom-color': c, 'border-left-color': 'transparent', 'border-right-color': 'transparent' }),
              r(d),
              d.addClass('bottom_right_corner'),
              d.find('.tipso_title').addClass('bottom_right_corner'),
              d.find('.tipso_arrow').css({ 'border-left-color': c }),
      ...
      case 'left':
        (n = l.offset().left - e(d).width - g),
          ...
          d.find('.tipso_arrow').css({ marginTop: -p.settings.arrowWidth, marginLeft: '' }),
          n < f.scrollLeft()
            ? ((n = l.offset().left + l.outerWidth() + g),
              d
                .find('.tipso_arrow')
                .css({ 'border-right-color': p.settings.background, 'border-left-color': 'transparent', 'border-top-color': 'transparent', 'border-bottom-color': 'transparent' }),
              d.removeClass('top bottom left right'),
              d.addClass('right'))
            : (d
                .find('.tipso_arrow')
                .css({ 'border-left-color': p.settings.background, 'border-right-color': 'transparent', 'border-top-color': 'transparent', 'border-bottom-color': 'transparent' }),
              d.removeClass('top bottom left right'),
              d.addClass(p.settings.position));
        break;
      case 'right':
    ...
    n < f.scrollLeft() && ('bottom' === p.settings.position || 'top' === p.settings.position) && (d.find('.tipso_arrow').css({ marginLeft: n - p.settings.arrowWidth }), (n = 0)),
      n + p.settings.width > f.outerWidth() &&
        ('bottom' === p.settings.position || 'top' === p.settings.position) &&
        ((a = f.outerWidth() - (n + p.settings.width)), d.find('.tipso_arrow').css({ marginLeft: -a - p.settings.arrowWidth, marginTop: '' }), (n += a)),
      n < f.scrollLeft() &&
        ...
        n + p.settings.width > f.outerWidth() &&
          ((a = f.outerWidth() - (n + p.settings.width)), d.find('.tipso_arrow').css({ marginLeft: -a - p.settings.arrowWidth, marginTop: '' }), (n += a)),
        n < f.scrollLeft() && (d.find('.tipso_arrow').css({ marginLeft: n - p.settings.arrowWidth }), (n = 0))),
      n + p.settings.width > f.outerWidth() &&
        ('left' === p.settings.position ||
          'right' === p.settings.position ||
          'top-right' === p.settings.position ||
      ...
      i < f.scrollTop() && ('right' === p.settings.position || 'left' === p.settings.position) && (l.tipso('update', 'position', 'bottom'), s(p)),
      i + e(d).height > f.scrollTop() + f.outerHeight() && ('right' === p.settings.position || 'left' === p.settings.position) && (l.tipso('update', 'position', 'top'), s(p));
  }
  var i = 'tipso',
    n = {
      speed: 400,
  ...
  t.extend(o.prototype, {
    ...
    tooltip: function () {
      return (
        this.tipso_bubble ||
          (this.tipso_bubble = t('<div class="tipso_bubble"><div class="tipso_title"></div><div class="tipso_content"></div><div class="tipso_arrow"></div></div>')),
        this.tipso_bubble
      );
    },
    show: function () {
      var o = this.tooltip(),
        e = this,
        r = this.win;
      e.settings.showArrow === !1 ? o.find('.tipso_arrow').hide() : o.find('.tipso_arrow').show(),
        'hide' === e.mode &&
          (t.isFunction(e.settings.onBeforeShow) && e.settings.onBeforeShow(e.$element, e.element, e),
          e.settings.size && o.addClass(e.settings.size),
          e.settings.width
            ? o.css({ background: e.settings.background, color: e.settings.color, width: e.settings.width }).hide()
            : e.settings.maxWidth
            ? o.css({ background: e.settings.background, color: e.settings.color, maxWidth: e.settings.maxWidth }).hide()
            : o.css({ background: e.settings.background, color: e.settings.color, width: 200 }).hide(),
          o.find('.tipso_title').css({ background: e.settings.titleBackground, color: e.settings.titleColor }),
          ...
          (e.timeout = window.setTimeout(function () {
            e.ieFade || '' === e.settings.animationIn || '' === e.settings.animationOut
              ? o
                  .appendTo('body')
                  .stop(!0, !0)
              ...
              : o
                  ...
                  .fadeIn(e.settings.speed, function () {
                    t(this).one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function () {
                      ...
                      (e.mode = 'show'),
                      t.isFunction(e.settings.onShow) && e.settings.onShow(e.$element, e.element, e),
          ...
          'tooltipHover' !== e.mode &&
            (e.ieFade || '' === e.settings.animationIn || '' === e.settings.animationOut
              ? s.stop(!0, !0).fadeOut(e.settings.speed, function () {
                  t(this).remove(),
                    t.isFunction(e.settings.onHide) && 'show' === e.mode && e.settings.onHide(e.$element, e.element, e),
                    (e.mode = 'hide'),
                    r.off('resize.' + i, null, 'tipsoResizeHandler');
                })
              : s
    ...
    content: function () {
      ...
      return (
        r.settings.ajaxContentUrl
          ? r._ajaxContent
            ? (o = r._ajaxContent)
            : ((r._ajaxContent = o = t.ajax({ type: 'GET', url: r.settings.ajaxContentUrl, async: !1 }).responseText),
        ...
        null !== r.settings.templateEngineFunc && (o = r.settings.templateEngineFunc(o)),
        o
      );
    },
    update: function (t, o) {
      ...
      return (
        this.each(function () {
          ...
          n || (n = t.data(this, 'plugin_' + i, new o(this, e))),
            n instanceof o && 'function' == typeof n[e] && (s = n[e].apply(n, Array.prototype.slice.call(r, 1))),
