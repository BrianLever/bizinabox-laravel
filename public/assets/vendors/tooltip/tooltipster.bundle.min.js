      ...
      __geometry: function () {
        ...
        var f = c[0].getBoundingClientRect(),
          ...
          k = {
            ...
            window: {
              scroll: { left: h.window.scrollX || h.window.document.documentElement.scrollLeft, top: h.window.scrollY || h.window.document.documentElement.scrollTop },
      ...
      _optionsExtract: function (b, c) {
        ...
        return (
          ...
          a.each(e, function (b, c) {
            void 0 !== f[b] &&
              ('object' != typeof c || c instanceof Array || null == c || 'object' != typeof f[b] || f[b] instanceof Array || null == f[b] ? (e[b] = f[b]) : a.extend(e[b], f[b]));
          }),
          e
        );
      },
        ...
        return (
          c.__destroyed
            ...
            : 'closed' != c.__state &&
              d(c._$origin) &&
              (b || d(c._$tooltip)) &&
              (b || c._$tooltip.detach(), (c.__Geometry = c.__geometry()), c._trigger({ type: 'reposition', event: a, helper: { geo: c.__Geometry } })),
          c
        );
      },
      show: function (a) {
      ...
      instance: {
        ...
        __reposition: function (b, c) {
          ...
          (p = c.geo.origin.fixedLineage
            ...
            : { left: c.geo.origin.windowOffset.left + c.geo.window.scroll.left, top: c.geo.origin.windowOffset.top + c.geo.window.scroll.top }),
