        ...
        (n = e.height instanceof Function ? parseInt(e.height.call()) : parseInt(e.height)),
          e.disableForMobile && mUtil.isInResponsiveRange('tablet-and-mobile')
            ? (a = mUtil.data(t).get('ps'))
              ? (e.resetHeightOnDestroy ? mUtil.css(t, 'height', 'auto') : (mUtil.css(t, 'overflow', 'auto'), n > 0 && mUtil.css(t, 'height', n + 'px')),
                a.destroy(),
                (a = mUtil.data(t).remove('ps')))
              : n > 0 && (mUtil.css(t, 'overflow', 'auto'), mUtil.css(t, 'height', n + 'px'))
            : (n > 0 && mUtil.css(t, 'height', n + 'px'),
              mUtil.css(t, 'overflow', 'hidden'),
              (a = mUtil.data(t).get('ps'))
                ? a.update()
                : (mUtil.addClass(t, 'm-scroller'),
                  (a = new PerfectScrollbar(t, { wheelSpeed: 0.5, swipeEasing: !0, wheelPropagation: !1, minScrollbarLength: 40, suppressScrollX: !0 })),
  ...
  return {
    ...
    block: function (t, e) {
      ...
      if (
        ...
        (e = $.extend(
          !0,
          { opacity: 0.03, overlayColor: '#000000', state: 'brand', type: 'loader', size: 'lg', centerX: !0, centerY: !0, message: '', shadow: !0, width: 'auto' },
          e
        )).type
          ? (o = '<div class="m-spinner ' + (a = e.skin ? 'm-spinner--skin-' + e.skin : '') + ' ' + (n = e.state ? 'm-spinner--' + e.state : '') + '"></div')
  ...
  (function (t) {
    ...
    (t.fn.mDatatable = function (n) {
        ...
        var i = {
          ...
          init: function (e) {
            ...
            return (
              ...
              ('remote' !== e.data.type && 'local' !== e.data.type) ||
                ((!1 === e.data.saveState || (!1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage)) && i.stateRemove(i.stateId),
              ...
              (null !== e.data.type && 'local' !== e.data.type) ||
                (i.setupCellField.call(), i.setupTemplateCell.call(), i.setupSubDatatable.call(), i.setupSystemColumn.call(), i.redraw()),
          ...
          layoutUpdate: function () {
            i.setupSubDatatable.call(),
              ...
              i.columnHide.call(),
              i.resetScroll(),
              i.isInit || (t(o).trigger('m-datatable--on-init', { table: t(o.wrap).attr('id'), options: n }), (i.isInit = !0)),
              t(o).trigger('m-datatable--on-layout-updated', { table: t(o.wrap).attr('id') });
          },
          lockTable: function () {
            var e = {
              lockEnabled: !1,
          ...
          fullRender: function () {
            i.isLocked() &&
              (t(o.tableHead).empty(),
              i.setHeadTitle(),
              i.getOption('layout.footer') && (t(o.tableFoot).empty(), i.setHeadTitle(o.tableFoot)),
              i.spinnerCallback(!0),
          ...
          lockEnabledColumns: function () {
            ...
            return (
              t.each(o, function (t, n) {
                void 0 !== n.locked &&
                  (void 0 !== n.locked.left && e.getBreakpoint(n.locked.left) <= a && i.left.push(n.locked.left),
          ...
          setupBaseDOM: function () {
            (o.initialDatatable = t(o).clone()),
              'TABLE' === t(o).prop('tagName')
                ? ((o.table = t(o).removeClass('m-datatable').addClass('m-datatable__table')),
              ...
              void 0 !== n.layout.footer &&
                n.layout.footer &&
                ((o.tableFoot = t(o.table).find('tfoot')), 0 === t(o.tableFoot).length && (o.tableFoot = t('<tfoot/>').appendTo(o.table)));
          },
                          ...
                          t(n)
                            ...
                            .html(
                              t('<a/>')
                                ...
                                .attr('href', '#')
                                .attr('data-value', l)
                                .append(t('<i/>').addClass(i.getOption('layout.icons.rowDetail.collapse')))
                            );
                        }
                      }
                    });
              ...
              init: function () {
                ...
                if (n.layout.scroll) {
                  ...
                  t(r).find('.m-datatable__row').length > 0 && t(r).length > 0
                    ? ((a.scrollHead = t(o.tableHead).find('> .m-datatable__lock--scroll > .m-datatable__row')),
                      ...
                      i.getOption('layout.customScrollbar') && 10 != e.detectIE() && l > e.getBreakpoint('lg') ? a.initCustomScrollbar(r[0]) : a.initDefaultScrollbar(r))
                    : t(o.tableBody).find('.m-datatable__row').length > 0 &&
                      ((a.scrollHead = t(o.tableHead).find('> .m-datatable__row')),
                      (a.scrollFoot = t(o.tableFoot).find('> .m-datatable__row')),
                      i.getOption('layout.customScrollbar') && 10 != e.detectIE() && l > e.getBreakpoint('lg')
            ...
            void 0 === r && ((r = document.createElement('tr')), a.appendChild(r)),
              t.each(l, function (a, n) {
                ...
                if (
                  ...
                  void 0 !== n.title && ((i.innerHTML = n.title), i.setAttribute('data-field', n.field), e.addClass(i, n.class), t(i).data(n)),
                  void 0 !== n.attr &&
            ...
            var l = {
              ...
              init: function (e) {
                (l.meta = e),
                  ...
                  t(l.pager).hasClass('m-datatable--paging-loaded') ||
                    (t(l.pager).remove(),
                    0 !== l.meta.pages &&
                      (i.setDataSourceParam('pagination', { page: l.meta.page, pages: l.meta.pages, perpage: l.meta.perpage, total: l.meta.total }),
              ...
              populate: function () {
                ...
                for (var c = d; c < s; c++) {
                  var m = c + 1;
                  t('<li/>')
                    .append(t('<a/>').addClass('m-datatable__pager-link m-datatable__pager-link-number').text(m).attr('data-page', m).attr('title', m).on('click', l.gotoPage))
                    .appendTo(n);
                }
                t('<li/>')
                  .append(
                  ...
                  i.getOption('toolbar.items.info') &&
                    (l.pagerLayout.info = t('<div/>').addClass('m-datatable__pager-info').append(t('<span/>').addClass('m-datatable__pager-detail'))),
                ...
                var u = t('<select/>')
                    ...
                    .attr('title', i.getOption('translate.toolbar.pagination.items.default.select'))
                ...
                t(o)
                  ...
                  .on(l.paginateEvent, function (e, a) {
                    ...
                    t(n).find('.m-datatable__pager-link--active').removeClass('m-datatable__pager-link--active'),
                      t(n)
                        .find('.m-datatable__pager-link-number[data-page="' + a.page + '"]')
              ...
              updateInfo: function () {
                ...
                t(l.pager)
                  ...
                  .html(
                    i.dataPlaceholder(i.getOption('translate.toolbar.pagination.items.info'), {
                      start: e,
              ...
              paginationUpdate: function () {
                ...
                t(n).each(function (e, a) {
                  ...
                  1 === l.meta.page
                    ? (t(r).attr('disabled', !0).addClass('m-datatable__pager-link--disabled'), t(s).attr('disabled', !0).addClass('m-datatable__pager-link--disabled'))
                    : (t(r).removeAttr('disabled').removeClass('m-datatable__pager-link--disabled'), t(s).removeAttr('disabled').removeClass('m-datatable__pager-link--disabled')),
                  l.meta.page === l.meta.pages
                    ? (t(d).attr('disabled', !0).addClass('m-datatable__pager-link--disabled'), t(c).attr('disabled', !0).addClass('m-datatable__pager-link--disabled'))
                    : (t(d).removeAttr('disabled').removeClass('m-datatable__pager-link--disabled'), t(c).removeAttr('disabled').removeClass('m-datatable__pager-link--disabled'));
              ...
              var a = function (a) {
                  ...
                  0 === t(r).length &&
                    ((r = t('<tr/>')
                      ...
                      .hide()
                      .append(t('<td/>').addClass('m-datatable__subtable').attr('colspan', i.getTotalColumns()))),
                    t(l).after(r),
                  ...
                  t(l).hasClass('m-datatable__row--subtable-expanded')
                    ? (t(c).addClass(i.getOption('layout.icons.rowDetail.collapse')),
                      t(l).removeClass('m-datatable__row--subtable-expanded'),
                      t(o).trigger('m-datatable--on-collapse-subtable', [l]))
                    : (t(c).addClass(i.getOption('layout.icons.rowDetail.expand')),
                        ...
                        if (void 0 !== o.subtable && o.subtable) {
                          ...
                          t(n).html(
                            t('<a/>')
                              ...
                              .on('click', a)
                              .append(t('<i/>').css('width', t(n).data('width')).addClass(i.getOption('layout.icons.rowDetail.collapse')))
                          );
                        }
                      }
                    });
                ...
                t(l).each(function () {
                  ...
                  t(s).append(
                    t('<tr class="m-datatable__row"></tr>')
                      .append(t('<td class="m-datatable__cell"></td>').append(t('<span/>').css('width', i.offset).append(a.title)))
                      .append(this)
                  );
                }),
                  t(r).append(s);
                  ...
                  t('<td/>')
                    ...
                    .append(
                      t('<a/>')
                        ...
                        .attr('href', '')
                        .on('click', e)
                        .append(t('<i/>').css('width', '21px').addClass(i.getOption('layout.icons.rowDetail.collapse')))
                    )
                ),
                  0 === t(o.tableHead).find('.m-datatable__toggle-detail').length
                    ? (t(o.tableHead).find('.m-datatable__row').first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'),
                      t(o.tableFoot).find('.m-datatable__row').first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'))
                    : t(o.tableHead).find('.m-datatable__toggle-detail').find('span').css('width', '21px');
              });
          },
          ...
          setAutoColumns: function () {
            i.getOption('data.autoColumns') &&
              ...
              i.setHeadTitle(),
              i.getOption('layout.footer') && (t(o.tableFoot).find('.m-datatable__row').remove(), i.setHeadTitle(o.tableFoot)));
          },
          isLocked: function () {
          ...
          stateKeep: function (t, e) {
            (t = i.getTablePrefix(t)),
              !1 !== i.getOption('data.saveState') &&
                (i.getOption('data.saveState.webstorage') && localStorage && localStorage.setItem(t, JSON.stringify(e)),
          ...
          sorting: function () {
            var e = {
              init: function () {
                n.sortable &&
                  (t(o.tableHead).find('.m-datatable__cell:not(.m-datatable__cell--check)').addClass('m-datatable__cell--sort').off('click').on('click', e.sortClick), e.setIcon());
              },
              setIcon: function () {
              ...
              sortClick: function (a) {
                ...
                if ((void 0 === s.sortable || !1 !== s.sortable) && (t(o.tableHead).find('.m-datatable__cell > span > i').remove(), n.sortable)) {
                  ...
                  i.getObject('field', l) === r && (d = i.getObject('sort', l)),
                    (l = { field: r, sort: (d = void 0 === d || 'desc' === d ? 'asc' : 'desc') }),
          ...
          resetScroll: function () {
            void 0 === n.detail &&
              1 === i.getDepth() &&
              (t(o.table).find('.m-datatable__row').css('left', 0), t(o.table).find('.m-datatable__lock').css('top', 0), t(o.tableBody).scrollTop(0));
          },
          ...
          rowEvenOdd: function () {
            t(o.tableBody).find('.m-datatable__row').removeClass('m-datatable__row--even'),
              t(o.wrap).hasClass('m-datatable--subtable')
                ? t(o.tableBody).find('.m-datatable__row:not(.m-datatable__row-detail):even').addClass('m-datatable__row--even')
                : t(o.tableBody).find('.m-datatable__row:nth-child(even)').addClass('m-datatable__row--even');
          },
          timer: 0,
          redraw: function () {
          ...
          setDataSourceParam: function (e, a) {
            (o.API.params = t.extend(
              {},
              { pagination: { page: 1, perpage: i.getOption('data.pageSize') }, sort: i.getDefaultSortColumn(), query: {} },
              o.API.params,
          ...
          getCurrentPage: function () {
            return (
              t(o.table).siblings('.m-datatable__pager').last().find('.m-datatable__pager-nav').find('.m-datatable__pager-link.m-datatable__pager-link--active').data('page') || 1
            );
          },
          ...
          visible: function (e) {
            if (t(i.recentNode.length)) {
              ...
              e
                ? (i.recentNode === i.nodeCols && delete n.columns[o].responsive, t(i.recentNode).show())
                : (i.recentNode === i.nodeCols && i.setOption('columns.' + o + '.responsive', { hidden: 'xl' }), t(i.recentNode).hide()),
                i.redraw();
            }
          },
          nodes: function () {
        ...
        if (
          ...
          if ('string' == typeof n) {
            ...
            o.data('mDatatable') ||
              ...
              ((o.dataSet = null),
              (o.textAlign = { left: 'm-datatable__cell--left', center: 'm-datatable__cell--center', right: 'm-datatable__cell--right' }),
      ...
      (t.fn.mDatatable.defaults = {
        ...
        rows: { callback: function () {}, beforeTemplate: function () {}, afterTemplate: function () {}, autoHide: !1 },
        toolbar: {
    ...
    var i = { toggle: 'click', hoverTimeout: 300, skin: 'light', height: 'auto', maxHeight: !1, minHeight: !1, persistent: !1, mobileOverlay: !0 },
      l = {
        ...
        hide: function (t) {
          return !1 === a.open
            ? a
            : (mUtil.isDesktopDevice() && 'hover' == a.options.toggle ? l.hideHovered(t) : l.hideClicked(),
              'down' == a.layout.defaultDropPos &&
                'up' == a.layout.currentDropPos &&
                (mUtil.removeClass(n, 'm-dropdown--up'), a.layout.arrow.prependTo(a.layout.wrapper), (a.layout.currentDropPos = 'down')),
              a);
        },
        ...
        adjustArrowPos: function () {
          ...
          a.layout.arrow &&
            (mUtil.isInResponsiveRange('mobile') && mUtil.hasClass(n, 'm-dropdown--mobile-full-width')
              ? ((o = mUtil.offset(n).left + t / 2 - Math.abs(parseInt(mUtil.css(a.layout.arrow, 'width')) / 2) - parseInt(mUtil.css(a.layout.wrapper, 'left'))),
              ...
              : mUtil.hasClass(a.layout.arrow, 'm-dropdown__arrow--adjust') &&
                ((o = t / 2 - Math.abs(parseInt(mUtil.css(a.layout.arrow, 'width')) / 2)),
                mUtil.hasClass(n, 'm-dropdown--align-push') && (o += 20),
                'right' == e
                  ? mUtil.isRTL()
                    ? (mUtil.css(a.layout.arrow, 'right', 'auto'), mUtil.css(a.layout.arrow, 'left', o + 'px'))
                    : (mUtil.css(a.layout.arrow, 'left', 'auto'), mUtil.css(a.layout.arrow, 'right', o + 'px'))
                  : mUtil.isRTL()
                  ? (mUtil.css(a.layout.arrow, 'left', 'auto'), mUtil.css(a.layout.arrow, 'right', o + 'px'))
                  : (mUtil.css(a.layout.arrow, 'right', 'auto'), mUtil.css(a.layout.arrow, 'left', o + 'px'))));
        },
    ...
    if ((e = a.querySelectorAll('.m-dropdown.m-dropdown--open')))
      for (var o = 0, i = e.length; o < i; o++) {
        ...
        mUtil.hasClass(l, 'm-dropdown--disable-close') && (t.preventDefault(), t.stopPropagation()),
          s && n !== s && !1 === s.contains(n) && !1 === n.contains(s) ? !1 === l.contains(n) && (r.isPersistent(), r.hide()) : !1 === l.contains(n) && r.hide();
      }
  });
            ...
            (!1 === a.options.minimize.mobile && !1 === a.options.minimize.desktop) ||
              window.addEventListener('scroll', function () {
                ...
                mUtil.isInResponsiveRange('desktop')
                  ...
                  : mUtil.isInResponsiveRange('tablet-and-mobile') && ((l = a.options.offset.mobile), (e = a.options.minimize.mobile.on), (n = a.options.minimize.mobile.off)),
                  (i = window.pageYOffset),
                  (mUtil.isInResponsiveRange('tablet-and-mobile') && a.options.classic && a.options.classic.mobile) ||
                  (mUtil.isInResponsiveRange('desktop') && a.options.classic && a.options.classic.desktop)
                    ? i > l
                      ? (mUtil.addClass(o, e), mUtil.removeClass(o, n))
                      : (mUtil.addClass(o, n), mUtil.removeClass(o, e))
                    : (i > l && t < i ? (mUtil.addClass(o, e), mUtil.removeClass(o, n)) : (mUtil.addClass(o, n), mUtil.removeClass(o, e)), (t = i));
              });
          },
          eventTrigger: function (t, e) {
            for (var n = 0; n < a.events.length; n++) {
        ...
        r = {
          ...
          build: function () {
            (a.eventHandlers.event_1 = mUtil.on(o, '.m-menu__toggle', 'click', r.handleSubmenuAccordion)),
              ('dropdown' === r.getSubmenuMode() || r.isConditionalSubmenuDropdown()) &&
                ((a.eventHandlers.event_2 = mUtil.on(o, '[m-menu-submenu-toggle="hover"]', 'mouseover', r.handleSubmenuDrodownHoverEnter)),
          ...
          scrollerInit: function () {
            a.options.scroll &&
              ...
              (mUtil.scrollerDestroy(o), mUtil.scrollerInit(o, { disableForMobile: !0, resetHeightOnDestroy: !0, handleWindowResize: !0, height: a.options.scroll.height }));
          },
          ...
          getSubmenuMode: function (t) {
            return mUtil.isInResponsiveRange('desktop')
              ? t && mUtil.hasAttr(t, 'm-menu-submenu-toggle')
                ...
                : void 0
              : mUtil.isInResponsiveRange('tablet') && mUtil.isset(a.options.submenu, 'tablet')
              ? a.options.submenu.tablet
              : !(!mUtil.isInResponsiveRange('mobile') || !mUtil.isset(a.options.submenu, 'mobile')) && a.options.submenu.mobile;
          },
            ...
            if ('accordion' !== r.getSubmenuMode(this)) {
              ...
              'accordion' != e.getAttribute('m-menu-submenu-mode') &&
                (!1 === mUtil.hasClass(e, 'm-menu__item--hover')
                  ? (mUtil.addClass(e, 'm-menu__item--open-dropdown'), r.showSubmenuDropdown(e))
                  : (mUtil.removeClass(e, 'm-menu__item--open-dropdown'), r.hideSubmenuDropdown(e, !0)),
                t.preventDefault());
            }
          },
          handleSubmenuDropdownTabClick: function (t) {
            if ('accordion' !== r.getSubmenuMode(this)) {
              var e = this.closest('.m-menu__item');
              'accordion' != e.getAttribute('m-menu-submenu-mode') &&
                (0 == mUtil.hasClass(e, 'm-menu__item--hover') && (mUtil.addClass(e, 'm-menu__item--open-dropdown'), r.showSubmenuDropdown(e)), t.preventDefault());
            }
          },
          ...
          createSubmenuDropdownClickDropoff: function (t) {
            var e,
              ...
              n = document.createElement(
                '<div class="m-menu__dropoff" style="background: transparent; position: fixed; top: 0; bottom: 0; left: 0; right: 0; z-index: ' + a + '"></div>'
              );
            i.appendChild(n),
                ...
                ? (mUtil.hasClass(e, 'm-menu__submenu--right')
                    ? ((n = mUtil.outerWidth(t) / 2),
                      mUtil.hasClass(e, 'm-menu__submenu--pull') &&
                        (mUtil.isRTL() ? (n += Math.abs(parseFloat(mUtil.css(e, 'margin-left')))) : (n += Math.abs(parseFloat(mUtil.css(e, 'margin-right'))))),
                      (n = parseInt(mUtil.css(e, 'width')) - n))
                    : mUtil.hasClass(e, 'm-menu__submenu--left') &&
                      ((n = mUtil.outerWidth(t) / 2),
                      mUtil.hasClass(e, 'm-menu__submenu--pull') &&
                        (mUtil.isRTL() ? (n += Math.abs(parseFloat(mUtil.css(e, 'margin-right')))) : (n += Math.abs(parseFloat(mUtil.css(e, 'margin-left')))))),
                  mUtil.isRTL() ? mUtil.css(a, 'right', n + 'px') : mUtil.css(a, 'left', n + 'px'))
      ...
      var l = {
        ...
        r = {
          ...
          onScrollSticky: function () {
            window.pageYOffset > a.options.sticky.offset
              ? !1 === mUtil.hasClass(o, 'm-portlet--sticky') &&
                (r.eventTrigger('stickyOn'), mUtil.addClass(o, 'm-portlet--sticky'), mUtil.addClass(n, 'm-portlet--sticky'), r.updateSticky())
              : mUtil.hasClass(o, 'm-portlet--sticky') &&
                (r.eventTrigger('stickyOff'), mUtil.removeClass(o, 'm-portlet--sticky'), mUtil.removeClass(n, 'm-portlet--sticky'), r.resetSticky());
          },
          initSticky: function () {
          ...
          updateSticky: function () {
            ...
            a.head &&
              mUtil.hasClass(o, 'm-portlet--sticky') &&
              ((t = a.options.sticky.position.top instanceof Function ? parseInt(a.options.sticky.position.top.call()) : parseInt(a.options.sticky.position.top)),
              ...
              mUtil.isRTL()
                ? (mUtil.css(a.head, 'left', n + 'px'), mUtil.css(a.head, 'right', e + 'px'))
                : (mUtil.css(a.head, 'left', e + 'px'), mUtil.css(a.head, 'right', n + 'px')));
          },
          resetSticky: function () {
            a.head &&
              !1 === mUtil.hasClass(o, 'm-portlet--sticky') &&
              (mUtil.css(a.head, 'z-index', ''), mUtil.css(a.head, 'top', ''), mUtil.css(a.head, 'left', ''), mUtil.css(a.head, 'right', ''));
          },
          ...
          remove: function () {
            !1 !== r.eventTrigger('beforeRemove') &&
              (mUtil.hasClass(o, 'm-portlet--fullscreen') && mUtil.hasClass(n, 'm-portlet--fullscreen') && r.fullscreen('off'),
              r.removeTooltips(),
              mUtil.remove(n),
        ...
        r = {
          ...
          search: function (t) {
            if (
              ...
              0 === a.query.length && (r.handleCancelIconVisibility('on'), mUtil.removeClass(n, a.options.hasResultClass), mUtil.removeClass(a.form, a.options.spinnerClass)),
          ...
          handleCancelIconVisibility: function (t) {
            'on' == t
              ? 0 === a.input.value.length
                ? (a.iconCancel && mUtil.css(a.iconCancel, 'visibility', 'hidden'), a.iconClose && mUtil.css(a.iconClose, 'visibility', 'visible'))
              ...
              : (a.iconCancel && mUtil.css(a.iconCancel, 'visibility', 'hidden'), a.iconClose && mUtil.css(a.iconClose, 'visibility', 'hidden'));
          },
          ...
          showDropdown: function (t) {
            0 == a.dropdown.isShown() &&
              ...
              0 == a.processing &&
              (console.log('show!!!'), a.dropdown.show(), t && (t.preventDefault(), t.stopPropagation()));
          },
          eventTrigger: function (t) {
            for (i = 0; i < a.events.length; i++) {
              var e = a.events[i];
          ...
          build: function () {
            mUtil.addEvent(a.btnNext, 'click', function (t) {
              ...
              mUtil.on(n, '.m-wizard__step a.m-wizard__step-number', 'click', function () {
                for (
                  var t, e = this.closest('.m-wizard__step'), n = mUtil.parents(this, '.m-wizard__steps'), o = mUtil.findAll(n, '.m-wizard__step'), i = 0, r = o.length;
                  i < r;
                  i++
                )
                  if (e === o[i]) {
          ...
          goTo: function (t) {
            if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
              ...
              if (((e = (t = t ? parseInt(t) : l.getNextStep()) > a.currentStep ? l.eventTrigger('beforeNext') : l.eventTrigger('beforePrev')), !0 !== a.stopped))
                return (
                  !1 !== e && (l.eventTrigger('beforeChange'), (a.currentStep = t), l.updateUI(), l.eventTrigger('change')),
  ...
  (t.fn.mDatatable = t.fn.mDatatable || {}),
    (t.fn.mDatatable.checkbox = function (e, a) {
      var n = {
        ...
        initSelect: function () {
          n.selectedAllRows && a.vars.requestIds
            ? (e.hasClass('m-datatable--error') || t(e.tableHead).find('.m-checkbox--all > [type="checkbox"]').prop('checked', !0),
              e.setActiveAll(!0),
            ...
            : (n.selectedRows.forEach(function (t) {
              ...
              !e.hasClass('m-datatable--error') &&
                t(e.tableBody).find('.m-checkbox--single > [type="checkbox"]').not(':checked').length < 1 &&
                t(e.tableHead).find('.m-checkbox--all > [type="checkbox"]').prop('checked', !0));
        },
      ...
      return (
        ...
        'object' == typeof a && ((a = t.extend(!0, {}, t.fn.mDatatable.checkbox.default, a)), n.init.apply(this, [a])),
        e
      );
    }),
...
var mLayout = (function () {
  var t,
    ...
    i = function () {
      0 !== $('#m_aside_left_hide_toggle').length &&
        (i = new mToggle('m_aside_left_hide_toggle', { target: 'body', targetState: 'm-aside-left--hide', togglerState: 'm-brand__toggler--active' })).on('toggle', function (a) {
  ...
  return {
    ...
    initHeader: function () {
      ...
      (a = mUtil.get('m_header')),
        ...
        'hide' == mUtil.attr(a, 'm-minimize-mobile')
          ? ((o.minimize.mobile = {}), (o.minimize.mobile.on = 'm-header--hide'), (o.minimize.mobile.off = 'm-header--show'))
          : (o.minimize.mobile = !1),
        'hide' == mUtil.attr(a, 'm-minimize')
          ? ((o.minimize.desktop = {}), (o.minimize.desktop.on = 'm-header--hide'), (o.minimize.desktop.off = 'm-header--show'))
        ...
        (t = new mMenu('m_header_menu', { submenu: { desktop: 'dropdown', tablet: 'accordion', mobile: 'accordion' }, accordion: { slideSpeed: 200, expandAll: !1 } })),
        $('#m_aside_header_topbar_mobile_toggle').click(function () {
          $('body').toggleClass('m-topbar--on');
        }),
        0 !== $('#m_quicksearch').length &&
          new mQuicksearch('m_quicksearch', { mode: mUtil.attr('m_quicksearch', 'm-quicksearch-mode'), minLength: 1 }).on('search', function (t) {
            t.showProgress(),
              $.ajax({
    ...
    initAside: function () {
      var n, l, r, s, d, c, m, u;
      (r = mUtil.get('body')),
        (s = mUtil.get('m_aside_left')),
        (d = mUtil.hasClass(s, 'm-aside-left--offcanvas-default') ? 'm-aside-left--offcanvas-default' : 'm-aside-left'),
        ...
        mUtil.hasClass(r, 'm-aside-left--fixed') &&
          (mUtil.addEvent(s, 'mouseenter', function () {
            l && (clearTimeout(l), (l = null)),
              (n = setTimeout(function () {
                mUtil.hasClass(r, 'm-aside-left--minimize') &&
                  mUtil.isInResponsiveRange('desktop') &&
                  (mUtil.removeClass(r, 'm-aside-left--minimize'), mUtil.addClass(r, 'm-aside-left--minimize-hover'), e.scrollerUpdate(), e.scrollerTop());
              }, 300));
          }),
          mUtil.addEvent(s, 'mouseleave', function () {
            n && (clearTimeout(n), (n = null)),
              (l = setTimeout(function () {
                mUtil.hasClass(r, 'm-aside-left--minimize-hover') &&
                  mUtil.isInResponsiveRange('desktop') &&
                  (mUtil.removeClass(r, 'm-aside-left--minimize-hover'), mUtil.addClass(r, 'm-aside-left--minimize'), e.scrollerUpdate(), e.scrollerTop());
              }, 500));
          })),
        (m = mUtil.get('m_ver_menu')),
        (u = '1' === mUtil.attr(m, 'm-menu-dropdown') ? 'dropdown' : 'accordion'),
        '1' === mUtil.attr(m, 'm-menu-scrollable') &&
          (c = {
            height: function () {
        ...
        (e = new mMenu('m_ver_menu', {
          scroll: c,
          submenu: { desktop: { default: u, state: { body: 'm-aside-left--minimize', mode: 'dropdown' } }, tablet: 'accordion', mobile: 'accordion' },
...
var mQuickSidebar = (function () {
  var t = $('#m_quick_sidebar'),
    ...
    n = function () {
      ...
      (a = mUtil.find(mUtil.get('m_quick_sidebar_tabs_messenger'), '.m-messenger__messages')),
        ...
        (o = mUtil.find(mUtil.get('m_quick_sidebar_tabs_settings'), '.m-list-settings')) &&
        ...
        (i = mUtil.find(mUtil.get('m_quick_sidebar_tabs_logs'), '.m-list-timeline')) &&
  ...
  return {
    init: function () {
      0 !== t.length &&
        new mOffcanvas('m_quick_sidebar', { overlay: !0, baseClass: 'm-quick-sidebar', closeBy: 'm_quick_sidebar_close', toggleBy: 'm_quick_sidebar_toggle' }).one(
          'afterShow',
          function () {
            mApp.block(t),
              setTimeout(function () {
