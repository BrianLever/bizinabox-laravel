...
!(function (a, b) {
  ...
  function d(a, b, c) {
    ...
    return (
      ...
      o.options.customBG &&
        ((e.rgbaMixCustom = i(b, o.options.customBG, c, 1)), (e.rgbaMixCustom.luminance = h(e.rgbaMixCustom, !0)), (o.options.customBG.luminance = h(o.options.customBG, !0))),
      e
    );
  }
  function e(a, b) {
  ...
  var l = {
    ...
    s = function (a) {
      (this.colors = { RND: {} }), (this.options = { color: 'rgba(0,0,0,0)', grey: q, luminance: r, valueRanges: l }), t(this, a || {});
    },
    t = function (a, d) {
      var e,
        f = a.options;
  ...
  var v = {
    ...
    HEX2rgb: function (a) {
      return (
        (a = a.split('')), { r: +('0x' + a[0] + a[a[3] ? 1 : 0]) / 255, g: +('0x' + a[a[3] ? 2 : 1] + (a[3] || a[1])) / 255, b: +('0x' + (a[4] || a[2]) + (a[5] || a[2])) / 255 }
      );
    },
    hue2RGB: function (a) {
      var b = 6 * a,
        c = ~~b % 6,
        d = 6 === b ? 0 : b - c;
      return { r: n(255 * [1, 1 - d, 0, 0, d, 1][c]), g: n(255 * [d, 1, 1, 1 - d, 0, 0][c]), b: n(255 * [0, 0, d, 1, 1, 1 - d][c]) };
    },
    rgb2hsv: function (a) {
      var b,
        c,
      ...
      return (
        ...
        (b = e - c),
        (d = e ? b / e : 0),
        { h: 1e-15 > d ? (p && p.hsl && p.hsl.h) || 0 : b ? m.abs(h + (f - g) / (6 * b)) : 0, s: e ? b / e : (p && p.hsv && p.hsv.s) || 0, v: e }
      );
    },
    hsv2rgb: function (a) {
      var b = 6 * a.h,
    ...
    hsv2hsl: function (a) {
      var b = (2 - a.s) * a.v,
        c = a.s * a.v;
      return (c = a.s ? (1 > b ? (b ? c / b : 0) : c / (2 - b)) : 0), { h: a.h, s: a.v || c ? c : (p && p.hsl && p.hsl.s) || 0, l: b / 2 };
    },
  ...
  (function (a, b) {
    ...
    function i() {
      return (
        b('head')[r.cssPrepend ? 'prepend' : 'append']('<style type="text/css" id="tinyColorPickerStyles">' + (r.css || I) + (r.cssAddon || '') + '</style>'),
        b(H)
          .css({ margin: r.margin })
          .appendTo('body')
          .show(0, function () {
    ...
    function n(a) {
      ...
      (v._css = { backgroundColor: 'rgb(' + c.r + ',' + c.g + ',' + c.b + ')' }),
        (w._css = { transform: n + '(' + k + 'px, ' + l + 'px, 0)', left: F ? '' : k, top: F ? '' : l, borderColor: b.RGBLuminance > 0.22 ? e : f }),
        (x._css = { transform: n + '(0, ' + j + 'px, 0)', top: F ? '' : j, borderColor: 'transparent ' + h }),
        (y._css = { backgroundColor: '#' + b.HEX }),
        (z._css = { transform: n + '(' + m + 'px, 0, 0)', left: F ? '' : m, borderColor: i + ' transparent' }),
        (s._css = { backgroundColor: t ? '' : g, color: t ? '' : b.rgbaMixBGMixCustom.luminance > 0.22 ? e : f }),
        (s.text = t ? '' : p !== g ? g : ''),
        a !== d ? o(a) : G(o);
    }
    function o(a) {
