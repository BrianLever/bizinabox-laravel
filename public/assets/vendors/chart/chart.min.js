...
!(function (t, e) {
  ...
  z._set('global', {
    elements: { point: { radius: 3, pointStyle: 'circle', backgroundColor: ht, borderColor: ht, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 } }
  });
  var ft = X.extend({
      _type: 'point',
      inRange: function (t, e) {
  ...
  V.extend(Qe.prototype, {
    ...
    resize: function (t) {
      ...
      if (
        ...
        ((i.width = e.width = r), (i.height = e.height = o), (i.style.width = r + 'px'), (i.style.height = o + 'px'), V.retinaScale(e, n.devicePixelRatio), !t)
      ) {
  ...
  var Rn = xn.extend({
      ...
      handleTickRangeOptions: function () {
        ...
        (t.min = On(e.min, t.min)),
          ...
          t.min === t.max &&
            (0 !== t.min && null !== t.min ? ((t.min = Math.pow(10, Math.floor(Fn(t.min)) - 1)), (t.max = Math.pow(10, Math.floor(Fn(t.max)) + 1))) : ((t.min = 1), (t.max = 10))),
  ...
  var ki = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (i = 0; i < o; ++i)
          (r = null),
            (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof _t.Line && (r = { visible: t.isDatasetVisible(i), fill: pi(a, i, o), chart: t, el: a }),
            (n.$filler = r),
            l.push(r);
