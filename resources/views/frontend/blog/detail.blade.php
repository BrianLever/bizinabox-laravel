                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="d-flex justify-content-between position-relative">
                            <div class="d-flex align-center">
                                <a href="{{route('blog.author', $post->user->username??'')}}" class="mr-2">
                                    <img src="{{$post->user->avatar()}}" alt="{{$post->user->name}}" class="rounded-circle w-50px">
                                </a>
                                <span class="m-auto">
                                    <a href="{{route('blog.author', $post->user->username??'')}}">{{$post->user->name}}</a>
                        ...
                        <div class="mt-4">
                                        ...
                                        <div class="row mt-1 lightgallery">
                                            @foreach($post->getLinks() as $key=>$link)
                                                <a href="{{$link}}" class="col-md-12 mb-3 masonry-item">
                                                    ...
                                                    <img src="{{asset("assets/img/youtube_button.png")}}" alt="" style="position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width:80px;">
                                            ...
                                            @foreach($post->getMedia('video') as $key=>$video)
                                                <div data-poster="{{asset('assets/img/video.png')}}" data-sub-html="{{$video->title}}" data-html="#v{{$key}}" class="col-md-12 mb-3 h-cursor masonry-item">
                            ...
                            @foreach($post->approvedTags as $tag)
                                <a href="{{route('blog.tag', $tag->slug)}}" class="btn btn-outline-info rounded-0 m-1">{{$tag->name}}</a>
                            @endforeach
                            <br>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex align-center">
                                    <a href="{{route('blog.author', $post->user->username??'')}}" class="mr-3">
                                        <img src="{{$post->user->avatar()}}" alt="{{$post->user->name}}" class="rounded-circle w-80px">
                                    </a>
                                    <span class="m-auto">
                                        <small>Written By</small> <br>
                                        <a href="{{route('blog.author', $post->user->username??'')}}">{{$post->user->name}}</a><b></b>
                                    </span>
                                </div>
                                <div class="d-flex">
