                        ...
                        <div class="col-md-6 offset-md-3">
                                ...
                                @if(session()->get("paypalguestemail", null) === null)
                                    <form action="{{route('cart.checkEmail')}}" method="POST" id="guest_email_form">
                                        ...
                                        <div class="guest_area mt-4 alert alert-info border-radius-0">
                                            <p class="">
                                                To continue to payment and to create a new account, enter your email. If you already have an account, <a href="{{route('cart.login')}}?redirect={{route('cart.index')}}" class="highlight underline">LOGIN</a>
                                            </p>
                                            <div class="mt-3">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <button class="btn btn-success border-radius-0 shadow confirmBtn" type="submit">Confirm</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mt-5 bg-white pt-4 pb-3 px-3 small_shadow position-relative checkout_form"  @if(session()->get("paypalguestemail", null) === null)   @endif>
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <p class="font-size20 text-right"><b>${{formatNumber(session("cart")->totalPrice?? 0)}}</b></p>
                                    </div>
                                </div>
