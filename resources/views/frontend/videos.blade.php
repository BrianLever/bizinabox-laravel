...
<head>
    <title>BizinaboxLogoMaker - Videos</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('assets/logo/css/video.css') }}">
        ...
        <div class="video-area">
            ...
            <template x-if="activeVideo">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" :src="activeVideo.link" allowfullscreen></iframe>
                </div>
            </template>
        </div>
    </div>
