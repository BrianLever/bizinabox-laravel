        ...
        <div id="color_body">
            ...
            <div class="content">
                <div class="colors pb-0">
                    <form action="{{route("admin.logotypes.color.item.solidUpdate", $palette->id)}}" method="POST" id="submit_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <div class="m-portlet__head-tools mt-3 mb-3 text-right">
                                    <input type="text" class="form-control maxw-300 d-inline-block mr-2" name="name" value="{{$palette->name}}">
                                    <a href="{{route('admin.logotypes.color.item.index', $palette->category_id)}}#/solid" class="btn m-btn--square  btn-outline-primary m-2">
                                        Back
                                    </a>
                        ...
                        <div class="random-colors menu_colors">
                            <div class="gen text-center">
                                <div class="child-color" ><input class="jscolor" id="js1" name="color1" value="{{$palette->getSolidColor("color1")}}"></div>
                                <div class="hexcolor">
                                    <h3>#17405B</h3>
                            ...
                            <div class="gen text-center">
                                <div class="child-color"><input class="jscolor" id="js2" name="color2" value="{{$palette->getSolidColor("color2")}}"></div>
                                <div class="hexcolor">
                                    <h3>#0A8BA1</h3>
                                    <i class="jfa-copy " title="Copy"></i>
                                    <i class="jfa-lock " title="Lock/Unlock this color"></i>
                            ...
                            <div class="gen text-center">
                                <div class="child-color"><input class="jscolor" id="js3" name="color3" value="{{$palette->getSolidColor("color3")}}"></div>
                                <div class="hexcolor">
                                    <h3>#09C1C5</h3>
                                    <i class="jfa-copy " title="Copy"></i>
                                    <i class="jfa-lock " title="Lock/Unlock this color"></i>
                            ...
                            <div class="gen text-center">
                                <div class="child-color"><input class="jscolor" id="js4" name="color4" value="{{$palette->getSolidColor("color4")}}"></div>
                                <div class="hexcolor">
                                    <h3>#F1F3F4</h3>
                                    <i class="jfa-copy " title="Copy"></i>
                                    <i class="jfa-lock " title="Lock/Unlock this color"></i>
                            ...
                            <div class="gen text-center">
                                <div class="child-color"><input class="jscolor" id="js5" name="color5" value="{{$palette->getSolidColor("color5")}}"></div>
                                <div class="hexcolor">
                                    <h3>#F1F3F4</h3>
                                    <i class="jfa-copy " title="Copy"></i>
                                    <i class="jfa-lock " title="Lock/Unlock this color"></i>
...
@endsection
@section('script')
    <script>var palette_id = "{{$palette->id}}"; </script>
    ...
    <script src="{{asset('assets/js/admin/logo/logoType/solidEdit.js')}}?v={{time()}}"></script>
@endsection
