        ...
        <div id="color_body">
            ...
            <div class="content">
                <div class="colors pb-0">
                    <form action="{{route("admin.logotypes.color.item.solidStore", $category->id)}}" method="POST" id="submit_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <div class="m-portlet__head-tools mt-3 mb-3 text-right">
                                    ...
                                    <a href="{{route('admin.logotypes.color.item.index', $category->id)}}#/solid" class="btn m-btn--square  btn-outline-primary m-2">
                                        Back
                                    </a>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/logo/logoType/solidCreate.js')}}?v={{time()}}"></script>
@endsection
