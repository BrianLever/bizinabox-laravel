...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        ...
        <a href="{{route('admin.logotypes.item.create')}}" class="ml-auto btn m-btn--sm m-btn--custom m-btn--square btn-outline-success mb-2">Import New Logo</a>
    </div>
@endsection
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/logo/logoType/item.js')}}?v={{time()}}"></script>
@endsection
