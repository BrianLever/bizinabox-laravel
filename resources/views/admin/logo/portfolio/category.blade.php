...
@section('title', 'Palette Ideas Category')
@section('style')
@endsection
@section('breadcrumb')
    <div class="col-md-6 text-left">
        <x-layout.breadcrumb :menus="['Palette Ideas', 'Category']"/>
    </div>
    <div class="col-md-6 text-right">
        <a href="javascript:void(0);" class="ml-auto btn m-btn--square btn-outline-info sortBtn mb-2">Sort Order</a>
        <a href="javascript:void(0);" class="ml-auto btn m-btn--square btn-outline-success createBtn mb-2">Create</a>
    </div>
@endsection
    ...
    <div class="modal fade" id="create_modal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="create_modal_form" method="post" enctype="multipart/form-data" action="{{route('admin.palette-idea.category.store')}}">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" accept="image/*" class="form-control m-input--square uploadImageBox" id="thumbnail" name="thumbnail" data-target="thumbnail_image">
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/logo/portfolio/category.js')}}"></script>
@endsection
