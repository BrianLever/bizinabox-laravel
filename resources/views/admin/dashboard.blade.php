                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="website" id="website" class="website" data-width="100%" data-live-search="true">
                    ...
                    <div class="m-portlet">
                        ...
                        <div class="m-portlet__body p-2 p-md-3">
                            <div class="m-scrollable m-scroller" data-scrollable="true" style="max-height: 400px; overflow: auto;">
                                <a href="{{route('admin.blog.post.index')}}" class="btn m-btn--square  btn-outline-dark m-btn m-btn--custom btn-block white-space-pre-line">
                                ...
                                <a href="{{route('admin.blog.comment.index')}}" class="btn m-btn--square  btn-outline-dark m-btn m-btn--custom btn-block white-space-pre-line">
                                ...
                                <a href="{{route('admin.blogAds.listing.index')}}" class="btn m-btn--square  btn-outline-dark m-btn m-btn--custom btn-block white-space-pre-line">
                                    Blog Ads Listing @if($pendingListings)<div class="float-right"><span class="m-nav__link-badge m-badge m-badge--danger">{{$pendingListings}}</span></div> @endif
                                </a>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="website" id="website_analytics" class="website" data-width="100%" data-live-search="true">
                                <option value="0">Bizinabox Website</option>
                                @foreach($websites as $website)
                                    <option value="{{$website->id}}">{{$website->name}} ({{$website->domain}})</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">
                                ...
                                <i class="la la-info-circle tooltip_icon"
                                   ...
                                   data-id="3"
                                ></i>
                                 <a href="https://bizinabox.com/account/tutorial/#/basic/how-to-hook-up-google-analytics" target="_blank" class="c-badge c-badge-success hover-none">Tutorial </a>
                            </label>
                            <div></div>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="json_file" name="json_file">
                                <label class="custom-file-label" for="json_file">@if(file_exists( storage_path()."/app/analytics/service-account-credentials.json")) Already exist @else Choose file @endif</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control m-input m-input--square" id="view_id" name="view_id" value="{{option("analytics_view_id", "")}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
