...
@section('content')
    <div class="m-portlet m-portlet--mobile md-pt-50">
        ...
        <div class="m-portlet__body">
            <form method="post" action="{{route('admin.favicon.front.store')}}" id="submit_form" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group m-form__group" >
                                ...
                                <div class="slimdiv">
                                    <input type="file" data-url="{{uploadUrl(option('favicon.front.header.image'))}}" name="headerImage" id="slimInput1"/>
                                </div>
                            </div>
                            <div class="form-group m-form__group" >
                                <label for="nav_image" class="form-control-label text-bold h4">
                                ...
                                <div class="slimdiv">
                                    <input type="file"  data-url="{{uploadUrl(option('favicon.front.box.image'))}}"  name="boxImage" id="slimInput2"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/favicon/front.js')}}"></script>
@endsection
