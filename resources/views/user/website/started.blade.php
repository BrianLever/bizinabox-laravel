...
@section('breadcrumb')
    <div class="col-md-6">
        <x-layout.breadcrumb :menus="['Website', 'Getting Started']" :menuLinks="[]" />
    </div>
@endsection
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                <input type="text" name="template_search" id="template_search" class="form-control" placeholder="Type keyword...">
                            </div>
                            <div class="form-group">
