            ...
            <form class="domain-search" id="search-form">
                ...
                <div class="container">
                    <div class="text-center mb-3">
                        ...
                        <a href="{{route('user.domain.connect')}}" class="btn m-btn--square  btn-outline-info m-btn m-btn--custom">Connect My Domain</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group m-form__group text-right">
                                    <button type="submit" class="btn btn-success formSmtBtn">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@endsection
@section('script')
    <script src="{{asset('assets/vendors/typed/typed.js')}}"></script>
