    ...
    <table class="table table-hover ajaxTable datatable {{$selector}} ">
        ...
        @foreach($items as $item)
            <tr>
                ...
                <td>
                    <a href="{{$item->getFirstMediaUrl('thumbnail')}}" class="w-100 progressive replace m-auto">
                ...
                <td>
                    <a href="{{route('admin.palette-idea.item.edit', $item->id)}}" class="btn btn-outline-info btn-sm m-1	p-2 m-btn m-btn--icon edit_btn">
                        <span>
