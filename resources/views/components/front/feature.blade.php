                        ...
                        <div>
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-img">
                                    ...
                                    @endif
                                    <a  @if($slider->model_type === 'url') href="{{$slider->model_id}}" @else href="{{route('slider.detail', $slider->id)}}" @endif>
                                ...
                                <div class="product-info">
                                    ...
                                    <p class="price text-center no-margin">
                                        @if($slider->model->standardPrice!==null)
                                            ...
                                            @endif
                                        @else
                                            @if($slider->model->slashed_price)
                                                <span class="red line-through">
                                            ${{$slider->model->slashed_price}}
                                        </span>
                                            @endif
                                            @if($slider->model->price)
