<div class="bz-front-component--home-slider">
    <div class="rev_slider_wrapper custom-controls">
        <div id="home-banner-slider" class="rev_slider" data-version="5.4.5" style="min-height: 62vh; background-color: #0d47a13f">
            <ul>
...
{{--                    <li data-transition="parallaxtoleft">--}}
                        ...
                        <div class="tp-caption tp-resizeme"
                            ...
                            <a href='/register' class='butn theme'><span>Get Started</span></a>
                        </div>
                    </li>
                @endforeach
            </ul>
...
@push('script')
    ...
    <script>
        $(function () {
            ...
            if (homeBannerSlider.revolution === undefined) {
                ...
                homeBannerSlider
                    ...
                    .revolution({
                        ...
                        delay: 6000,
                        spinner: "none",
                        snow: { startSlide: "first", endSlide: "last", maxNum: "400", minSize: "0.2", maxSize: "6", minOpacity: "0.3", maxOpacity: "1", minSpeed: "30", maxSpeed: "100", minSinus: "1", maxSinus: "100" },
                        navigation: {
                        ...
                        responsiveLevels: [1920, 1024, 767, 480],
