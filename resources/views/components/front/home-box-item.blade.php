                    ...
                    <div class="thumbnail_overlay">
                        <div  class="img_area">
                            <x-global.aspect-view>
                                <figure data-href="/assets/img/front/plugin.png" class="w-100 h-100 progressive replace m-0" >
                                    <img src="/assets/img/front/plugin.png" alt="bizinabox home page" class="preview img-full" />
                                </figure>
                            </x-global.aspect-view>
                        </div>
                    </div>
