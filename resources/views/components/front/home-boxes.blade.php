                    ...
                    <div class="col-12 position-relative">
                        <div class="preview-wrapper">
                            <div class="thumbnail_overlay">
                                <div  class="img_area">
                                    <figure data-href="{{uploadUrl(option('home.front.box.image'),'center-box.png')}}" class="w-100 progressive replace m-0" >
                                        <img src="{{uploadUrl(option('home.front.box.image-thumb'), 'center-thumb.png')}}" alt="bizinabox home page" class="preview img img-full" />
                                    </figure>
                                </div>
                            </div>
                        </div>
