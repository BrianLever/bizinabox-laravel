  ...
  constructor(container, config) {
    ...
    ;(function () {
        ...
        switch (currentMode) {
          case 'select':
            ...
            if (mouseTarget.id === 'backgroundRect') {
              ...
              mouseTarget.style = 'pointer-events: none;'
              EventBus.$emit('background.selected')
            } else if (mouseTarget !== svgroot) {
            ...
            if (selectedElements[0]) {
              ...
              let contentBbox = getBackgroundItem().getBoundingClientRect()
          ...
          case 'text':
            started = true
            /* const newText = */
            let newText = addSVGElementFromJson({
              element: 'text',
              curStyles: true,
              attr: {
                x,
      ...
      const mouseMove = function (evt) {
        ...
        EventBus.$emit('editor-logo-changed')
      } // mouseMove()
    ...
    const snapToObjects = function (offset, axis = 'left') {
      ...
      let distance = appConfig().snap.object.step
      ...
      try {
        if (selectedItems.length === 1) {
          ...
          let excludeIds = ['snap-line-x', 'snap-line-y']
    ...
    this.getBackgroundColor = function () {
      let background = getBackgroundItem()

      if (background) {
        let rectangle = background.children[0]
        let attributes = rectangle.attributes
