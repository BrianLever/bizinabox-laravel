...
;(function () {
  ...
  svgedit.path.Segment.prototype.move = function (dx, dy) {
    ...
    var cur_pts = this.ctrlpts
      ? [(cloneItem.x += dx), (cloneItem.y += dy), cloneItem.x1, cloneItem.y1, (cloneItem.x2 += dx), (cloneItem.y2 += dy)]
  ...
  svgedit.path.Segment.prototype.setLinked = function (num) {
    ...
    var pts = [cloneItem.x, cloneItem.y, cloneItem.x1, cloneItem.y1, cloneItem.x2, cloneItem.y2]
