...
;(function () {
  ...
  svgedit.math.matrixMultiply = function (...args) {
  ...
  svgedit.math.transformBox = function (l, t, w, h, m) {
    const tl = svgedit.math.transformPoint(l, t, m),
      tr = svgedit.math.transformPoint(l + w, t, m),
      bl = svgedit.math.transformPoint(l, t + h, m),
      br = svgedit.math.transformPoint(l + w, t + h, m),
