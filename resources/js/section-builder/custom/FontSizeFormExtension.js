module.exports = {
  init: function (MediumEditor) {
    ...
    var FontSizeForm = MediumEditor.extensions.button.extend({
      name: 'fontsize',
      action: 'fontSize',
      ...
      getButton: function () {
        ...
        let fontIncreaseBtn = window.document.createElement('button')
        ...
        let fontDecreaseBtn = window.document.createElement('button')
        ...
        let fontSizeBox = window.document.createElement('div')
