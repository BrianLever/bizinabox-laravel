    ...
    var Toolbar = MediumEditor.Extension.extend({
      ...
      showToolbar: function () {
        if (this.buttons.includes('fontsize')) {
          let fontSizeExtension = this.base.extensions.find((ex) => ex.fontSizeBox)
        ...
        if (this.buttons.includes('colorPicker')) {
          let colorPickerExtension = this.base.extensions.find((ex) => ex.name === 'colorPicker')
