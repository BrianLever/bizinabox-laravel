<template>
  <div class="bz-section-container bz-sec--header-4-root" :class="{ [breakPoint]: true }" :data-section="section.sectionUUID">
...
export default {
  extends: BzSection,
  components: { BzBackground, HamburgerIcon, BzButton, MenuIcon },
  computed: {
    headerButtonColor() {
