...
/**
 *  2021-07-10 by lovecoding
 * delete files in uploads folder that indicates Storage disk named "uploads" to save front image files, e.x. home box, hero images. seo images..., etc.
 * required array of filenames.
 */
if(!function_exists('clearUploadFiles')){
    function clearUploadFiles($fileNames){
...
/**
 * 2021-07-10 by lovecoding
 * return public url of "uploads" file disk
 * @param $fileName
