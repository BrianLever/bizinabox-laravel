...
/**
        ...
        protected static $_commands = [
            'domains.setLock'        => 'App\Integration\Namecheap\DomainSetLock',
            'domains.getLock'        => 'App\Integration\Namecheap\DomainGetLock',
            'domains.setContacts'        => 'App\Integration\Namecheap\DomainSetContacts',
        ];
