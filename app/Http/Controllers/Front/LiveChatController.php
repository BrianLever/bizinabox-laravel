...
class LiveChatController extends Controller
{
    ...
    public function getSession(Request $request)
    {
        ...
        $data['messages'] = "<li class=\"support_answer\">
                    <div class=\"message-div\">Welcome! We are excited to offer you messaging, allowing you to respond to us in your own time. Click here to get started.</div>
                </li>
                <li class=\"support_answer\">
                    <div class=\"message-div letsgo\" title=\"Let's Go!\">Let's Go!</div>
                </li>";
        return response()->json([
            'status'=>1,
            'data'=>$data
