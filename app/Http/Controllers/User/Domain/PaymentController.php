    ...
    public function paywithPaypalExecute(Request $request, $status)
    {
        ...
        }elseif($status=='success')
        {
            try{
                ...
                if($g_total!=$data['total']) return redirect()->route('user.domain.search')->with('error', 'Package is already used but you applied discount using that package.');
