...
class CategoryController extends AdminController
{
    ...
    public function index()
    {
        ...
        if(request()->wantsJson())
        {
            ...
            $all = view('components.admin.logo.videoCategory', [
                'categories'=>$categories,
                'selector'=>"datatable-all"
            ])->render();
            $active = view('components.admin.logo.videoCategory', [
                'categories'=>$activeCats,
                'selector'=>"datatable-active"
            ])->render();
            $inactive = view('components.admin.logo.videoCategory', [
                'categories'=>$inactiveCats,
                'selector'=>"datatable-inactive"
            ])->render();
            $subcategory = view('components.admin.logo.videoCategory', [
