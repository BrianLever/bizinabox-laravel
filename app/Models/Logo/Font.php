...
class Font extends Model
{
    ...
    public function getDatatable()
    {
        ...
        return Datatables::of($fonts)->editColumn('public_path', function($row) {
            ...
            return '
                    <a href="' . route('admin.logotypes.font.delete', $row->id) . '" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill tooltip_3 deleteBtn" title="Delete">
