...
class LogotypeRepository extends BaseRepository
{
    /**
     * @var string
     */
    public $model = LogoType::class;
    ...
    public function create(array $data)
    {
        return \DB::transaction(function () use ($data) {
            ...
            if (!$logotype) {
                ...
                if($request->favicon){
                    $logotype->favicons()->sync([$request->favicon]);
                }
            }
